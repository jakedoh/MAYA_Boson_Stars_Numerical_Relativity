...
class BondiSource : public CompactSource
{
	protected:
		...
		double simpsonIntegrate(double (BondiSource::*dFdr)(double), double rmin, double rmid, double rmax, double fmin, double fmid, double fmax, int depth);
		double radialIntegrate(double (BondiSource::*dFdr)(double), double rmin, double rmax);
		double radius;

	public:
		virtual ~BondiSource() = 0;
		BondiSource(int idx);
...
class BlackHole : public BondiSource
{
	public:
		BlackHole(int idx);
...
class SphericalHydroSource : public BondiSource
{
	public:
		SphericalHydroSource(int idx) : BondiSource(idx) {};
