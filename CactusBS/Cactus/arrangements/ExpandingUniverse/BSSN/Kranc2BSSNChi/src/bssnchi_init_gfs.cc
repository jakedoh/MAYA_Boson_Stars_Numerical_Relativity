...
static void bssnchi_init_gfs_Body(const cGH* restrict const cctkGH, const int dir, const int face, const CCTK_REAL normal[3], const CCTK_REAL tangentA[3], const CCTK_REAL tangentB[3], const int imin[3], const int imax[3], const int n_subblock_gfs, CCTK_REAL* restrict const subblock_gfs[])
{
    ...
    cctk_ash[0],cctk_ash[1],cctk_ash[2])
  {
    ...
    CCTK_REAL h11L CCTK_ATTRIBUTE_UNUSED = 100;
    
    CCTK_REAL h21L CCTK_ATTRIBUTE_UNUSED = 100;
    
    CCTK_REAL h31L CCTK_ATTRIBUTE_UNUSED = 100;
    
    CCTK_REAL h22L CCTK_ATTRIBUTE_UNUSED = 100;
    
    CCTK_REAL h32L CCTK_ATTRIBUTE_UNUSED = 100;
    
    CCTK_REAL h33L CCTK_ATTRIBUTE_UNUSED = 100;
    
    CCTK_REAL A11L CCTK_ATTRIBUTE_UNUSED = 100;
    
    CCTK_REAL A21L CCTK_ATTRIBUTE_UNUSED = 100;
    
    CCTK_REAL A31L CCTK_ATTRIBUTE_UNUSED = 100;
    
    CCTK_REAL A22L CCTK_ATTRIBUTE_UNUSED = 100;
    
    CCTK_REAL A32L CCTK_ATTRIBUTE_UNUSED = 100;
    
    CCTK_REAL A33L CCTK_ATTRIBUTE_UNUSED = 100;
    
    CCTK_REAL chiL CCTK_ATTRIBUTE_UNUSED = 100;
    
    CCTK_REAL KL CCTK_ATTRIBUTE_UNUSED = 100;
    
    CCTK_REAL Gam1L CCTK_ATTRIBUTE_UNUSED = 100;
    
    CCTK_REAL Gam2L CCTK_ATTRIBUTE_UNUSED = 100;
    
    CCTK_REAL Gam3L CCTK_ATTRIBUTE_UNUSED = 100;
    
    CCTK_REAL alphaL CCTK_ATTRIBUTE_UNUSED = 100;
    
    CCTK_REAL beta1L CCTK_ATTRIBUTE_UNUSED = 100;
    
    CCTK_REAL beta2L CCTK_ATTRIBUTE_UNUSED = 100;
    
    CCTK_REAL beta3L CCTK_ATTRIBUTE_UNUSED = 100;
    
    CCTK_REAL betat1L CCTK_ATTRIBUTE_UNUSED = 100;
    
    CCTK_REAL betat2L CCTK_ATTRIBUTE_UNUSED = 100;
    
    CCTK_REAL betat3L CCTK_ATTRIBUTE_UNUSED = 100;
    /* Copy local copies back to grid functions */
    A11[index] = A11L;
    A21[index] = A21L;
    A22[index] = A22L;
  ...
  CCTK_ENDLOOP3(bssnchi_init_gfs);
}
extern "C" void bssnchi_init_gfs(CCTK_ARGUMENTS)
{
  DECLARE_CCTK_ARGUMENTS;
  DECLARE_CCTK_PARAMETERS;
  ...
  if (verbose > 1)
  {
    CCTK_VInfo(CCTK_THORNSTRING,"Entering bssnchi_init_gfs_Body");
  }
  if (cctk_iteration % bssnchi_init_gfs_calc_every != bssnchi_init_gfs_calc_offset)
  {
    return;
  }
  ...
  AssertGroupStorage(cctkGH, "bssnchi_init_gfs", 8, groups);
  ...
  LoopOverEverything(cctkGH, bssnchi_init_gfs_Body);
  if (verbose > 1)
  {
    CCTK_VInfo(CCTK_THORNSTRING,"Leaving bssnchi_init_gfs_Body");
  }
}
