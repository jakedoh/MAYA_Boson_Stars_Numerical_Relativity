...
!  @enddesc
!  @version   $Id: MoncriefQ.F90,v 1.3 2005/01/14 17:36:19 herrmann Exp $
!  @@*/
...
!  @enddesc
!@@*/
subroutine WavExtr_MoncriefQ(CCTK_ARGUMENTS)
  ...
  CCTK_INT :: int_var1,int_var2,int_var3,int_var4, &
              int_var5,int_var6,int_var7,int_var8,int_var9, &
              int_var10,int_var11,int_var12,int_var13,int_var14, &
              int_var15,int_var16,int_var17,int_var18
  CCTK_INT :: num_out_vals, num_in_fields
  CCTK_REAL,dimension(18) :: out_vals
...
! _________________________________________________________________
  ...
  call CCTK_VarIndex ( int_var11, "WaveExtract::int_tmp11" )
  call CCTK_VarIndex ( int_var12, "WaveExtract::int_tmp12" )
  call CCTK_VarIndex ( int_var13, "WaveExtract::int_tmp13" )
  call CCTK_VarIndex ( int_var14, "WaveExtract::int_tmp14" )
  call CCTK_VarIndex ( int_var15, "WaveExtract::int_tmp15" )
  call CCTK_VarIndex ( int_var16, "WaveExtract::int_tmp16" )
  call CCTK_VarIndex ( int_var17, "WaveExtract::int_tmp17" )
  call CCTK_VarIndex ( int_var18, "WaveExtract::int_tmp18" )
  if ( min(int_var1,int_var2,int_var3,int_var4,int_var5, &
           int_var6,int_var7,int_var8,int_var9, &
           int_var10,int_var11,int_var12,int_var13,int_var14, &
           int_var15,int_var16,int_var17,int_var13,int_var18 ).lt. 0 ) then
    call CCTK_WARN ( 0, 'Could not get index to one of the int_tmpX arrays' )
  end if
    ...
    loop_m: do im = m_min,m_max,m_step
      ...
      loop_phi1: do j = 1, lsh(2)
        loop_theta1: do i = 1, lsh(1)
          ...
          call WavExtr_spher_harm_combs(ctheta(i,j),cphi(i,j),il,im,Ylm,Y1,Y2,Y3,Y4)
      ...
      if (im.eq.0) then
        ...
        call CCTK_Reduce(ierr, cctkGH, -1, sum_handle,  &
                         ...
                         int_var1,int_var2,int_var3,int_var4, &
                         int_var5,int_var6,int_var7,int_var8, &
                         int_var9)
        ...
        call CCTK_Reduce(ierr, cctkGH, -1, sum_handle,  &
                         ...
                         int_var5,int_var6,int_var7,int_var8, &
                         int_var9, &
                         int_var10,int_var11,int_var12,int_var13, &
                         int_var14,int_var15,int_var16,int_var17, &
                         int_var18)
      end if
      ...
      ! call IO on CPU 0
      if (myproc.eq.0) then
         call write_moncriefq_mode(ierr,cctk_time,&
              wavextr_files_exist,first_detector_this_time,&
              current_detector, current_detector_radius, il, im,&
              Qeven_Re, Qeven_Im, Qodd_Re, Qodd_Im, &
              Schwarzschild_Radius, Schwarzschild_Mass)
         if (ierr.lt.0) then
            call CCTK_WARN(1,"writing of data has failed!")
         end if
      end if
...
end subroutine WavExtr_MoncriefQ
...
!
! ------------------------------------------------------------------
subroutine WavExtr_spherical_harmonic(l,m,theta,phi,Ylm)
...
! Local variables
  CCTK_INT :: i
  CCTK_REAL :: a,fac,WavExtr_plgndr
! _________________________________________________________________
...
! &    /four/Pi*fac)*WavExtr_plgndr(l,abs(m),cos(theta))

  a = (-one)**max(m,0)*sqrt(dble(2*l+1)/ &
      four/Pi*fac)*WavExtr_plgndr(l,abs(m),cos(theta))
  Ylm(1) = a*cos(dble(m)*phi)
  Ylm(2) = a*sin(dble(m)*phi)
end subroutine WavExtr_spherical_harmonic
...
! __________________________________________________________________
subroutine WavExtr_spher_harm_combs(theta,phi,l,m,Y,Y1,Y2,Y3,Y4)
...
! __________________________________________________________________
  ...
  call WavExtr_spherical_harmonic(l+1,m,theta,phi,Yplus)

  ! Find Y
  call WavExtr_spherical_harmonic(l,m,theta,phi,Y)
...
end subroutine WavExtr_spher_harm_combs
