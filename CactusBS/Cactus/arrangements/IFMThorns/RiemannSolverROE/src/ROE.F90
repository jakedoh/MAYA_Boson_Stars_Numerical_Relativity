...
subroutine Whisky_Roe(CCTK_ARGUMENTS)
  ...
  CCTK_REAL :: avg_alp,avg_beta,gxxh,gxyh,gxzh,gyyh,gyzh,gzzh, &
       ...
       w_lorentzave, usendh, alp_l, alp_r
  integer :: m
  integer :: i,j,k
...
!!$        inside the eigenproblem_roe routine) so instead we just have
...
!!$                 velxave, velyave, velzave, epsave, pressave, w_lorentzave)
            call eigenproblem_roe(whisky_eos_handle,rhoave, velxave, &
...
!!$                 velyave, velzave, velxave, epsave, pressave, w_lorentzave)
            call eigenproblem_roe(whisky_eos_handle,rhoave, velyave, &
...
!!$                 velzave, velxave, velyave, epsave, pressave, w_lorentzave)
            call eigenproblem_roe(whisky_eos_handle,rhoave, velzave, &
