...
extern "C" void bssn_calc_constraints_vacuum_SelectBCs(CCTK_ARGUMENTS)
{
  DECLARE_CCTK_ARGUMENTS;
  DECLARE_CCTK_PARAMETERS;
  
  if (cctk_iteration % bssn_calc_constraints_vacuum_calc_every != bssn_calc_constraints_vacuum_calc_offset)
    return;
  CCTK_INT ierr CCTK_ATTRIBUTE_UNUSED = 0;
  ierr = Boundary_SelectGroupForBC(cctkGH, CCTK_ALL_FACES, GetBoundaryWidth(cctkGH), -1 /* no table */, "Kranc2BSSN::bssnCcons_group","flat");
  if (ierr < 0)
    CCTK_WARN(1, "Failed to register flat BC for Kranc2BSSN::bssnCcons_group.");
  ierr = Boundary_SelectGroupForBC(cctkGH, CCTK_ALL_FACES, GetBoundaryWidth(cctkGH), -1 /* no table */, "Kranc2BSSN::bssnmom_group","flat");
  if (ierr < 0)
    CCTK_WARN(1, "Failed to register flat BC for Kranc2BSSN::bssnmom_group.");
...
static void bssn_calc_constraints_vacuum_Body(const cGH* restrict const cctkGH, const int dir, const int face, const CCTK_REAL normal[3], const CCTK_REAL tangentA[3], const CCTK_REAL tangentB[3], const int imin[3], const int imax[3], const int n_subblock_gfs, CCTK_REAL* restrict const subblock_gfs[])
{
  DECLARE_CCTK_ARGUMENTS;
  DECLARE_CCTK_PARAMETERS;
  ...
  #pragma omp parallel
  CCTK_LOOP3(bssn_calc_constraints_vacuum,
    ...
    cctk_ash[0],cctk_ash[1],cctk_ash[2])
  {
    ...
    switch (constraintsfdorder)
    {
      case 2:
      {
        ...
        PDstandardNth1phi = PDstandardNthconstraintsfdorder21(&phi[index]);
        PDstandardNth2phi = PDstandardNthconstraintsfdorder22(&phi[index]);
        PDstandardNth3phi = PDstandardNthconstraintsfdorder23(&phi[index]);
        PDstandardNth11phi = PDstandardNthconstraintsfdorder211(&phi[index]);
        PDstandardNth22phi = PDstandardNthconstraintsfdorder222(&phi[index]);
        PDstandardNth33phi = PDstandardNthconstraintsfdorder233(&phi[index]);
        PDstandardNth12phi = PDstandardNthconstraintsfdorder212(&phi[index]);
        PDstandardNth13phi = PDstandardNthconstraintsfdorder213(&phi[index]);
        PDstandardNth23phi = PDstandardNthconstraintsfdorder223(&phi[index]);
        break;
      }
      ...
      case 4:
      {
        ...
        PDstandardNth1phi = PDstandardNthconstraintsfdorder41(&phi[index]);
        PDstandardNth2phi = PDstandardNthconstraintsfdorder42(&phi[index]);
        PDstandardNth3phi = PDstandardNthconstraintsfdorder43(&phi[index]);
        PDstandardNth11phi = PDstandardNthconstraintsfdorder411(&phi[index]);
        PDstandardNth22phi = PDstandardNthconstraintsfdorder422(&phi[index]);
        PDstandardNth33phi = PDstandardNthconstraintsfdorder433(&phi[index]);
        PDstandardNth12phi = PDstandardNthconstraintsfdorder412(&phi[index]);
        PDstandardNth13phi = PDstandardNthconstraintsfdorder413(&phi[index]);
        PDstandardNth23phi = PDstandardNthconstraintsfdorder423(&phi[index]);
        break;
      }
      ...
      case 6:
      {
        ...
        PDstandardNth1phi = PDstandardNthconstraintsfdorder61(&phi[index]);
        PDstandardNth2phi = PDstandardNthconstraintsfdorder62(&phi[index]);
        PDstandardNth3phi = PDstandardNthconstraintsfdorder63(&phi[index]);
        PDstandardNth11phi = PDstandardNthconstraintsfdorder611(&phi[index]);
        PDstandardNth22phi = PDstandardNthconstraintsfdorder622(&phi[index]);
        PDstandardNth33phi = PDstandardNthconstraintsfdorder633(&phi[index]);
        PDstandardNth12phi = PDstandardNthconstraintsfdorder612(&phi[index]);
        PDstandardNth13phi = PDstandardNthconstraintsfdorder613(&phi[index]);
        PDstandardNth23phi = PDstandardNthconstraintsfdorder623(&phi[index]);
        break;
      }
      default:
    ...
    CCTK_REAL DDphi11 CCTK_ATTRIBUTE_UNUSED = PDstandardNth11phi - 
      gamma111*PDstandardNth1phi - gamma211*PDstandardNth2phi - 
      gamma311*PDstandardNth3phi;
    
    CCTK_REAL DDphi21 CCTK_ATTRIBUTE_UNUSED = PDstandardNth12phi - 
      gamma121*PDstandardNth1phi - gamma221*PDstandardNth2phi - 
      gamma321*PDstandardNth3phi;
    
    CCTK_REAL DDphi31 CCTK_ATTRIBUTE_UNUSED = PDstandardNth13phi - 
      gamma131*PDstandardNth1phi - gamma231*PDstandardNth2phi - 
      gamma331*PDstandardNth3phi;
    
    CCTK_REAL DDphi12 CCTK_ATTRIBUTE_UNUSED = PDstandardNth12phi - 
      gamma121*PDstandardNth1phi - gamma221*PDstandardNth2phi - 
      gamma321*PDstandardNth3phi;
    
    CCTK_REAL DDphi22 CCTK_ATTRIBUTE_UNUSED = 
      -(gamma122*PDstandardNth1phi) + PDstandardNth22phi - 
      gamma222*PDstandardNth2phi - gamma322*PDstandardNth3phi;
    
    CCTK_REAL DDphi32 CCTK_ATTRIBUTE_UNUSED = 
      -(gamma132*PDstandardNth1phi) + PDstandardNth23phi - 
      gamma232*PDstandardNth2phi - gamma332*PDstandardNth3phi;
    
    CCTK_REAL DDphi13 CCTK_ATTRIBUTE_UNUSED = PDstandardNth13phi - 
      gamma131*PDstandardNth1phi - gamma231*PDstandardNth2phi - 
      gamma331*PDstandardNth3phi;
    ...
    CCTK_REAL DDphi33 CCTK_ATTRIBUTE_UNUSED = 
      -(gamma133*PDstandardNth1phi) - gamma233*PDstandardNth2phi + 
      PDstandardNth33phi - gamma333*PDstandardNth3phi;
    
    CCTK_REAL Dphi1 CCTK_ATTRIBUTE_UNUSED = PDstandardNth1phi;
    
    CCTK_REAL Dphi2 CCTK_ATTRIBUTE_UNUSED = PDstandardNth2phi;
    
    CCTK_REAL Dphi3 CCTK_ATTRIBUTE_UNUSED = PDstandardNth3phi;
    ...
    CCTK_REAL bssnhamL CCTK_ATTRIBUTE_UNUSED = -(A11L*AInv11) - 
      ...
      A33L*AInv33 + em4phi*(hInv11*(R11 + Rphi11) + 2*hInv12*(R21 + Rphi21) + 
      hInv22*(R22 + Rphi22) + 2*hInv13*(R31 + Rphi31) + 2*hInv23*(R32 + 
      Rphi32) + hInv33*(R33 + Rphi33)) + 
      0.666666666666666666666666666667*pow(KL,2);
    
    CCTK_REAL bssnmom1L CCTK_ATTRIBUTE_UNUSED = (-(A22L*gamma221) + 
      A21L*(-gamma121 - gamma222) - A32L*gamma321)*hInv22 + (6*A31L*Dphi2 - 
      A32L*gamma221 - A33L*gamma321)*hInv23 + (6*A21L*Dphi3 - A22L*gamma231 - 
    ...
    CCTK_REAL bssnmom2L CCTK_ATTRIBUTE_UNUSED = (-(A11L*gamma121) - 
      A22L*gamma211 - A21L*gamma221 - A32L*gamma311 - A31L*gamma321)*hInv11 + 
      (6*A22L*Dphi1 - A11L*gamma122)*hInv12 + (6*A21L*Dphi2 - 
      A31L*gamma322)*hInv12 + (6*A32L*Dphi1 - A11L*gamma132)*hInv13 + 
      (6*A21L*Dphi3 - A31L*gamma332)*hInv13 + gamma121*(-3*A21L*hInv12 - 
      A31L*hInv13) + gamma221*(-3*A22L*hInv12 - A32L*hInv13) + 
      gamma321*(-3*A32L*hInv12 - A33L*hInv13) + A21L*((6*Dphi1 - 
      gamma111)*hInv11 - gamma222*hInv12 - gamma232*hInv13) + 
      6*A22L*Dphi2*hInv22 - 2*A22L*gamma222*hInv22 + 6*A22L*Dphi3*hInv23 - 
      3*A22L*gamma232*hInv23 + gamma122*(-2*A21L*hInv22 - A31L*hInv23) + 
      gamma322*(-2*A32L*hInv22 - A33L*hInv23) + 6*A32L*Dphi3*hInv33 + 
      gamma132*(-3*A21L*hInv23 - A31L*hInv33) + gamma332*(-3*A32L*hInv23 - 
      A33L*hInv33) + A21L*(-2*gamma131*hInv13 - gamma133*hInv33) + 
      A32L*(6*Dphi2*hInv23 - gamma232*hInv33) + A22L*(-2*gamma231*hInv13 - 
      gamma233*hInv33) + A32L*(-2*gamma331*hInv13 - gamma222*hInv23 - 
      gamma333*hInv33) + hInv11*PDstandardNth1A21 + hInv12*PDstandardNth1A22 
      + hInv13*PDstandardNth1A32 + hInv12*PDstandardNth2A21 + 
      hInv22*PDstandardNth2A22 + hInv23*PDstandardNth2A32 - 
    ...
    CCTK_REAL bssnmom3L CCTK_ATTRIBUTE_UNUSED = (-(A11L*gamma131) - 
      A32L*gamma211 - A21L*gamma231 - A33L*gamma311 - A31L*gamma331)*hInv11 + 
      (-2*A31L*gamma121 - A22L*gamma231)*hInv12 + (6*A32L*Dphi1 + 
      A21L*(-gamma131 - gamma232))*hInv12 + (6*A31L*Dphi2 - A11L*gamma132 - 
  ...
  CCTK_ENDLOOP3(bssn_calc_constraints_vacuum);
}
extern "C" void bssn_calc_constraints_vacuum(CCTK_ARGUMENTS)
{
  DECLARE_CCTK_ARGUMENTS;
  DECLARE_CCTK_PARAMETERS;
  ...
  if (verbose > 1)
  {
    CCTK_VInfo(CCTK_THORNSTRING,"Entering bssn_calc_constraints_vacuum_Body");
  }
  if (cctk_iteration % bssn_calc_constraints_vacuum_calc_every != bssn_calc_constraints_vacuum_calc_offset)
  {
    return;
  ...
  const char* const groups[] = {
    ...
    "Kranc2BSSN::bssnCcons_group",
    "Kranc2BSSN::bssnmom_group",
    "Kranc2BSSN::Gam_group",
    "Kranc2BSSN::h_group",
    "Kranc2BSSN::K_group",
    "Kranc2BSSN::phi_group",
    "Kranc2BSSN::scalarconstraints"};
  AssertGroupStorage(cctkGH, "bssn_calc_constraints_vacuum", 9, groups);
  
  switch (constraintsfdorder)
  {
    case 2:
    {
      EnsureStencilFits(cctkGH, "bssn_calc_constraints_vacuum", 1, 1, 1);
      break;
    }
    
    case 4:
    {
      EnsureStencilFits(cctkGH, "bssn_calc_constraints_vacuum", 2, 2, 2);
      break;
    }
    
    case 6:
    {
      EnsureStencilFits(cctkGH, "bssn_calc_constraints_vacuum", 3, 3, 3);
      break;
    }
    default:
      CCTK_BUILTIN_UNREACHABLE();
  ...
  LoopOverInterior(cctkGH, bssn_calc_constraints_vacuum_Body);
  if (verbose > 1)
  {
    CCTK_VInfo(CCTK_THORNSTRING,"Leaving bssn_calc_constraints_vacuum_Body");
  }
}
