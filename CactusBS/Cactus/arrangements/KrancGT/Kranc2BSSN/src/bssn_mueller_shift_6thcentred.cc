...
extern "C" void bssn_mueller_shift_6thcentred_SelectBCs(CCTK_ARGUMENTS)
{
  DECLARE_CCTK_ARGUMENTS;
  DECLARE_CCTK_PARAMETERS;
  
  if (cctk_iteration % bssn_mueller_shift_6thcentred_calc_every != bssn_mueller_shift_6thcentred_calc_offset)
    return;
...
static void bssn_mueller_shift_6thcentred_Body(const cGH* restrict const cctkGH, const int dir, const int face, const CCTK_REAL normal[3], const CCTK_REAL tangentA[3], const CCTK_REAL tangentB[3], const int imin[3], const int imax[3], const int n_subblock_gfs, CCTK_REAL* restrict const subblock_gfs[])
{
  DECLARE_CCTK_ARGUMENTS;
  DECLARE_CCTK_PARAMETERS;
  ...
  #pragma omp parallel
  CCTK_LOOP3(bssn_mueller_shift_6thcentred,
    ...
    cctk_ash[0],cctk_ash[1],cctk_ash[2])
  {
    ...
    CCTK_REAL muellerTop CCTK_ATTRIBUTE_UNUSED = 
      2*(hInv23*PDstandard6th2phi*PDstandard6th3phi + 
      PDstandard6th1phi*(hInv12*PDstandard6th2phi + 
      hInv13*PDstandard6th3phi)) + hInv11*pow(PDstandard6th1phi,2) + 
      hInv22*pow(PDstandard6th2phi,2) + hInv33*pow(PDstandard6th3phi,2);
  ...
  CCTK_ENDLOOP3(bssn_mueller_shift_6thcentred);
}
extern "C" void bssn_mueller_shift_6thcentred(CCTK_ARGUMENTS)
{
  DECLARE_CCTK_ARGUMENTS;
  DECLARE_CCTK_PARAMETERS;
  ...
  if (verbose > 1)
  {
    CCTK_VInfo(CCTK_THORNSTRING,"Entering bssn_mueller_shift_6thcentred_Body");
  }
  if (cctk_iteration % bssn_mueller_shift_6thcentred_calc_every != bssn_mueller_shift_6thcentred_calc_offset)
  {
    return;
  ...
  AssertGroupStorage(cctkGH, "bssn_mueller_shift_6thcentred", 9, groups);
  
  switch (constraintsfdorder)
  {
    case 2:
    {
      EnsureStencilFits(cctkGH, "bssn_mueller_shift_6thcentred", 3, 3, 3);
      break;
    }
  ...
  LoopOverInterior(cctkGH, bssn_mueller_shift_6thcentred_Body);
  if (verbose > 1)
  {
    CCTK_VInfo(CCTK_THORNSTRING,"Leaving bssn_mueller_shift_6thcentred_Body");
  }
}
