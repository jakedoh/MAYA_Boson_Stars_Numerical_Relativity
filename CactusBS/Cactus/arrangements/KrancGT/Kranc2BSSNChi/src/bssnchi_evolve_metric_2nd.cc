...
extern "C" void bssnchi_evolve_metric_2nd_SelectBCs(CCTK_ARGUMENTS)
{
  DECLARE_CCTK_ARGUMENTS;
  DECLARE_CCTK_PARAMETERS;
  
  if (cctk_iteration % bssnchi_evolve_metric_2nd_calc_every != bssnchi_evolve_metric_2nd_calc_offset)
    return;
...
static void bssnchi_evolve_metric_2nd_Body(const cGH* restrict const cctkGH, const int dir, const int face, const CCTK_REAL normal[3], const CCTK_REAL tangentA[3], const CCTK_REAL tangentB[3], const int imin[3], const int imax[3], const int n_subblock_gfs, CCTK_REAL* restrict const subblock_gfs[])
{
  DECLARE_CCTK_ARGUMENTS;
  DECLARE_CCTK_PARAMETERS;
  ...
  #pragma omp parallel
  CCTK_LOOP3(bssnchi_evolve_metric_2nd,
    ...
    cctk_ash[0],cctk_ash[1],cctk_ash[2])
  {
    ...
    CCTK_REAL chirhsL CCTK_ATTRIBUTE_UNUSED = 
      beta1L*PDonesided2nd1(&chi[index]) + beta2L*PDonesided2nd2(&chi[index]) 
      + beta3L*PDonesided2nd3(&chi[index]) - 
    ...
    CCTK_REAL h11rhsL CCTK_ATTRIBUTE_UNUSED = -2*A11L*alphaL + 
      beta1L*PDonesided2nd1(&h11[index]) + beta2L*PDonesided2nd2(&h11[index]) 
      + beta3L*PDonesided2nd3(&h11[index]) + 2*(h11L*PDstandard2nd1beta1 + 
      h21L*PDstandard2nd1beta2 + h31L*PDstandard2nd1beta3) - 
    ...
    CCTK_REAL h21rhsL CCTK_ATTRIBUTE_UNUSED = -2*A21L*alphaL + 
      beta1L*PDonesided2nd1(&h21[index]) + beta2L*PDonesided2nd2(&h21[index]) 
      + beta3L*PDonesided2nd3(&h21[index]) + h22L*PDstandard2nd1beta2 + 
      h32L*PDstandard2nd1beta3 + h11L*PDstandard2nd2beta1 + 
      h31L*PDstandard2nd2beta3 + 
    ...
    CCTK_REAL h31rhsL CCTK_ATTRIBUTE_UNUSED = -2*A31L*alphaL + 
      beta1L*PDonesided2nd1(&h31[index]) + beta2L*PDonesided2nd2(&h31[index]) 
      + beta3L*PDonesided2nd3(&h31[index]) + h32L*PDstandard2nd1beta2 + 
      h33L*PDstandard2nd1beta3 + h11L*PDstandard2nd3beta1 + 
      h21L*PDstandard2nd3beta2 + 
    ...
    CCTK_REAL h22rhsL CCTK_ATTRIBUTE_UNUSED = -2*A22L*alphaL + 
      beta1L*PDonesided2nd1(&h22[index]) + beta2L*PDonesided2nd2(&h22[index]) 
      + beta3L*PDonesided2nd3(&h22[index]) + 2*(h21L*PDstandard2nd2beta1 + 
    ...
    CCTK_REAL h32rhsL CCTK_ATTRIBUTE_UNUSED = -2*A32L*alphaL + 
      beta1L*PDonesided2nd1(&h32[index]) + beta2L*PDonesided2nd2(&h32[index]) 
      + beta3L*PDonesided2nd3(&h32[index]) + h31L*PDstandard2nd2beta1 + 
      h33L*PDstandard2nd2beta3 + h21L*PDstandard2nd3beta1 + 
      h22L*PDstandard2nd3beta2 + 
    ...
    CCTK_REAL h33rhsL CCTK_ATTRIBUTE_UNUSED = -2*A33L*alphaL + 
      beta1L*PDonesided2nd1(&h33[index]) + beta2L*PDonesided2nd2(&h33[index]) 
      + beta3L*PDonesided2nd3(&h33[index]) - 
      0.666666666666666666666666666667*h33L*(PDstandard2nd1beta1 + 
      PDstandard2nd2beta2 + PDstandard2nd3beta3) + 
      2*(h31L*PDstandard2nd3beta1 + h32L*PDstandard2nd3beta2 + 
      h33L*PDstandard2nd3beta3);
    /* Copy local copies back to grid functions */
  ...
  CCTK_ENDLOOP3(bssnchi_evolve_metric_2nd);
}
extern "C" void bssnchi_evolve_metric_2nd(CCTK_ARGUMENTS)
{
  DECLARE_CCTK_ARGUMENTS;
  DECLARE_CCTK_PARAMETERS;
  ...
  if (verbose > 1)
  {
    CCTK_VInfo(CCTK_THORNSTRING,"Entering bssnchi_evolve_metric_2nd_Body");
  }
  if (cctk_iteration % bssnchi_evolve_metric_2nd_calc_every != bssnchi_evolve_metric_2nd_calc_offset)
  {
    return;
  ...
  AssertGroupStorage(cctkGH, "bssnchi_evolve_metric_2nd", 8, groups);
  
  switch (constraintsfdorder)
  {
    case 2:
    {
      EnsureStencilFits(cctkGH, "bssnchi_evolve_metric_2nd", 2, 2, 2);
      break;
    }
  ...
  LoopOverInterior(cctkGH, bssnchi_evolve_metric_2nd_Body);
  if (verbose > 1)
  {
    CCTK_VInfo(CCTK_THORNSTRING,"Leaving bssnchi_evolve_metric_2nd_Body");
  }
}
