...
extern "C" void bssnchi_evolve_metric_4thcentred_SelectBCs(CCTK_ARGUMENTS)
{
  DECLARE_CCTK_ARGUMENTS;
  DECLARE_CCTK_PARAMETERS;
  
  if (cctk_iteration % bssnchi_evolve_metric_4thcentred_calc_every != bssnchi_evolve_metric_4thcentred_calc_offset)
    return;
...
static void bssnchi_evolve_metric_4thcentred_Body(const cGH* restrict const cctkGH, const int dir, const int face, const CCTK_REAL normal[3], const CCTK_REAL tangentA[3], const CCTK_REAL tangentB[3], const int imin[3], const int imax[3], const int n_subblock_gfs, CCTK_REAL* restrict const subblock_gfs[])
{
  DECLARE_CCTK_ARGUMENTS;
  DECLARE_CCTK_PARAMETERS;
  ...
  #pragma omp parallel
  CCTK_LOOP3(bssnchi_evolve_metric_4thcentred,
    ...
    cctk_ash[0],cctk_ash[1],cctk_ash[2])
  {
    ...
    CCTK_REAL chirhsL CCTK_ATTRIBUTE_UNUSED = beta1L*PDstandard4th1chi + 
      ...
      0.666666666666666666666666666667*chiL*(-(alphaL*KL) + 
      PDstandard4th1beta1 + PDstandard4th2beta2 + PDstandard4th3beta3) + 
      beta3L*PDstandard4th3chi;
  ...
  CCTK_ENDLOOP3(bssnchi_evolve_metric_4thcentred);
}
extern "C" void bssnchi_evolve_metric_4thcentred(CCTK_ARGUMENTS)
{
  DECLARE_CCTK_ARGUMENTS;
  DECLARE_CCTK_PARAMETERS;
  ...
  if (verbose > 1)
  {
    CCTK_VInfo(CCTK_THORNSTRING,"Entering bssnchi_evolve_metric_4thcentred_Body");
  }
  if (cctk_iteration % bssnchi_evolve_metric_4thcentred_calc_every != bssnchi_evolve_metric_4thcentred_calc_offset)
  {
    return;
  ...
  AssertGroupStorage(cctkGH, "bssnchi_evolve_metric_4thcentred", 8, groups);
  
  switch (constraintsfdorder)
  {
    case 2:
    {
      EnsureStencilFits(cctkGH, "bssnchi_evolve_metric_4thcentred", 2, 2, 2);
      break;
    }
  ...
  LoopOverInterior(cctkGH, bssnchi_evolve_metric_4thcentred_Body);
  if (verbose > 1)
  {
    CCTK_VInfo(CCTK_THORNSTRING,"Leaving bssnchi_evolve_metric_4thcentred_Body");
  }
}
