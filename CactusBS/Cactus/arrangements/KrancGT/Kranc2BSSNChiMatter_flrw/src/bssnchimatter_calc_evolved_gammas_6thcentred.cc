...
extern "C" void bssnchimatter_calc_evolved_gammas_6thcentred_SelectBCs(CCTK_ARGUMENTS)
{
  #ifdef DECLARE_CCTK_ARGUMENTS_bssnchimatter_calc_evolved_gammas_6thcentred_SelectBCs
  DECLARE_CCTK_ARGUMENTS_CHECKED(bssnchimatter_calc_evolved_gammas_6thcentred_SelectBCs);
  #else
  DECLARE_CCTK_ARGUMENTS;
  #endif
  DECLARE_CCTK_PARAMETERS;
  
  if (cctk_iteration % bssnchimatter_calc_evolved_gammas_6thcentred_calc_every != bssnchimatter_calc_evolved_gammas_6thcentred_calc_offset)
    return;
...
static void bssnchimatter_calc_evolved_gammas_6thcentred_Body(const cGH* restrict const cctkGH, const int dir, const int face, const CCTK_REAL normal[3], const CCTK_REAL tangentA[3], const CCTK_REAL tangentB[3], const int imin[3], const int imax[3], const int n_subblock_gfs, CCTK_REAL* restrict const subblock_gfs[])
{
  DECLARE_CCTK_ARGUMENTS;
  DECLARE_CCTK_PARAMETERS;
  ...
  #pragma omp parallel
  CCTK_LOOP3(bssnchimatter_calc_evolved_gammas_6thcentred,
    ...
    cctk_ash[0],cctk_ash[1],cctk_ash[2])
  {
    ...
    CCTK_REAL gamma111 CCTK_ATTRIBUTE_UNUSED = 
      0.5*(hInv11*PDstandard6th1h11 + 2*(hInv12*PDstandard6th1h21 + 
      hInv13*PDstandard6th1h31) - hInv12*PDstandard6th2h11 - 
      hInv13*PDstandard6th3h11);
    
    CCTK_REAL gamma211 CCTK_ATTRIBUTE_UNUSED = 
      0.5*(hInv12*PDstandard6th1h11 + 2*(hInv22*PDstandard6th1h21 + 
      hInv23*PDstandard6th1h31) - hInv22*PDstandard6th2h11 - 
      hInv23*PDstandard6th3h11);
    
    CCTK_REAL gamma311 CCTK_ATTRIBUTE_UNUSED = 
      0.5*(hInv13*PDstandard6th1h11 + 2*(hInv23*PDstandard6th1h21 + 
      hInv33*PDstandard6th1h31) - hInv23*PDstandard6th2h11 - 
      hInv33*PDstandard6th3h11);
    ...
    CCTK_REAL gamma122 CCTK_ATTRIBUTE_UNUSED = 
      0.5*(hInv11*(-PDstandard6th1h22 + 2*PDstandard6th2h21) + 
      hInv12*PDstandard6th2h22 + hInv13*(2*PDstandard6th2h32 - 
      PDstandard6th3h22));
    
    CCTK_REAL gamma222 CCTK_ATTRIBUTE_UNUSED = 
      0.5*(hInv12*(-PDstandard6th1h22 + 2*PDstandard6th2h21) + 
      hInv22*PDstandard6th2h22 + hInv23*(2*PDstandard6th2h32 - 
      PDstandard6th3h22));
    
    CCTK_REAL gamma322 CCTK_ATTRIBUTE_UNUSED = 
      0.5*(hInv13*(-PDstandard6th1h22 + 2*PDstandard6th2h21) + 
      hInv23*PDstandard6th2h22 + hInv33*(2*PDstandard6th2h32 - 
      PDstandard6th3h22));
    ...
    CCTK_REAL gamma133 CCTK_ATTRIBUTE_UNUSED = 
      0.5*(hInv11*(-PDstandard6th1h33 + 2*PDstandard6th3h31) + 
      hInv12*(-PDstandard6th2h33 + 2*PDstandard6th3h32) + 
      hInv13*PDstandard6th3h33);
    
    CCTK_REAL gamma233 CCTK_ATTRIBUTE_UNUSED = 
      0.5*(hInv12*(-PDstandard6th1h33 + 2*PDstandard6th3h31) + 
      hInv22*(-PDstandard6th2h33 + 2*PDstandard6th3h32) + 
      hInv23*PDstandard6th3h33);
    
    CCTK_REAL gamma333 CCTK_ATTRIBUTE_UNUSED = 
      0.5*(hInv13*(-PDstandard6th1h33 + 2*PDstandard6th3h31) + 
      hInv23*(-PDstandard6th2h33 + 2*PDstandard6th3h32) + 
      hInv33*PDstandard6th3h33);
  ...
  CCTK_ENDLOOP3(bssnchimatter_calc_evolved_gammas_6thcentred);
}
extern "C" void bssnchimatter_calc_evolved_gammas_6thcentred(CCTK_ARGUMENTS)
{
  #ifdef DECLARE_CCTK_ARGUMENTS_bssnchimatter_calc_evolved_gammas_6thcentred
  DECLARE_CCTK_ARGUMENTS_CHECKED(bssnchimatter_calc_evolved_gammas_6thcentred);
  #else
  DECLARE_CCTK_ARGUMENTS;
  #endif
  DECLARE_CCTK_PARAMETERS;
  ...
  if (verbose > 1)
  {
    CCTK_VInfo(CCTK_THORNSTRING,"Entering bssnchimatter_calc_evolved_gammas_6thcentred_Body");
  }
  if (cctk_iteration % bssnchimatter_calc_evolved_gammas_6thcentred_calc_every != bssnchimatter_calc_evolved_gammas_6thcentred_calc_offset)
  {
    return;
  ...
  AssertGroupStorage(cctkGH, "bssnchimatter_calc_evolved_gammas_6thcentred", 3, groups);
  
  switch (constraintsfdorder)
  {
    case 2:
    {
      EnsureStencilFits(cctkGH, "bssnchimatter_calc_evolved_gammas_6thcentred", 3, 3, 3);
      break;
    }
  ...
  LoopOverInterior(cctkGH, bssnchimatter_calc_evolved_gammas_6thcentred_Body);
  if (verbose > 1)
  {
    CCTK_VInfo(CCTK_THORNSTRING,"Leaving bssnchimatter_calc_evolved_gammas_6thcentred_Body");
  }
}
