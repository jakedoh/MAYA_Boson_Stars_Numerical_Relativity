...
extern "C" void bssnchimatter_evolve_metric_4thcentred_SelectBCs(CCTK_ARGUMENTS)
{
  #ifdef DECLARE_CCTK_ARGUMENTS_bssnchimatter_evolve_metric_4thcentred_SelectBCs
  DECLARE_CCTK_ARGUMENTS_CHECKED(bssnchimatter_evolve_metric_4thcentred_SelectBCs);
  #else
  DECLARE_CCTK_ARGUMENTS;
  #endif
  DECLARE_CCTK_PARAMETERS;
  
  if (cctk_iteration % bssnchimatter_evolve_metric_4thcentred_calc_every != bssnchimatter_evolve_metric_4thcentred_calc_offset)
    return;
  CCTK_INT ierr CCTK_ATTRIBUTE_UNUSED = 0;
  ierr = KrancBdy_SelectGroupForBC(cctkGH, CCTK_ALL_FACES, GetBoundaryWidth(cctkGH), -1 /* no table */, "Kranc2BSSNChiMatter::chi_grouprhs","flat");
  if (ierr < 0)
    CCTK_WARN(CCTK_WARN_ALERT, "Failed to register flat BC for Kranc2BSSNChiMatter::chi_grouprhs.");
  ierr = KrancBdy_SelectGroupForBC(cctkGH, CCTK_ALL_FACES, GetBoundaryWidth(cctkGH), -1 /* no table */, "Kranc2BSSNChiMatter::h_grouprhs","flat");
  if (ierr < 0)
    CCTK_WARN(CCTK_WARN_ALERT, "Failed to register flat BC for Kranc2BSSNChiMatter::h_grouprhs.");
  return;
}

static void bssnchimatter_evolve_metric_4thcentred_Body(const cGH* restrict const cctkGH, const int dir, const int face, const CCTK_REAL normal[3], const CCTK_REAL tangentA[3], const CCTK_REAL tangentB[3], const int imin[3], const int imax[3], const int n_subblock_gfs, CCTK_REAL* restrict const subblock_gfs[])
{
  DECLARE_CCTK_ARGUMENTS;
  DECLARE_CCTK_PARAMETERS;
  ...
  #pragma omp parallel
  CCTK_LOOP3(bssnchimatter_evolve_metric_4thcentred,
    ...
    cctk_ash[0],cctk_ash[1],cctk_ash[2])
  {
    ...
    CCTK_REAL chirhsL CCTK_ATTRIBUTE_UNUSED = beta1L*PDstandard4th1chi + 
      beta2L*PDstandard4th2chi + 
      chiL*(0.666666666666666666666666666667*alphaL*KL - 
      0.666666666666666666666666666667*(PDstandard4th1beta1 + 
      PDstandard4th2beta2 + PDstandard4th3beta3)) + beta3L*PDstandard4th3chi;
    
    CCTK_REAL h11rhsL CCTK_ATTRIBUTE_UNUSED = -2*A11L*alphaL + 
      2*(h11L*PDstandard4th1beta1 + h21L*PDstandard4th1beta2 + 
      h31L*PDstandard4th1beta3) + beta1L*PDstandard4th1h11 + 
      beta2L*PDstandard4th2h11 - 
      0.666666666666666666666666666667*h11L*(PDstandard4th1beta1 + 
      PDstandard4th2beta2 + PDstandard4th3beta3) + beta3L*PDstandard4th3h11;
    
    CCTK_REAL h21rhsL CCTK_ATTRIBUTE_UNUSED = -2*A21L*alphaL + 
      h22L*PDstandard4th1beta2 + h32L*PDstandard4th1beta3 + 
      beta1L*PDstandard4th1h21 + h11L*PDstandard4th2beta1 + 
      h31L*PDstandard4th2beta3 + beta2L*PDstandard4th2h21 + 
      h21L*(0.333333333333333333333333333333*(PDstandard4th1beta1 + 
      PDstandard4th2beta2) - 
      0.666666666666666666666666666667*PDstandard4th3beta3) + 
      beta3L*PDstandard4th3h21;
    
    CCTK_REAL h31rhsL CCTK_ATTRIBUTE_UNUSED = -2*A31L*alphaL + 
      h32L*PDstandard4th1beta2 + h33L*PDstandard4th1beta3 + 
      beta1L*PDstandard4th1h31 + beta2L*PDstandard4th2h31 + 
      h11L*PDstandard4th3beta1 + h21L*PDstandard4th3beta2 + 
      h31L*(-0.666666666666666666666666666667*PDstandard4th2beta2 + 
      0.333333333333333333333333333333*(PDstandard4th1beta1 + 
      PDstandard4th3beta3)) + beta3L*PDstandard4th3h31;
    
    CCTK_REAL h22rhsL CCTK_ATTRIBUTE_UNUSED = -2*A22L*alphaL + 
      beta1L*PDstandard4th1h22 + 2*(h21L*PDstandard4th2beta1 + 
      h22L*PDstandard4th2beta2 + h32L*PDstandard4th2beta3) + 
      beta2L*PDstandard4th2h22 - 
      0.666666666666666666666666666667*h22L*(PDstandard4th1beta1 + 
      PDstandard4th2beta2 + PDstandard4th3beta3) + beta3L*PDstandard4th3h22;
    
    CCTK_REAL h32rhsL CCTK_ATTRIBUTE_UNUSED = -2*A32L*alphaL + 
      beta1L*PDstandard4th1h32 + h31L*PDstandard4th2beta1 + 
      h33L*PDstandard4th2beta3 + beta2L*PDstandard4th2h32 + 
      h21L*PDstandard4th3beta1 + h22L*PDstandard4th3beta2 + 
      h32L*(-0.666666666666666666666666666667*PDstandard4th1beta1 + 
      0.333333333333333333333333333333*(PDstandard4th2beta2 + 
      PDstandard4th3beta3)) + beta3L*PDstandard4th3h32;
    
    CCTK_REAL h33rhsL CCTK_ATTRIBUTE_UNUSED = -2*A33L*alphaL + 
      beta1L*PDstandard4th1h33 + beta2L*PDstandard4th2h33 - 
      0.666666666666666666666666666667*h33L*(PDstandard4th1beta1 + 
      PDstandard4th2beta2 + PDstandard4th3beta3) + 
      2*(h31L*PDstandard4th3beta1 + h32L*PDstandard4th3beta2 + 
      h33L*PDstandard4th3beta3) + beta3L*PDstandard4th3h33;
    /* Copy local copies back to grid functions */
  ...
  CCTK_ENDLOOP3(bssnchimatter_evolve_metric_4thcentred);
}
extern "C" void bssnchimatter_evolve_metric_4thcentred(CCTK_ARGUMENTS)
{
  #ifdef DECLARE_CCTK_ARGUMENTS_bssnchimatter_evolve_metric_4thcentred
  DECLARE_CCTK_ARGUMENTS_CHECKED(bssnchimatter_evolve_metric_4thcentred);
  #else
  DECLARE_CCTK_ARGUMENTS;
  #endif
  DECLARE_CCTK_PARAMETERS;
  ...
  if (verbose > 1)
  {
    CCTK_VInfo(CCTK_THORNSTRING,"Entering bssnchimatter_evolve_metric_4thcentred_Body");
  }
  if (cctk_iteration % bssnchimatter_evolve_metric_4thcentred_calc_every != bssnchimatter_evolve_metric_4thcentred_calc_offset)
  {
    return;
  ...
  AssertGroupStorage(cctkGH, "bssnchimatter_evolve_metric_4thcentred", 8, groups);
  
  switch (constraintsfdorder)
  {
    case 2:
    {
      EnsureStencilFits(cctkGH, "bssnchimatter_evolve_metric_4thcentred", 2, 2, 2);
      break;
    }
  ...
  LoopOverInterior(cctkGH, bssnchimatter_evolve_metric_4thcentred_Body);
  if (verbose > 1)
  {
    CCTK_VInfo(CCTK_THORNSTRING,"Leaving bssnchimatter_evolve_metric_4thcentred_Body");
  }
}
