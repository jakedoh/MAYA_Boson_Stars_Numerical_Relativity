...
static void bssnchimatter_evolved_to_adm_initial_Body(const cGH* restrict const cctkGH, const int dir, const int face, const CCTK_REAL normal[3], const CCTK_REAL tangentA[3], const CCTK_REAL tangentB[3], const int imin[3], const int imax[3], const int n_subblock_gfs, CCTK_REAL* restrict const subblock_gfs[])
{
  ...
  #pragma omp parallel
  CCTK_LOOP3(bssnchimatter_evolved_to_adm_initial,
    ...
    cctk_ash[0],cctk_ash[1],cctk_ash[2])
  {
    ...
    CCTK_REAL e4phi CCTK_ATTRIBUTE_UNUSED = pow(fmax(chiL,chiEps),-1);
    
    CCTK_REAL g11 CCTK_ATTRIBUTE_UNUSED = h11L*e4phi;
    
    CCTK_REAL g21 CCTK_ATTRIBUTE_UNUSED = h21L*e4phi;
    
    CCTK_REAL g31 CCTK_ATTRIBUTE_UNUSED = h31L*e4phi;
    
    CCTK_REAL g22 CCTK_ATTRIBUTE_UNUSED = h22L*e4phi;
    
    CCTK_REAL g32 CCTK_ATTRIBUTE_UNUSED = h32L*e4phi;
    
    CCTK_REAL g33 CCTK_ATTRIBUTE_UNUSED = h33L*e4phi;
    
    CCTK_REAL k11 CCTK_ATTRIBUTE_UNUSED = A11L*e4phi + 
      0.333333333333333333333333333333*KL*g11;
    
    CCTK_REAL k21 CCTK_ATTRIBUTE_UNUSED = A21L*e4phi + 
      0.333333333333333333333333333333*KL*g21;
    
    CCTK_REAL k31 CCTK_ATTRIBUTE_UNUSED = A31L*e4phi + 
      0.333333333333333333333333333333*KL*g31;
    
    CCTK_REAL k22 CCTK_ATTRIBUTE_UNUSED = A22L*e4phi + 
      0.333333333333333333333333333333*KL*g22;
    
    CCTK_REAL k32 CCTK_ATTRIBUTE_UNUSED = A32L*e4phi + 
      0.333333333333333333333333333333*KL*g32;
    
    CCTK_REAL k33 CCTK_ATTRIBUTE_UNUSED = A33L*e4phi + 
      0.333333333333333333333333333333*KL*g33;
    
    CCTK_REAL gxxL CCTK_ATTRIBUTE_UNUSED = g11;
    
    CCTK_REAL gxyL CCTK_ATTRIBUTE_UNUSED = g21;
    
    CCTK_REAL gyyL CCTK_ATTRIBUTE_UNUSED = g22;
    
    CCTK_REAL gxzL CCTK_ATTRIBUTE_UNUSED = g31;
    
    CCTK_REAL gyzL CCTK_ATTRIBUTE_UNUSED = g32;
    
    CCTK_REAL gzzL CCTK_ATTRIBUTE_UNUSED = g33;
    
    CCTK_REAL kxxL CCTK_ATTRIBUTE_UNUSED = k11;
    
    CCTK_REAL kxyL CCTK_ATTRIBUTE_UNUSED = k21;
    
    CCTK_REAL kyyL CCTK_ATTRIBUTE_UNUSED = k22;
    
    CCTK_REAL kxzL CCTK_ATTRIBUTE_UNUSED = k31;
    
    CCTK_REAL kyzL CCTK_ATTRIBUTE_UNUSED = k32;
    
    CCTK_REAL kzzL CCTK_ATTRIBUTE_UNUSED = k33;
  ...
  CCTK_ENDLOOP3(bssnchimatter_evolved_to_adm_initial);
}
extern "C" void bssnchimatter_evolved_to_adm_initial(CCTK_ARGUMENTS)
{
  #ifdef DECLARE_CCTK_ARGUMENTS_bssnchimatter_evolved_to_adm_initial
  DECLARE_CCTK_ARGUMENTS_CHECKED(bssnchimatter_evolved_to_adm_initial);
  #else
  DECLARE_CCTK_ARGUMENTS;
  #endif
  DECLARE_CCTK_PARAMETERS;
  ...
  if (verbose > 1)
  {
    CCTK_VInfo(CCTK_THORNSTRING,"Entering bssnchimatter_evolved_to_adm_initial_Body");
  }
  if (cctk_iteration % bssnchimatter_evolved_to_adm_initial_calc_every != bssnchimatter_evolved_to_adm_initial_calc_offset)
  {
    return;
  }
  ...
  AssertGroupStorage(cctkGH, "bssnchimatter_evolved_to_adm_initial", 10, groups);
  ...
  LoopOverEverything(cctkGH, bssnchimatter_evolved_to_adm_initial_Body);
  if (verbose > 1)
  {
    CCTK_VInfo(CCTK_THORNSTRING,"Leaving bssnchimatter_evolved_to_adm_initial_Body");
  }
}
