...
{
  #ifdef DECLARE_CCTK_ARGUMENTS_bssnchimatter_external_shift_6th_SelectBCs
  DECLARE_CCTK_ARGUMENTS_CHECKED(bssnchimatter_external_shift_6th_SelectBCs);
  #else
...
{
  #ifdef DECLARE_CCTK_ARGUMENTS_bssnchimatter_external_shift_6th
  DECLARE_CCTK_ARGUMENTS_CHECKED(bssnchimatter_external_shift_6th);
  #else
  DECLARE_CCTK_ARGUMENTS;
  #endif
  DECLARE_CCTK_PARAMETERS;
