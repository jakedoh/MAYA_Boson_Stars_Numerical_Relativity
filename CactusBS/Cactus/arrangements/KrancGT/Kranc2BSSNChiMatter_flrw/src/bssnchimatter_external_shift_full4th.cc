...
{
  #ifdef DECLARE_CCTK_ARGUMENTS_bssnchimatter_external_shift_full4th_SelectBCs
  DECLARE_CCTK_ARGUMENTS_CHECKED(bssnchimatter_external_shift_full4th_SelectBCs);
  #else
...
{
  #ifdef DECLARE_CCTK_ARGUMENTS_bssnchimatter_external_shift_full4th
  DECLARE_CCTK_ARGUMENTS_CHECKED(bssnchimatter_external_shift_full4th);
  #else
  DECLARE_CCTK_ARGUMENTS;
  #endif
  DECLARE_CCTK_PARAMETERS;
