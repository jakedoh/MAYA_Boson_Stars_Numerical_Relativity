...
{
  #ifdef DECLARE_CCTK_ARGUMENTS_bssnchimatter_nasa_shift_2ndcentred_SelectBCs
  DECLARE_CCTK_ARGUMENTS_CHECKED(bssnchimatter_nasa_shift_2ndcentred_SelectBCs);
  #else
...
{
  #ifdef DECLARE_CCTK_ARGUMENTS_bssnchimatter_nasa_shift_2ndcentred
  DECLARE_CCTK_ARGUMENTS_CHECKED(bssnchimatter_nasa_shift_2ndcentred);
  #else
  DECLARE_CCTK_ARGUMENTS;
  #endif
  DECLARE_CCTK_PARAMETERS;
  ...
  AssertGroupStorage(cctkGH, "bssnchimatter_nasa_shift_2ndcentred", 8, groups);
