...
extern "C" void bssnmatter_evolve_nonmetric_4thcentred_SelectBCs(CCTK_ARGUMENTS)
{
  DECLARE_CCTK_ARGUMENTS;
  DECLARE_CCTK_PARAMETERS;
  
  if (cctk_iteration % bssnmatter_evolve_nonmetric_4thcentred_calc_every != bssnmatter_evolve_nonmetric_4thcentred_calc_offset)
    return;
  ...
  if (ierr < 0)
    CCTK_WARN(1, "Failed to register flat BC for Kranc2BSSNMatter::A_grouprhs.");
  ...
  if (ierr < 0)
    CCTK_WARN(1, "Failed to register flat BC for Kranc2BSSNMatter::Gam_grouprhs.");
  ierr = Boundary_SelectGroupForBC(cctkGH, CCTK_ALL_FACES, GetBoundaryWidth(cctkGH), -1 /* no table */, "Kranc2BSSNMatter::K_grouprhs","flat");
  if (ierr < 0)
    CCTK_WARN(1, "Failed to register flat BC for Kranc2BSSNMatter::K_grouprhs.");
  ...
  if (ierr < 0)
    CCTK_WARN(1, "Failed to register flat BC for Kranc2BSSNMatter::scalarconstraints.");
  return;
}

static void bssnmatter_evolve_nonmetric_4thcentred_Body(const cGH* restrict const cctkGH, const int dir, const int face, const CCTK_REAL normal[3], const CCTK_REAL tangentA[3], const CCTK_REAL tangentB[3], const int imin[3], const int imax[3], const int n_subblock_gfs, CCTK_REAL* restrict const subblock_gfs[])
{
  DECLARE_CCTK_ARGUMENTS;
  DECLARE_CCTK_PARAMETERS;
  ...
  #pragma omp parallel
  CCTK_LOOP3(bssnmatter_evolve_nonmetric_4thcentred,
    ...
    cctk_ash[0],cctk_ash[1],cctk_ash[2])
  {
    ...
    CCTK_REAL PDstandard4th11phi CCTK_ATTRIBUTE_UNUSED;
    CCTK_REAL PDstandard4th22phi CCTK_ATTRIBUTE_UNUSED;
    CCTK_REAL PDstandard4th33phi CCTK_ATTRIBUTE_UNUSED;
    CCTK_REAL PDstandard4th12phi CCTK_ATTRIBUTE_UNUSED;
    CCTK_REAL PDstandard4th13phi CCTK_ATTRIBUTE_UNUSED;
    CCTK_REAL PDstandard4th23phi CCTK_ATTRIBUTE_UNUSED;
    ...
    switch (constraintsfdorder)
    {
      case 2:
      {
        ...
        PDstandard4th11phi = PDstandard4th11(&phi[index]);
        PDstandard4th22phi = PDstandard4th22(&phi[index]);
        PDstandard4th33phi = PDstandard4th33(&phi[index]);
        PDstandard4th12phi = PDstandard4th12(&phi[index]);
        PDstandard4th13phi = PDstandard4th13(&phi[index]);
        PDstandard4th23phi = PDstandard4th23(&phi[index]);
        break;
      }
    ...
    CCTK_REAL DDphi11 CCTK_ATTRIBUTE_UNUSED = PDstandard4th11phi - 
      gamma111*PDstandard4th1phi - gamma211*PDstandard4th2phi - 
      gamma311*PDstandard4th3phi;
    
    CCTK_REAL DDphi21 CCTK_ATTRIBUTE_UNUSED = PDstandard4th12phi - 
      gamma121*PDstandard4th1phi - gamma221*PDstandard4th2phi - 
      gamma321*PDstandard4th3phi;
    
    CCTK_REAL DDphi31 CCTK_ATTRIBUTE_UNUSED = PDstandard4th13phi - 
      gamma131*PDstandard4th1phi - gamma231*PDstandard4th2phi - 
      gamma331*PDstandard4th3phi;
    
    CCTK_REAL DDphi12 CCTK_ATTRIBUTE_UNUSED = PDstandard4th12phi - 
      gamma121*PDstandard4th1phi - gamma221*PDstandard4th2phi - 
      gamma321*PDstandard4th3phi;
    
    CCTK_REAL DDphi22 CCTK_ATTRIBUTE_UNUSED = 
      -(gamma122*PDstandard4th1phi) + PDstandard4th22phi - 
      gamma222*PDstandard4th2phi - gamma322*PDstandard4th3phi;
    
    CCTK_REAL DDphi32 CCTK_ATTRIBUTE_UNUSED = 
      -(gamma132*PDstandard4th1phi) + PDstandard4th23phi - 
      gamma232*PDstandard4th2phi - gamma332*PDstandard4th3phi;
    
    CCTK_REAL DDphi13 CCTK_ATTRIBUTE_UNUSED = PDstandard4th13phi - 
      gamma131*PDstandard4th1phi - gamma231*PDstandard4th2phi - 
      gamma331*PDstandard4th3phi;
    ...
    CCTK_REAL DDphi33 CCTK_ATTRIBUTE_UNUSED = 
      -(gamma133*PDstandard4th1phi) - gamma233*PDstandard4th2phi + 
      PDstandard4th33phi - gamma333*PDstandard4th3phi;
    
    CCTK_REAL Dphi1 CCTK_ATTRIBUTE_UNUSED = PDstandard4th1phi;
    
    CCTK_REAL Dphi2 CCTK_ATTRIBUTE_UNUSED = PDstandard4th2phi;
    
    CCTK_REAL Dphi3 CCTK_ATTRIBUTE_UNUSED = PDstandard4th3phi;
  ...
  CCTK_ENDLOOP3(bssnmatter_evolve_nonmetric_4thcentred);
}
extern "C" void bssnmatter_evolve_nonmetric_4thcentred(CCTK_ARGUMENTS)
{
  DECLARE_CCTK_ARGUMENTS;
  DECLARE_CCTK_PARAMETERS;
  ...
  if (verbose > 1)
  {
    CCTK_VInfo(CCTK_THORNSTRING,"Entering bssnmatter_evolve_nonmetric_4thcentred_Body");
  }
  if (cctk_iteration % bssnmatter_evolve_nonmetric_4thcentred_calc_every != bssnmatter_evolve_nonmetric_4thcentred_calc_offset)
  {
    return;
  ...
  AssertGroupStorage(cctkGH, "bssnmatter_evolve_nonmetric_4thcentred", 11, groups);
  
  switch (constraintsfdorder)
  {
    case 2:
    {
      EnsureStencilFits(cctkGH, "bssnmatter_evolve_nonmetric_4thcentred", 2, 2, 2);
      break;
    }
  ...
  LoopOverInterior(cctkGH, bssnmatter_evolve_nonmetric_4thcentred_Body);
  if (verbose > 1)
  {
    CCTK_VInfo(CCTK_THORNSTRING,"Leaving bssnmatter_evolve_nonmetric_4thcentred_Body");
  }
}
