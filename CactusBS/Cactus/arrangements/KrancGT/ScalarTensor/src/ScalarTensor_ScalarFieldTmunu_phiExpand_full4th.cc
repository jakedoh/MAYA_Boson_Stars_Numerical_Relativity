...
extern "C" void ScalarTensor_ScalarFieldTmunu_phiExpand_full4th_SelectBCs(CCTK_ARGUMENTS)
{
  DECLARE_CCTK_ARGUMENTS;
  DECLARE_CCTK_PARAMETERS;
  
  if (cctk_iteration % ScalarTensor_ScalarFieldTmunu_phiExpand_full4th_calc_every != ScalarTensor_ScalarFieldTmunu_phiExpand_full4th_calc_offset)
    return;
...
static void ScalarTensor_ScalarFieldTmunu_phiExpand_full4th_Body(const cGH* restrict const cctkGH, const int dir, const int face, const CCTK_REAL normal[3], const CCTK_REAL tangentA[3], const CCTK_REAL tangentB[3], const int imin[3], const int imax[3], const int n_subblock_gfs, CCTK_REAL* restrict const subblock_gfs[])
{
  DECLARE_CCTK_ARGUMENTS;
  DECLARE_CCTK_PARAMETERS;
  ...
  #pragma omp parallel
  CCTK_LOOP3(ScalarTensor_ScalarFieldTmunu_phiExpand_full4th,
    ...
    cctk_ash[0],cctk_ash[1],cctk_ash[2])
  {
    ...
    CCTK_REAL STTij21 CCTK_ATTRIBUTE_UNUSED = 
      PDstandard4th1STphi*PDstandard4th2STphi - 0.5*gLocal21L*(dSTphiSqr + 
    ...
    CCTK_REAL STTij31 CCTK_ATTRIBUTE_UNUSED = 
      PDstandard4th1STphi*PDstandard4th3STphi - 0.5*gLocal31L*(dSTphiSqr + 
      pow(STphiL,2)*pow(fieldMass,2) + 
      0.166666666666666666666666666667*(12*V0 + 
      Vlambda*pow(STphiL,2)*(2*pow(STphiL,4) - 3*pow(STphiL,2)*(1 + 
      pow(Veps,2))*pow(Veta,2) + 6*pow(Veps,2)*pow(Veta,4))));
    ...
    CCTK_REAL STTij32 CCTK_ATTRIBUTE_UNUSED = 
      PDstandard4th2STphi*PDstandard4th3STphi - 0.5*gLocal32L*(dSTphiSqr + 
      pow(STphiL,2)*pow(fieldMass,2) + 
      0.166666666666666666666666666667*(12*V0 + 
      Vlambda*pow(STphiL,2)*(2*pow(STphiL,4) - 3*pow(STphiL,2)*(1 + 
      pow(Veps,2))*pow(Veta,2) + 6*pow(Veps,2)*pow(Veta,4))));
  ...
  CCTK_ENDLOOP3(ScalarTensor_ScalarFieldTmunu_phiExpand_full4th);
}
extern "C" void ScalarTensor_ScalarFieldTmunu_phiExpand_full4th(CCTK_ARGUMENTS)
{
  DECLARE_CCTK_ARGUMENTS;
  DECLARE_CCTK_PARAMETERS;
  ...
  if (verbose > 1)
  {
    CCTK_VInfo(CCTK_THORNSTRING,"Entering ScalarTensor_ScalarFieldTmunu_phiExpand_full4th_Body");
  }
  if (cctk_iteration % ScalarTensor_ScalarFieldTmunu_phiExpand_full4th_calc_every != ScalarTensor_ScalarFieldTmunu_phiExpand_full4th_calc_offset)
  {
    return;
  ...
  AssertGroupStorage(cctkGH, "ScalarTensor_ScalarFieldTmunu_phiExpand_full4th", 6, groups);
  
  EnsureStencilFits(cctkGH, "ScalarTensor_ScalarFieldTmunu_phiExpand_full4th", 3, 3, 3);
  
  LoopOverInterior(cctkGH, ScalarTensor_ScalarFieldTmunu_phiExpand_full4th_Body);
  if (verbose > 1)
  {
    CCTK_VInfo(CCTK_THORNSTRING,"Leaving ScalarTensor_ScalarFieldTmunu_phiExpand_full4th_Body");
  }
}
