! $Id: SetupSphere.F90 50 2008-05-30 07:21:25Z reisswig $
...
subroutine WavExtr_SetupSphere(CCTK_ARGUMENTS)
  ...
  do i=1,maximum_detector_number
    ...
    !print*,'WaveExtract: ntheta.',int_ntheta(i)
    !print*,'WaveExtract: nphi.',int_nphi(i)
    !print*,'WaveExtract: detector_radius.',detector_radius(i)
  end do
