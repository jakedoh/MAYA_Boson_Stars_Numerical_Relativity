...
{
#endif
	void bowenid_getSourceInfo(double xx, double yy, double zz, double *GradPhiSqr, double *MagPi, double *V, double jhat[3], double *psi, double *psiguess, double Aij[3][3]);
	...
	void bowenid_getInitialPhi(double xx, double yy, double zz, double Phi[3]);
        void bowenid_getInitialConformalPi(double xx, double yy, double zz, double confPi[3]);
#ifdef __cplusplus
}
#endif
