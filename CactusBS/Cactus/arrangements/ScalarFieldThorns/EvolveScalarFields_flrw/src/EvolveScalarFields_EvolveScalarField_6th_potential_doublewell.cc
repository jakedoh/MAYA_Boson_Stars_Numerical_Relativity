...
extern "C" void EvolveScalarFields_EvolveScalarField_6th_potential_doublewell_SelectBCs(CCTK_ARGUMENTS)
{
  #ifdef DECLARE_CCTK_ARGUMENTS_EvolveScalarFields_EvolveScalarField_6th_potential_doublewell_SelectBCs
  DECLARE_CCTK_ARGUMENTS_CHECKED(EvolveScalarFields_EvolveScalarField_6th_potential_doublewell_SelectBCs);
  #else
  DECLARE_CCTK_ARGUMENTS;
  #endif
  DECLARE_CCTK_PARAMETERS;
  
  if (cctk_iteration % EvolveScalarFields_EvolveScalarField_6th_potential_doublewell_calc_every != EvolveScalarFields_EvolveScalarField_6th_potential_doublewell_calc_offset)
    return;
...
static void EvolveScalarFields_EvolveScalarField_6th_potential_doublewell_Body(const cGH* restrict const cctkGH, const int dir, const int face, const CCTK_REAL normal[3], const CCTK_REAL tangentA[3], const CCTK_REAL tangentB[3], const int imin[3], const int imax[3], const int n_subblock_gfs, CCTK_REAL* restrict const subblock_gfs[])
{
  ...
  #pragma omp parallel
  CCTK_LOOP3(EvolveScalarFields_EvolveScalarField_6th_potential_doublewell,
  ...
  CCTK_ENDLOOP3(EvolveScalarFields_EvolveScalarField_6th_potential_doublewell);
}
extern "C" void EvolveScalarFields_EvolveScalarField_6th_potential_doublewell(CCTK_ARGUMENTS)
{
  #ifdef DECLARE_CCTK_ARGUMENTS_EvolveScalarFields_EvolveScalarField_6th_potential_doublewell
  DECLARE_CCTK_ARGUMENTS_CHECKED(EvolveScalarFields_EvolveScalarField_6th_potential_doublewell);
  #else
  DECLARE_CCTK_ARGUMENTS;
  #endif
  DECLARE_CCTK_PARAMETERS;
  ...
  if (verbose > 1)
  {
    CCTK_VInfo(CCTK_THORNSTRING,"Entering EvolveScalarFields_EvolveScalarField_6th_potential_doublewell_Body");
  }
  if (cctk_iteration % EvolveScalarFields_EvolveScalarField_6th_potential_doublewell_calc_every != EvolveScalarFields_EvolveScalarField_6th_potential_doublewell_calc_offset)
  {
    return;
  ...
  AssertGroupStorage(cctkGH, "EvolveScalarFields_EvolveScalarField_6th_potential_doublewell", 12, groups);
  
  EnsureStencilFits(cctkGH, "EvolveScalarFields_EvolveScalarField_6th_potential_doublewell", 4, 4, 4);
  
  LoopOverInterior(cctkGH, EvolveScalarFields_EvolveScalarField_6th_potential_doublewell_Body);
  if (verbose > 1)
  {
    CCTK_VInfo(CCTK_THORNSTRING,"Leaving EvolveScalarFields_EvolveScalarField_6th_potential_doublewell_Body");
  }
}
