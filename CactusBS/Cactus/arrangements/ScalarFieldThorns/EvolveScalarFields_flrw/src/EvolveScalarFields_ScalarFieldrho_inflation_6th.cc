...
static void EvolveScalarFields_ScalarFieldrho_inflation_6th_Body(const cGH* restrict const cctkGH, const int dir, const int face, const CCTK_REAL normal[3], const CCTK_REAL tangentA[3], const CCTK_REAL tangentB[3], const int imin[3], const int imax[3], const int n_subblock_gfs, CCTK_REAL* restrict const subblock_gfs[])
{
    ...
    cctk_ash[0],cctk_ash[1],cctk_ash[2])
  {
    ...
    SFTttL = pow(dtphia,2) + pow(dtphib,2) - 0.25*(betaSqr - 
      pow(alpL,2))*(2*(dphiaSqr + dphibSqr) + 4*Vi0 + 
      lambdaphia*pow(-pow(phiaL,2) + pow(phi00,2),2) + 
    ...
    CCTK_REAL SFTtj1 CCTK_ATTRIBUTE_UNUSED = dtphia*PDstandard6th1phia + 
      ...
      betazL*gxzL)*(2*(dphiaSqr + dphibSqr) + 4*Vi0 + 
      lambdaphia*(pow(phiaL,4) - 2*pow(phiaL,2)*pow(phi00,2) + pow(phi00,4)) 
      + lambdaphibn*(pow(phibL,4) - 2*pow(phibL,2)*pow(phibv,2) + 
      pow(phibv,4)));
    
    CCTK_REAL SFTtj2 CCTK_ATTRIBUTE_UNUSED = dtphia*PDstandard6th2phia + 
      dtphib*PDstandard6th2phib - 0.25*(betaxL*gxyL + betayL*gyyL + 
      betazL*gyzL)*(2*(dphiaSqr + dphibSqr) + 4*Vi0 + 
      lambdaphia*(pow(phiaL,4) - 2*pow(phiaL,2)*pow(phi00,2) + pow(phi00,4)) 
      + lambdaphibn*(pow(phibL,4) - 2*pow(phibL,2)*pow(phibv,2) + 
      pow(phibv,4)));
    ...
    CCTK_REAL SFTtj3 CCTK_ATTRIBUTE_UNUSED = dtphia*PDstandard6th3phia + 
      ...
      betazL*gzzL)*(2*(dphiaSqr + dphibSqr) + 4*Vi0 + 
      lambdaphia*(pow(phiaL,4) - 2*pow(phiaL,2)*pow(phi00,2) + pow(phi00,4)) 
      + lambdaphibn*(pow(phibL,4) - 2*pow(phibL,2)*pow(phibv,2) + 
      pow(phibv,4)));
    
    CCTK_REAL SFTij11 CCTK_ATTRIBUTE_UNUSED = pow(PDstandard6th1phia,2) + 
      pow(PDstandard6th1phib,2) - 0.25*gxxL*(2*(dphiaSqr + dphibSqr) + 4*Vi0 
      + lambdaphia*pow(-pow(phiaL,2) + pow(phi00,2),2) + 
      lambdaphibn*pow(pow(phibL,2) - pow(phibv,2),2));
    ...
    CCTK_REAL SFTij21 CCTK_ATTRIBUTE_UNUSED = 
      ...
      dphibSqr) + 4*Vi0 + lambdaphia*pow(-pow(phiaL,2) + pow(phi00,2),2) + 
      lambdaphibn*pow(pow(phibL,2) - pow(phibv,2),2));
    ...
    CCTK_REAL SFTij22 CCTK_ATTRIBUTE_UNUSED = pow(PDstandard6th2phia,2) + 
      pow(PDstandard6th2phib,2) - 0.25*gyyL*(2*(dphiaSqr + dphibSqr) + 4*Vi0 
      + lambdaphia*pow(-pow(phiaL,2) + pow(phi00,2),2) + 
      lambdaphibn*pow(pow(phibL,2) - pow(phibv,2),2));
    ...
    CCTK_REAL SFTij33 CCTK_ATTRIBUTE_UNUSED = pow(PDstandard6th3phia,2) + 
      pow(PDstandard6th3phib,2) - 0.25*gzzL*(2*(dphiaSqr + dphibSqr) + 4*Vi0 
      + lambdaphia*pow(-pow(phiaL,2) + pow(phi00,2),2) + 
      lambdaphibn*pow(pow(phibL,2) - pow(phibv,2),2));
