...
{
  #ifdef DECLARE_CCTK_ARGUMENTS_EvolveScalarFields_EvolveScalarField_6th_potential_onlymass_SelectBCs
  DECLARE_CCTK_ARGUMENTS_CHECKED(EvolveScalarFields_EvolveScalarField_6th_potential_onlymass_SelectBCs);
  #else
...
{
  #ifdef DECLARE_CCTK_ARGUMENTS_EvolveScalarFields_EvolveScalarField_6th_potential_onlymass
  DECLARE_CCTK_ARGUMENTS_CHECKED(EvolveScalarFields_EvolveScalarField_6th_potential_onlymass);
  #else
  DECLARE_CCTK_ARGUMENTS;
  #endif
  DECLARE_CCTK_PARAMETERS;
