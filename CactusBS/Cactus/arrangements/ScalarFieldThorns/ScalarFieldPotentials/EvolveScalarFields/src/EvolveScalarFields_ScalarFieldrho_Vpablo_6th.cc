...
extern "C" void EvolveScalarFields_ScalarFieldrho_Vpablo_6th_SelectBCs(CCTK_ARGUMENTS)
{
  #ifdef DECLARE_CCTK_ARGUMENTS_EvolveScalarFields_ScalarFieldrho_Vpablo_6th_SelectBCs
  DECLARE_CCTK_ARGUMENTS_CHECKED(EvolveScalarFields_ScalarFieldrho_Vpablo_6th_SelectBCs);
  #else
  DECLARE_CCTK_ARGUMENTS;
  #endif
  DECLARE_CCTK_PARAMETERS;
  
  if (cctk_iteration % EvolveScalarFields_ScalarFieldrho_Vpablo_6th_calc_every != EvolveScalarFields_ScalarFieldrho_Vpablo_6th_calc_offset)
    return;
...
static void EvolveScalarFields_ScalarFieldrho_Vpablo_6th_Body(const cGH* restrict const cctkGH, const int dir, const int face, const CCTK_REAL normal[3], const CCTK_REAL tangentA[3], const CCTK_REAL tangentB[3], const int imin[3], const int imax[3], const int n_subblock_gfs, CCTK_REAL* restrict const subblock_gfs[])
{
  DECLARE_CCTK_ARGUMENTS;
  DECLARE_CCTK_PARAMETERS;
  ...
  #pragma omp parallel
  CCTK_LOOP3(EvolveScalarFields_ScalarFieldrho_Vpablo_6th,
    ...
    cctk_ash[0],cctk_ash[1],cctk_ash[2])
  {
    ...
    CCTK_REAL dphiaSqr CCTK_ATTRIBUTE_UNUSED = 
      2*(gInv23*PDstandard6th2phia*PDstandard6th3phia + 
    ...
    CCTK_REAL dphibSqr CCTK_ATTRIBUTE_UNUSED = 
      2*(gInv23*PDstandard6th2phib*PDstandard6th3phib + 
    ...
    SFTttL = pow(dtphia,2) + pow(dtphib,2) - 0.5*(betaSqr - 
      pow(alpL,2))*(dphiaSqr + dphibSqr - 8192*V0*pow(-3*C3 + pow(-32*C2 + 
      9*pow(C3,2),0.5),-2)*(pow(phiaL,4) + C2*(pow(phiaL,2) - 
      0.015625*pow(-3*C3 + pow(-32*C2 + 9*pow(C3,2),0.5),2)) + 
      C3*(pow(phiaL,3) - 0.001953125*pow(-3*C3 + pow(-32*C2 + 
      9*pow(C3,2),0.5),3)) - 0.000244140625*pow(-3*C3 + pow(-32*C2 + 
      9*pow(C3,2),0.5),4))*pow(64*C2 - 15*pow(C3,2) + 2*C3*pow(-32*C2 + 
    ...
    CCTK_REAL SFTtj1 CCTK_ATTRIBUTE_UNUSED = dtphia*PDstandard6th1phia + 
      ...
      betazL*gxzL)*(-dphiaSqr - dphibSqr + 8192*V0*pow(-3*C3 + pow(-32*C2 + 
      9*pow(C3,2),0.5),-2)*(C2*pow(phiaL,2) + C3*pow(phiaL,3) + pow(phiaL,4) 
      - 0.015625*C2*pow(-3*C3 + pow(-32*C2 + 9*pow(C3,2),0.5),2) - 
      0.001953125*C3*pow(-3*C3 + pow(-32*C2 + 9*pow(C3,2),0.5),3) - 
      0.000244140625*pow(-3*C3 + pow(-32*C2 + 9*pow(C3,2),0.5),4))*pow(64*C2 
      - 15*pow(C3,2) + 2*C3*pow(-32*C2 + 9*pow(C3,2),0.5) + pow(-32*C2 + 
      9*pow(C3,2),1.),-1));
    
    CCTK_REAL SFTtj2 CCTK_ATTRIBUTE_UNUSED = dtphia*PDstandard6th2phia + 
      dtphib*PDstandard6th2phib + 0.5*(betaxL*gxyL + betayL*gyyL + 
      betazL*gyzL)*(-dphiaSqr - dphibSqr + 8192*V0*pow(-3*C3 + pow(-32*C2 + 
      9*pow(C3,2),0.5),-2)*(C2*pow(phiaL,2) + C3*pow(phiaL,3) + pow(phiaL,4) 
      - 0.015625*C2*pow(-3*C3 + pow(-32*C2 + 9*pow(C3,2),0.5),2) - 
      0.001953125*C3*pow(-3*C3 + pow(-32*C2 + 9*pow(C3,2),0.5),3) - 
      0.000244140625*pow(-3*C3 + pow(-32*C2 + 9*pow(C3,2),0.5),4))*pow(64*C2 
    ...
    CCTK_REAL SFTtj3 CCTK_ATTRIBUTE_UNUSED = dtphia*PDstandard6th3phia + 
      ...
      betazL*gzzL)*(-dphiaSqr - dphibSqr + 8192*V0*pow(-3*C3 + pow(-32*C2 + 
      9*pow(C3,2),0.5),-2)*(C2*pow(phiaL,2) + C3*pow(phiaL,3) + pow(phiaL,4) 
      - 0.015625*C2*pow(-3*C3 + pow(-32*C2 + 9*pow(C3,2),0.5),2) - 
      0.001953125*C3*pow(-3*C3 + pow(-32*C2 + 9*pow(C3,2),0.5),3) - 
      0.000244140625*pow(-3*C3 + pow(-32*C2 + 9*pow(C3,2),0.5),4))*pow(64*C2 
    ...
    CCTK_REAL SFTij11 CCTK_ATTRIBUTE_UNUSED = pow(PDstandard6th1phia,2) + 
      pow(PDstandard6th1phib,2) - 0.5*gxxL*(dphiaSqr + dphibSqr - 
      8192*V0*pow(-3*C3 + pow(-32*C2 + 9*pow(C3,2),0.5),-2)*(pow(phiaL,4) + 
      C2*(pow(phiaL,2) - 0.015625*pow(-3*C3 + pow(-32*C2 + 
      9*pow(C3,2),0.5),2)) + C3*(pow(phiaL,3) - 0.001953125*pow(-3*C3 + 
      pow(-32*C2 + 9*pow(C3,2),0.5),3)) - 0.000244140625*pow(-3*C3 + 
      pow(-32*C2 + 9*pow(C3,2),0.5),4))*pow(64*C2 - 15*pow(C3,2) + 
      2*C3*pow(-32*C2 + 9*pow(C3,2),0.5) + pow(-32*C2 + 9*pow(C3,2),1.),-1));
    
    CCTK_REAL SFTij21 CCTK_ATTRIBUTE_UNUSED = 
      PDstandard6th1phia*PDstandard6th2phia + 
      PDstandard6th1phib*PDstandard6th2phib - 0.5*gxyL*(dphiaSqr + dphibSqr - 
      8192*V0*pow(-3*C3 + pow(-32*C2 + 9*pow(C3,2),0.5),-2)*(pow(phiaL,4) + 
      C2*(pow(phiaL,2) - 0.015625*pow(-3*C3 + pow(-32*C2 + 
      9*pow(C3,2),0.5),2)) + C3*(pow(phiaL,3) - 0.001953125*pow(-3*C3 + 
      pow(-32*C2 + 9*pow(C3,2),0.5),3)) - 0.000244140625*pow(-3*C3 + 
    ...
    CCTK_REAL SFTij31 CCTK_ATTRIBUTE_UNUSED = 
      ...
      PDstandard6th1phib*PDstandard6th3phib - 0.5*gxzL*(dphiaSqr + dphibSqr - 
      8192*V0*pow(-3*C3 + pow(-32*C2 + 9*pow(C3,2),0.5),-2)*(pow(phiaL,4) + 
      C2*(pow(phiaL,2) - 0.015625*pow(-3*C3 + pow(-32*C2 + 
      9*pow(C3,2),0.5),2)) + C3*(pow(phiaL,3) - 0.001953125*pow(-3*C3 + 
      pow(-32*C2 + 9*pow(C3,2),0.5),3)) - 0.000244140625*pow(-3*C3 + 
    ...
    CCTK_REAL SFTij22 CCTK_ATTRIBUTE_UNUSED = pow(PDstandard6th2phia,2) + 
      pow(PDstandard6th2phib,2) - 0.5*gyyL*(dphiaSqr + dphibSqr - 
      8192*V0*pow(-3*C3 + pow(-32*C2 + 9*pow(C3,2),0.5),-2)*(pow(phiaL,4) + 
      C2*(pow(phiaL,2) - 0.015625*pow(-3*C3 + pow(-32*C2 + 
      9*pow(C3,2),0.5),2)) + C3*(pow(phiaL,3) - 0.001953125*pow(-3*C3 + 
      pow(-32*C2 + 9*pow(C3,2),0.5),3)) - 0.000244140625*pow(-3*C3 + 
    ...
    CCTK_REAL SFTij32 CCTK_ATTRIBUTE_UNUSED = 
      ...
      PDstandard6th2phib*PDstandard6th3phib - 0.5*gyzL*(dphiaSqr + dphibSqr - 
      8192*V0*pow(-3*C3 + pow(-32*C2 + 9*pow(C3,2),0.5),-2)*(pow(phiaL,4) + 
      C2*(pow(phiaL,2) - 0.015625*pow(-3*C3 + pow(-32*C2 + 
      9*pow(C3,2),0.5),2)) + C3*(pow(phiaL,3) - 0.001953125*pow(-3*C3 + 
      pow(-32*C2 + 9*pow(C3,2),0.5),3)) - 0.000244140625*pow(-3*C3 + 
    ...
    CCTK_REAL SFTij33 CCTK_ATTRIBUTE_UNUSED = pow(PDstandard6th3phia,2) + 
      pow(PDstandard6th3phib,2) - 0.5*gzzL*(dphiaSqr + dphibSqr - 
      8192*V0*pow(-3*C3 + pow(-32*C2 + 9*pow(C3,2),0.5),-2)*(pow(phiaL,4) + 
      C2*(pow(phiaL,2) - 0.015625*pow(-3*C3 + pow(-32*C2 + 
      9*pow(C3,2),0.5),2)) + C3*(pow(phiaL,3) - 0.001953125*pow(-3*C3 + 
      pow(-32*C2 + 9*pow(C3,2),0.5),3)) - 0.000244140625*pow(-3*C3 + 
  ...
  CCTK_ENDLOOP3(EvolveScalarFields_ScalarFieldrho_Vpablo_6th);
}
extern "C" void EvolveScalarFields_ScalarFieldrho_Vpablo_6th(CCTK_ARGUMENTS)
{
  #ifdef DECLARE_CCTK_ARGUMENTS_EvolveScalarFields_ScalarFieldrho_Vpablo_6th
  DECLARE_CCTK_ARGUMENTS_CHECKED(EvolveScalarFields_ScalarFieldrho_Vpablo_6th);
  #else
  DECLARE_CCTK_ARGUMENTS;
  #endif
  DECLARE_CCTK_PARAMETERS;
  ...
  if (verbose > 1)
  {
    CCTK_VInfo(CCTK_THORNSTRING,"Entering EvolveScalarFields_ScalarFieldrho_Vpablo_6th_Body");
  }
  if (cctk_iteration % EvolveScalarFields_ScalarFieldrho_Vpablo_6th_calc_every != EvolveScalarFields_ScalarFieldrho_Vpablo_6th_calc_offset)
  {
    return;
  ...
  AssertGroupStorage(cctkGH, "EvolveScalarFields_ScalarFieldrho_Vpablo_6th", 9, groups);
  
  EnsureStencilFits(cctkGH, "EvolveScalarFields_ScalarFieldrho_Vpablo_6th", 4, 4, 4);
  
  LoopOverInterior(cctkGH, EvolveScalarFields_ScalarFieldrho_Vpablo_6th_Body);
  if (verbose > 1)
  {
    CCTK_VInfo(CCTK_THORNSTRING,"Leaving EvolveScalarFields_ScalarFieldrho_Vpablo_6th_Body");
  }
}
