...
static void EvolveScalarFields_init_gfs_Body(const cGH* restrict const cctkGH, const int dir, const int face, const CCTK_REAL normal[3], const CCTK_REAL tangentA[3], const CCTK_REAL tangentB[3], const int imin[3], const int imax[3], const int n_subblock_gfs, CCTK_REAL* restrict const subblock_gfs[])
{
  ...
  #pragma omp parallel
  CCTK_LOOP3(EvolveScalarFields_init_gfs,
    ...
    cctk_ash[0],cctk_ash[1],cctk_ash[2])
  {
    ...
    CCTK_REAL phiaL CCTK_ATTRIBUTE_UNUSED = 0;
    
    CCTK_REAL piaL CCTK_ATTRIBUTE_UNUSED = 0;
    
    CCTK_REAL phibL CCTK_ATTRIBUTE_UNUSED = 0;
  ...
  CCTK_ENDLOOP3(EvolveScalarFields_init_gfs);
}
extern "C" void EvolveScalarFields_init_gfs(CCTK_ARGUMENTS)
{
  #ifdef DECLARE_CCTK_ARGUMENTS_EvolveScalarFields_init_gfs
  DECLARE_CCTK_ARGUMENTS_CHECKED(EvolveScalarFields_init_gfs);
  #else
  DECLARE_CCTK_ARGUMENTS;
  #endif
  DECLARE_CCTK_PARAMETERS;
  ...
  if (verbose > 1)
  {
    CCTK_VInfo(CCTK_THORNSTRING,"Entering EvolveScalarFields_init_gfs_Body");
  }
  if (cctk_iteration % EvolveScalarFields_init_gfs_calc_every != EvolveScalarFields_init_gfs_calc_offset)
  {
    return;
  }
  ...
  if (verbose > 1)
  {
    CCTK_VInfo(CCTK_THORNSTRING,"Leaving EvolveScalarFields_init_gfs_Body");
  }
}
