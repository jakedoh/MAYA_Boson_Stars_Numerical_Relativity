...
module PPM_EigenvalueCalcs

 CONTAINS
  subroutine eigenvalues_ppm(handle,rho,velx,vely,velz,eps,w_lorentz,&
...
!!$  Calculate eigenvalues
  ...
  end subroutine eigenvalues_ppm
 ...
 /*@@
  ...
  subroutine eigenvalues_general_ppm(&
...
!!$  Calculate eigenvalues
  ...
  end subroutine eigenvalues_general_ppm

end module PPM_EigenvalueCalcs 
