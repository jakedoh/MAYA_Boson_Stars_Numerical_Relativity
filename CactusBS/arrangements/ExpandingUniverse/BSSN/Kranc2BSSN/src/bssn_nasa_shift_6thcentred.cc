...
extern "C" void bssn_nasa_shift_6thcentred_SelectBCs(CCTK_ARGUMENTS)
{
  DECLARE_CCTK_ARGUMENTS;
  DECLARE_CCTK_PARAMETERS;
  
  if (cctk_iteration % bssn_nasa_shift_6thcentred_calc_every != bssn_nasa_shift_6thcentred_calc_offset)
    return;
  ...
  if (ierr < 0)
    CCTK_WARN(CCTK_WARN_ALERT, "Failed to register flat BC for Kranc2BSSN::beta_grouprhs.");
  ierr = Boundary_SelectGroupForBC(cctkGH, CCTK_ALL_FACES, GetBoundaryWidth(cctkGH), -1 /* no table */, "Kranc2BSSN::betat_grouprhs","flat");
  if (ierr < 0)
    CCTK_WARN(CCTK_WARN_ALERT, "Failed to register flat BC for Kranc2BSSN::betat_grouprhs.");
  return;
}

static void bssn_nasa_shift_6thcentred_Body(const cGH* restrict const cctkGH, const int dir, const int face, const CCTK_REAL normal[3], const CCTK_REAL tangentA[3], const CCTK_REAL tangentB[3], const int imin[3], const int imax[3], const int n_subblock_gfs, CCTK_REAL* restrict const subblock_gfs[])
{
  DECLARE_CCTK_ARGUMENTS;
  DECLARE_CCTK_PARAMETERS;
  ...
  #pragma omp parallel
  CCTK_LOOP3(bssn_nasa_shift_6thcentred,
  ...
  CCTK_ENDLOOP3(bssn_nasa_shift_6thcentred);
}
extern "C" void bssn_nasa_shift_6thcentred(CCTK_ARGUMENTS)
{
  DECLARE_CCTK_ARGUMENTS;
  DECLARE_CCTK_PARAMETERS;
  ...
  if (verbose > 1)
  {
    CCTK_VInfo(CCTK_THORNSTRING,"Entering bssn_nasa_shift_6thcentred_Body");
  }
  if (cctk_iteration % bssn_nasa_shift_6thcentred_calc_every != bssn_nasa_shift_6thcentred_calc_offset)
  {
    return;
  ...
  AssertGroupStorage(cctkGH, "bssn_nasa_shift_6thcentred", 7, groups);
  
  switch (constraintsfdorder)
  {
    case 2:
    {
      EnsureStencilFits(cctkGH, "bssn_nasa_shift_6thcentred", 3, 3, 3);
      break;
    }
  ...
  LoopOverInterior(cctkGH, bssn_nasa_shift_6thcentred_Body);
  if (verbose > 1)
  {
    CCTK_VInfo(CCTK_THORNSTRING,"Leaving bssn_nasa_shift_6thcentred_Body");
  }
}
