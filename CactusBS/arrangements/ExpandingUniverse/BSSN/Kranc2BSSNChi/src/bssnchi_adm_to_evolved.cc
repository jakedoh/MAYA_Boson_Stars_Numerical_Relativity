...
static void bssnchi_adm_to_evolved_Body(const cGH* restrict const cctkGH, const int dir, const int face, const CCTK_REAL normal[3], const CCTK_REAL tangentA[3], const CCTK_REAL tangentB[3], const int imin[3], const int imax[3], const int n_subblock_gfs, CCTK_REAL* restrict const subblock_gfs[])
{
  ...
  #pragma omp parallel
  CCTK_LOOP3(bssnchi_adm_to_evolved,
    ...
    cctk_ash[0],cctk_ash[1],cctk_ash[2])
  {
    ...
    chiL = pow(detg,-0.333333333333333333333333333333);
  ...
  CCTK_ENDLOOP3(bssnchi_adm_to_evolved);
}
extern "C" void bssnchi_adm_to_evolved(CCTK_ARGUMENTS)
{
  DECLARE_CCTK_ARGUMENTS;
  DECLARE_CCTK_PARAMETERS;
  ...
  if (verbose > 1)
  {
    CCTK_VInfo(CCTK_THORNSTRING,"Entering bssnchi_adm_to_evolved_Body");
  }
  if (cctk_iteration % bssnchi_adm_to_evolved_calc_every != bssnchi_adm_to_evolved_calc_offset)
  {
    return;
  }
  ...
  AssertGroupStorage(cctkGH, "bssnchi_adm_to_evolved", 12, groups);
  ...
  LoopOverEverything(cctkGH, bssnchi_adm_to_evolved_Body);
  if (verbose > 1)
  {
    CCTK_VInfo(CCTK_THORNSTRING,"Leaving bssnchi_adm_to_evolved_Body");
  }
}
