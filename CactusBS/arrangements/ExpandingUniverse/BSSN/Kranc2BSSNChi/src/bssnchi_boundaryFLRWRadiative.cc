...
extern "C" void bssnchi_boundaryFLRWRadiative_SelectBCs(CCTK_ARGUMENTS)
{
  DECLARE_CCTK_ARGUMENTS;
  DECLARE_CCTK_PARAMETERS;
  
  if (cctk_iteration % bssnchi_boundaryFLRWRadiative_calc_every != bssnchi_boundaryFLRWRadiative_calc_offset)
    return;
  ...
  ierr = Boundary_SelectGroupForBC(cctkGH, CCTK_ALL_FACES, GetBoundaryWidth(cctkGH), -1 /* no table */, "Kranc2BSSNChi::alpha_grouprhs","flat");
  if (ierr < 0)
    CCTK_WARN(CCTK_WARN_ALERT, "Failed to register flat BC for Kranc2BSSNChi::alpha_grouprhs.");
  ...
  ierr = Boundary_SelectGroupForBC(cctkGH, CCTK_ALL_FACES, GetBoundaryWidth(cctkGH), -1 /* no table */, "Kranc2BSSNChi::bssnmom_group","flat");
  if (ierr < 0)
    CCTK_WARN(CCTK_WARN_ALERT, "Failed to register flat BC for Kranc2BSSNChi::bssnmom_group.");
  ierr = Boundary_SelectGroupForBC(cctkGH, CCTK_ALL_FACES, GetBoundaryWidth(cctkGH), -1 /* no table */, "Kranc2BSSNChi::chi_grouprhs","flat");
  if (ierr < 0)
    CCTK_WARN(CCTK_WARN_ALERT, "Failed to register flat BC for Kranc2BSSNChi::chi_grouprhs.");
  ...
  ierr = Boundary_SelectGroupForBC(cctkGH, CCTK_ALL_FACES, GetBoundaryWidth(cctkGH), -1 /* no table */, "Kranc2BSSNChi::h_grouprhs","flat");
  if (ierr < 0)
    CCTK_WARN(CCTK_WARN_ALERT, "Failed to register flat BC for Kranc2BSSNChi::h_grouprhs.");
...
static void bssnchi_boundaryFLRWRadiative_Body(const cGH* restrict const cctkGH, const int dir, const int face, const CCTK_REAL normal[3], const CCTK_REAL tangentA[3], const CCTK_REAL tangentB[3], const int imin[3], const int imax[3], const int n_subblock_gfs, CCTK_REAL* restrict const subblock_gfs[])
{
  DECLARE_CCTK_ARGUMENTS;
  DECLARE_CCTK_PARAMETERS;
  ...
  #pragma omp parallel
  CCTK_LOOP3(bssnchi_boundaryFLRWRadiative,
    ...
    cctk_ash[0],cctk_ash[1],cctk_ash[2])
  {
    ...
    CCTK_REAL expansion CCTK_ATTRIBUTE_UNUSED = a0*pow(t*pow(t0,-1),0.5);
    
    CCTK_REAL Hubble CCTK_ATTRIBUTE_UNUSED = H0*t0*pow(t,-1);
    
    CCTK_REAL expansionPrime CCTK_ATTRIBUTE_UNUSED = 
      0.5*a0*pow(t0,-1)*pow(t*pow(t0,-1),-0.5);
    
    CCTK_REAL HubblePrime CCTK_ATTRIBUTE_UNUSED = -(H0*t0*pow(t,-2));
    ...
    CCTK_REAL chirhsL CCTK_ATTRIBUTE_UNUSED = 
      ...
      PDonesided2nd3(&chi[index])*n3 - 2*expansionPrime*pow(expansion,-3) - 
      pow(rL,-1)*(chiL - pow(expansion,-2));
  ...
  CCTK_ENDLOOP3(bssnchi_boundaryFLRWRadiative);
}
extern "C" void bssnchi_boundaryFLRWRadiative(CCTK_ARGUMENTS)
{
  DECLARE_CCTK_ARGUMENTS;
  DECLARE_CCTK_PARAMETERS;
  ...
  if (verbose > 1)
  {
    CCTK_VInfo(CCTK_THORNSTRING,"Entering bssnchi_boundaryFLRWRadiative_Body");
  }
  if (cctk_iteration % bssnchi_boundaryFLRWRadiative_calc_every != bssnchi_boundaryFLRWRadiative_calc_offset)
  {
    return;
  ...
  const char* const groups[] = {
    ...
    "Kranc2BSSNChi::chi_grouprhs",
    "Kranc2BSSNChi::Gam_grouprhs",
    "grid::coordinates",
    "Kranc2BSSNChi::h_group",
    "Kranc2BSSNChi::h_grouprhs",
    "Kranc2BSSNChi::K_group",
    "Kranc2BSSNChi::K_grouprhs",
    "Kranc2BSSNChi::scalarconstraints"};
  AssertGroupStorage(cctkGH, "bssnchi_boundaryFLRWRadiative", 18, groups);
  
  switch (constraintsfdorder)
  {
    case 2:
    {
      EnsureStencilFits(cctkGH, "bssnchi_boundaryFLRWRadiative", 2, 2, 2);
      break;
    }
  ...
  LoopOverBoundary(cctkGH, bssnchi_boundaryFLRWRadiative_Body);
  if (verbose > 1)
  {
    CCTK_VInfo(CCTK_THORNSTRING,"Leaving bssnchi_boundaryFLRWRadiative_Body");
  }
}
