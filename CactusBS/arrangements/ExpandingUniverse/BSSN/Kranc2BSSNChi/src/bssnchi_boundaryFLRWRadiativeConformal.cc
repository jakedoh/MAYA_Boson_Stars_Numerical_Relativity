...
extern "C" void bssnchi_boundaryFLRWRadiativeConformal_SelectBCs(CCTK_ARGUMENTS)
{
  DECLARE_CCTK_ARGUMENTS;
  DECLARE_CCTK_PARAMETERS;
  
  if (cctk_iteration % bssnchi_boundaryFLRWRadiativeConformal_calc_every != bssnchi_boundaryFLRWRadiativeConformal_calc_offset)
    return;
...
static void bssnchi_boundaryFLRWRadiativeConformal_Body(const cGH* restrict const cctkGH, const int dir, const int face, const CCTK_REAL normal[3], const CCTK_REAL tangentA[3], const CCTK_REAL tangentB[3], const int imin[3], const int imax[3], const int n_subblock_gfs, CCTK_REAL* restrict const subblock_gfs[])
{
  DECLARE_CCTK_ARGUMENTS;
  DECLARE_CCTK_PARAMETERS;
  ...
  #pragma omp parallel
  CCTK_LOOP3(bssnchi_boundaryFLRWRadiativeConformal,
  ...
  CCTK_ENDLOOP3(bssnchi_boundaryFLRWRadiativeConformal);
}
extern "C" void bssnchi_boundaryFLRWRadiativeConformal(CCTK_ARGUMENTS)
{
  DECLARE_CCTK_ARGUMENTS;
  DECLARE_CCTK_PARAMETERS;
  ...
  if (verbose > 1)
  {
    CCTK_VInfo(CCTK_THORNSTRING,"Entering bssnchi_boundaryFLRWRadiativeConformal_Body");
  }
  if (cctk_iteration % bssnchi_boundaryFLRWRadiativeConformal_calc_every != bssnchi_boundaryFLRWRadiativeConformal_calc_offset)
  {
    return;
  ...
  AssertGroupStorage(cctkGH, "bssnchi_boundaryFLRWRadiativeConformal", 18, groups);
  
  switch (constraintsfdorder)
  {
    case 2:
    {
      EnsureStencilFits(cctkGH, "bssnchi_boundaryFLRWRadiativeConformal", 2, 2, 2);
      break;
    }
  ...
  LoopOverBoundary(cctkGH, bssnchi_boundaryFLRWRadiativeConformal_Body);
  if (verbose > 1)
  {
    CCTK_VInfo(CCTK_THORNSTRING,"Leaving bssnchi_boundaryFLRWRadiativeConformal_Body");
  }
}
