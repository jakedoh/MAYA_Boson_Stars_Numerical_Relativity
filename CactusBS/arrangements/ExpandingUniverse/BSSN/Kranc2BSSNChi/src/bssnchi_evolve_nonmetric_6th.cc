...
extern "C" void bssnchi_evolve_nonmetric_6th_SelectBCs(CCTK_ARGUMENTS)
{
  DECLARE_CCTK_ARGUMENTS;
  DECLARE_CCTK_PARAMETERS;
  
  if (cctk_iteration % bssnchi_evolve_nonmetric_6th_calc_every != bssnchi_evolve_nonmetric_6th_calc_offset)
    return;
...
static void bssnchi_evolve_nonmetric_6th_Body(const cGH* restrict const cctkGH, const int dir, const int face, const CCTK_REAL normal[3], const CCTK_REAL tangentA[3], const CCTK_REAL tangentB[3], const int imin[3], const int imax[3], const int n_subblock_gfs, CCTK_REAL* restrict const subblock_gfs[])
{
  DECLARE_CCTK_ARGUMENTS;
  DECLARE_CCTK_PARAMETERS;
  ...
  #pragma omp parallel
  CCTK_LOOP3(bssnchi_evolve_nonmetric_6th,
    ...
    cctk_ash[0],cctk_ash[1],cctk_ash[2])
  {
    ...
    CCTK_REAL PDstandard6th1chi CCTK_ATTRIBUTE_UNUSED;
    CCTK_REAL PDstandard6th2chi CCTK_ATTRIBUTE_UNUSED;
    CCTK_REAL PDstandard6th3chi CCTK_ATTRIBUTE_UNUSED;
    CCTK_REAL PDstandard6th11chi CCTK_ATTRIBUTE_UNUSED;
    CCTK_REAL PDstandard6th22chi CCTK_ATTRIBUTE_UNUSED;
    CCTK_REAL PDstandard6th33chi CCTK_ATTRIBUTE_UNUSED;
    CCTK_REAL PDstandard6th12chi CCTK_ATTRIBUTE_UNUSED;
    CCTK_REAL PDstandard6th13chi CCTK_ATTRIBUTE_UNUSED;
    CCTK_REAL PDstandard6th23chi CCTK_ATTRIBUTE_UNUSED;
    ...
    switch (constraintsfdorder)
    {
      case 2:
      {
        ...
        PDstandard6th1chi = PDstandard6th1(&chi[index]);
        PDstandard6th2chi = PDstandard6th2(&chi[index]);
        PDstandard6th3chi = PDstandard6th3(&chi[index]);
        PDstandard6th11chi = PDstandard6th11(&chi[index]);
        PDstandard6th22chi = PDstandard6th22(&chi[index]);
        PDstandard6th33chi = PDstandard6th33(&chi[index]);
        PDstandard6th12chi = PDstandard6th12(&chi[index]);
        PDstandard6th13chi = PDstandard6th13(&chi[index]);
        PDstandard6th23chi = PDstandard6th23(&chi[index]);
    ...
    CCTK_REAL DDphi11 CCTK_ATTRIBUTE_UNUSED = 
      0.25*pow(chiCutoff,-2)*(chiCutoff*(-PDstandard6th11chi + 
      gamma111*PDstandard6th1chi + gamma211*PDstandard6th2chi + 
      gamma311*PDstandard6th3chi) + pow(PDstandard6th1chi,2));
    
    CCTK_REAL DDphi21 CCTK_ATTRIBUTE_UNUSED = 
      0.25*(PDstandard6th1chi*(chiCutoff*gamma121 + PDstandard6th2chi) + 
      chiCutoff*(-PDstandard6th12chi + gamma221*PDstandard6th2chi + 
      gamma321*PDstandard6th3chi))*pow(chiCutoff,-2);
    
    CCTK_REAL DDphi31 CCTK_ATTRIBUTE_UNUSED = 
      0.25*(PDstandard6th1chi*(chiCutoff*gamma131 + PDstandard6th3chi) + 
      chiCutoff*(-PDstandard6th13chi + gamma231*PDstandard6th2chi + 
      gamma331*PDstandard6th3chi))*pow(chiCutoff,-2);
    ...
    CCTK_REAL DDphi22 CCTK_ATTRIBUTE_UNUSED = 
      0.25*pow(chiCutoff,-2)*(chiCutoff*(gamma122*PDstandard6th1chi - 
      PDstandard6th22chi + gamma222*PDstandard6th2chi + 
      gamma322*PDstandard6th3chi) + pow(PDstandard6th2chi,2));
    
    CCTK_REAL DDphi32 CCTK_ATTRIBUTE_UNUSED = 
      0.25*(PDstandard6th2chi*(chiCutoff*gamma232 + PDstandard6th3chi) + 
      chiCutoff*(gamma132*PDstandard6th1chi - PDstandard6th23chi + 
      gamma332*PDstandard6th3chi))*pow(chiCutoff,-2);
    ...
    CCTK_REAL DDphi33 CCTK_ATTRIBUTE_UNUSED = 
      0.25*pow(chiCutoff,-2)*(chiCutoff*(gamma133*PDstandard6th1chi + 
      gamma233*PDstandard6th2chi - PDstandard6th33chi + 
      gamma333*PDstandard6th3chi) + pow(PDstandard6th3chi,2));
    
    CCTK_REAL Dphi1 CCTK_ATTRIBUTE_UNUSED = 
      -0.25*PDstandard6th1chi*pow(chiCutoff,-1);
    
    CCTK_REAL Dphi2 CCTK_ATTRIBUTE_UNUSED = 
      -0.25*PDstandard6th2chi*pow(chiCutoff,-1);
    
    CCTK_REAL Dphi3 CCTK_ATTRIBUTE_UNUSED = 
      -0.25*PDstandard6th3chi*pow(chiCutoff,-1);
    ...
    CCTK_REAL KrhsL CCTK_ATTRIBUTE_UNUSED = 
      beta1L*PDlopsided6th1(&K[index]) + beta2L*PDlopsided6th2(&K[index]) + 
      beta3L*PDlopsided6th3(&K[index]) + em4phi*(-(hInv11*(DDalpha11 + 
      ...
      2*Dphi3*PDstandard6th3alpha)) + alphaL*(A11L*AInv11 + 2*A21L*AInv12 + 
    ...
    CCTK_REAL A11rhsL CCTK_ATTRIBUTE_UNUSED = 
      beta1L*PDlopsided6th1(&A11[index]) + beta2L*PDlopsided6th2(&A11[index]) 
      + beta3L*PDlopsided6th3(&A11[index]) + 2*(A11L*PDstandard6th1beta1 + 
      A21L*PDstandard6th1beta2 + A31L*PDstandard6th1beta3) - 
    ...
    CCTK_REAL A21rhsL CCTK_ATTRIBUTE_UNUSED = 
      beta1L*PDlopsided6th1(&A21[index]) + beta2L*PDlopsided6th2(&A21[index]) 
      + beta3L*PDlopsided6th3(&A21[index]) + A22L*PDstandard6th1beta2 + 
      A32L*PDstandard6th1beta3 + A11L*PDstandard6th2beta1 + 
      A31L*PDstandard6th2beta3 + A21L*(alphaL*(KL - 2*(A11L*hInv11 + 
      A22L*hInv22)) + 0.333333333333333333333333333333*(PDstandard6th1beta1 + 
      PDstandard6th2beta2) - 
    ...
    CCTK_REAL A31rhsL CCTK_ATTRIBUTE_UNUSED = 
      beta1L*PDlopsided6th1(&A31[index]) + beta2L*PDlopsided6th2(&A31[index]) 
      + beta3L*PDlopsided6th3(&A31[index]) + A32L*PDstandard6th1beta2 + 
      A33L*PDstandard6th1beta3 + A11L*PDstandard6th3beta1 + 
      A21L*PDstandard6th3beta2 + A31L*(alphaL*(KL - 2*(A11L*hInv11 + 
      A33L*hInv33)) - 0.666666666666666666666666666667*PDstandard6th2beta2 + 
    ...
    CCTK_REAL A22rhsL CCTK_ATTRIBUTE_UNUSED = 
      beta1L*PDlopsided6th1(&A22[index]) + beta2L*PDlopsided6th2(&A22[index]) 
      + beta3L*PDlopsided6th3(&A22[index]) + 2*(A21L*PDstandard6th2beta1 + 
    ...
    CCTK_REAL A32rhsL CCTK_ATTRIBUTE_UNUSED = 
      beta1L*PDlopsided6th1(&A32[index]) + beta2L*PDlopsided6th2(&A32[index]) 
      + beta3L*PDlopsided6th3(&A32[index]) + A31L*PDstandard6th2beta1 + 
      A33L*PDstandard6th2beta3 + A21L*PDstandard6th3beta1 + 
      A22L*PDstandard6th3beta2 + 
    ...
    CCTK_REAL A33rhsL CCTK_ATTRIBUTE_UNUSED = 
      beta1L*PDlopsided6th1(&A33[index]) + beta2L*PDlopsided6th2(&A33[index]) 
      + beta3L*PDlopsided6th3(&A33[index]) - 
    ...
    CCTK_REAL Gam1rhsL CCTK_ATTRIBUTE_UNUSED = 
      beta1L*PDlopsided6th1(&Gam1[index]) + 
      beta2L*PDlopsided6th2(&Gam1[index]) + 
      beta3L*PDlopsided6th3(&Gam1[index]) + alphaL*(12*(AInv11*Dphi1 + 
      AInv12*Dphi2 + AInv13*Dphi3) + 2*AInv11*gamma111 + 4*AInv12*gamma121 + 
      2*AInv22*gamma122 + 4*AInv13*gamma131 + 4*AInv23*gamma132 + 
      2*AInv33*gamma133) - Gam2L*PDstandard6th2beta1 - 
    ...
    CCTK_REAL Gam2rhsL CCTK_ATTRIBUTE_UNUSED = 
      beta1L*PDlopsided6th1(&Gam2[index]) + 
      beta2L*PDlopsided6th2(&Gam2[index]) + 
      beta3L*PDlopsided6th3(&Gam2[index]) + alphaL*(12*(AInv12*Dphi1 + 
    ...
    CCTK_REAL Gam3rhsL CCTK_ATTRIBUTE_UNUSED = 
      beta1L*PDlopsided6th1(&Gam3[index]) + 
      beta2L*PDlopsided6th2(&Gam3[index]) + 
      beta3L*PDlopsided6th3(&Gam3[index]) + alphaL*(12*(AInv13*Dphi1 + 
      ...
      Gam2L*PDstandard6th2beta3 - 2*(AInv13*PDstandard6th1alpha + 
  ...
  CCTK_ENDLOOP3(bssnchi_evolve_nonmetric_6th);
}
extern "C" void bssnchi_evolve_nonmetric_6th(CCTK_ARGUMENTS)
{
  DECLARE_CCTK_ARGUMENTS;
  DECLARE_CCTK_PARAMETERS;
  ...
  if (verbose > 1)
  {
    CCTK_VInfo(CCTK_THORNSTRING,"Entering bssnchi_evolve_nonmetric_6th_Body");
  }
  if (cctk_iteration % bssnchi_evolve_nonmetric_6th_calc_every != bssnchi_evolve_nonmetric_6th_calc_offset)
  {
    return;
  ...
  AssertGroupStorage(cctkGH, "bssnchi_evolve_nonmetric_6th", 11, groups);
  
  switch (constraintsfdorder)
  {
    case 2:
    {
      EnsureStencilFits(cctkGH, "bssnchi_evolve_nonmetric_6th", 4, 4, 4);
      break;
    }
  ...
  LoopOverInterior(cctkGH, bssnchi_evolve_nonmetric_6th_Body);
  if (verbose > 1)
  {
    CCTK_VInfo(CCTK_THORNSTRING,"Leaving bssnchi_evolve_nonmetric_6th_Body");
  }
}
