...
extern "C" void bssnchimatter_boundaryFLRWConformal_SelectBCs(CCTK_ARGUMENTS)
{
  DECLARE_CCTK_ARGUMENTS;
  DECLARE_CCTK_PARAMETERS;
  
  if (cctk_iteration % bssnchimatter_boundaryFLRWConformal_calc_every != bssnchimatter_boundaryFLRWConformal_calc_offset)
    return;
...
static void bssnchimatter_boundaryFLRWConformal_Body(const cGH* restrict const cctkGH, const int dir, const int face, const CCTK_REAL normal[3], const CCTK_REAL tangentA[3], const CCTK_REAL tangentB[3], const int imin[3], const int imax[3], const int n_subblock_gfs, CCTK_REAL* restrict const subblock_gfs[])
{
  DECLARE_CCTK_ARGUMENTS;
  DECLARE_CCTK_PARAMETERS;
  ...
  #pragma omp parallel
  CCTK_LOOP3(bssnchimatter_boundaryFLRWConformal,
  ...
  CCTK_ENDLOOP3(bssnchimatter_boundaryFLRWConformal);
}
extern "C" void bssnchimatter_boundaryFLRWConformal(CCTK_ARGUMENTS)
{
  DECLARE_CCTK_ARGUMENTS;
  DECLARE_CCTK_PARAMETERS;
  ...
  if (verbose > 1)
  {
    CCTK_VInfo(CCTK_THORNSTRING,"Entering bssnchimatter_boundaryFLRWConformal_Body");
  }
  if (cctk_iteration % bssnchimatter_boundaryFLRWConformal_calc_every != bssnchimatter_boundaryFLRWConformal_calc_offset)
  {
    return;
  ...
  AssertGroupStorage(cctkGH, "bssnchimatter_boundaryFLRWConformal", 11, groups);
  ...
  LoopOverBoundary(cctkGH, bssnchimatter_boundaryFLRWConformal_Body);
  if (verbose > 1)
  {
    CCTK_VInfo(CCTK_THORNSTRING,"Leaving bssnchimatter_boundaryFLRWConformal_Body");
  }
}
