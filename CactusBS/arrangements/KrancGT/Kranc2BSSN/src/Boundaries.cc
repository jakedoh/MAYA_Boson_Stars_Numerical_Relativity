...
extern "C" void Kranc2BSSN_CheckBoundaries(CCTK_ARGUMENTS)
{
...
extern "C" void Kranc2BSSN_SelectBoundConds(CCTK_ARGUMENTS)
{
  DECLARE_CCTK_ARGUMENTS;
  DECLARE_CCTK_PARAMETERS;
      ...
      CCTK_EQUALS(h_group_bound, "zero"  ) )
  {
    ierr = Boundary_SelectGroupForBC(cctkGH, CCTK_ALL_FACES, 1, -1,
                      "Kranc2BSSN::h_group", h_group_bound);
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register h_group_bound BC for Kranc2BSSN::h_group!");
  }
  ...
  {
    ierr = Boundary_SelectGroupForBC(cctkGH, CCTK_ALL_FACES, 1, -1,
                      "Kranc2BSSN::A_group", A_group_bound);
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register A_group_bound BC for Kranc2BSSN::A_group!");
  }
  ...
  {
    ierr = Boundary_SelectGroupForBC(cctkGH, CCTK_ALL_FACES, 1, -1,
                      "Kranc2BSSN::phi_group", phi_group_bound);
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register phi_group_bound BC for Kranc2BSSN::phi_group!");
  }
  ...
  {
    ierr = Boundary_SelectGroupForBC(cctkGH, CCTK_ALL_FACES, 1, -1,
                      "Kranc2BSSN::K_group", K_group_bound);
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register K_group_bound BC for Kranc2BSSN::K_group!");
  }
  ...
  {
    ierr = Boundary_SelectGroupForBC(cctkGH, CCTK_ALL_FACES, 1, -1,
                      "Kranc2BSSN::Gam_group", Gam_group_bound);
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register Gam_group_bound BC for Kranc2BSSN::Gam_group!");
  }
  ...
  {
    ierr = Boundary_SelectGroupForBC(cctkGH, CCTK_ALL_FACES, 1, -1,
                      "Kranc2BSSN::alpha_group", alpha_group_bound);
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register alpha_group_bound BC for Kranc2BSSN::alpha_group!");
  }
  ...
  {
    ierr = Boundary_SelectGroupForBC(cctkGH, CCTK_ALL_FACES, 1, -1,
                      "Kranc2BSSN::beta_group", beta_group_bound);
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register beta_group_bound BC for Kranc2BSSN::beta_group!");
  }
  ...
  {
    ierr = Boundary_SelectGroupForBC(cctkGH, CCTK_ALL_FACES, 1, -1,
                      "Kranc2BSSN::betat_group", betat_group_bound);
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register betat_group_bound BC for Kranc2BSSN::betat_group!");
  }
      ...
      CCTK_EQUALS(h11_bound, "zero"  ) )
  {
    ierr = Boundary_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, -1,
                      "Kranc2BSSN::h11", h11_bound);
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register h11_bound BC for Kranc2BSSN::h11!");
  }
  ...
  {
    ierr = Boundary_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, -1,
                      "Kranc2BSSN::h21", h21_bound);
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register h21_bound BC for Kranc2BSSN::h21!");
  }
  ...
  {
    ierr = Boundary_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, -1,
                      "Kranc2BSSN::h31", h31_bound);
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register h31_bound BC for Kranc2BSSN::h31!");
  }
  ...
  {
    ierr = Boundary_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, -1,
                      "Kranc2BSSN::h22", h22_bound);
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register h22_bound BC for Kranc2BSSN::h22!");
  }
  ...
  {
    ierr = Boundary_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, -1,
                      "Kranc2BSSN::h32", h32_bound);
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register h32_bound BC for Kranc2BSSN::h32!");
  }
  ...
  {
    ierr = Boundary_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, -1,
                      "Kranc2BSSN::h33", h33_bound);
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register h33_bound BC for Kranc2BSSN::h33!");
  }
  ...
  {
    ierr = Boundary_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, -1,
                      "Kranc2BSSN::A11", A11_bound);
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register A11_bound BC for Kranc2BSSN::A11!");
  }
  ...
  {
    ierr = Boundary_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, -1,
                      "Kranc2BSSN::A21", A21_bound);
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register A21_bound BC for Kranc2BSSN::A21!");
  }
  ...
  {
    ierr = Boundary_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, -1,
                      "Kranc2BSSN::A31", A31_bound);
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register A31_bound BC for Kranc2BSSN::A31!");
  }
  ...
  {
    ierr = Boundary_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, -1,
                      "Kranc2BSSN::A22", A22_bound);
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register A22_bound BC for Kranc2BSSN::A22!");
  }
  ...
  {
    ierr = Boundary_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, -1,
                      "Kranc2BSSN::A32", A32_bound);
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register A32_bound BC for Kranc2BSSN::A32!");
  }
  ...
  {
    ierr = Boundary_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, -1,
                      "Kranc2BSSN::A33", A33_bound);
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register A33_bound BC for Kranc2BSSN::A33!");
  }
  ...
  {
    ierr = Boundary_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, -1,
                      "Kranc2BSSN::phi", phi_bound);
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register phi_bound BC for Kranc2BSSN::phi!");
  }
  ...
  {
    ierr = Boundary_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, -1,
                      "Kranc2BSSN::K", K_bound);
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register K_bound BC for Kranc2BSSN::K!");
  }
  ...
  {
    ierr = Boundary_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, -1,
                      "Kranc2BSSN::Gam1", Gam1_bound);
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register Gam1_bound BC for Kranc2BSSN::Gam1!");
  }
  ...
  {
    ierr = Boundary_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, -1,
                      "Kranc2BSSN::Gam2", Gam2_bound);
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register Gam2_bound BC for Kranc2BSSN::Gam2!");
  }
  ...
  {
    ierr = Boundary_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, -1,
                      "Kranc2BSSN::Gam3", Gam3_bound);
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register Gam3_bound BC for Kranc2BSSN::Gam3!");
  }
  ...
  {
    ierr = Boundary_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, -1,
                      "Kranc2BSSN::alpha", alpha_bound);
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register alpha_bound BC for Kranc2BSSN::alpha!");
  }
  ...
  {
    ierr = Boundary_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, -1,
                      "Kranc2BSSN::beta1", beta1_bound);
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register beta1_bound BC for Kranc2BSSN::beta1!");
  }
  ...
  {
    ierr = Boundary_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, -1,
                      "Kranc2BSSN::beta2", beta2_bound);
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register beta2_bound BC for Kranc2BSSN::beta2!");
  }
  ...
  {
    ierr = Boundary_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, -1,
                      "Kranc2BSSN::beta3", beta3_bound);
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register beta3_bound BC for Kranc2BSSN::beta3!");
  }
  ...
  {
    ierr = Boundary_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, -1,
                      "Kranc2BSSN::betat1", betat1_bound);
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register betat1_bound BC for Kranc2BSSN::betat1!");
  }
  ...
  {
    ierr = Boundary_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, -1,
                      "Kranc2BSSN::betat2", betat2_bound);
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register betat2_bound BC for Kranc2BSSN::betat2!");
  }
  ...
  {
    ierr = Boundary_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, -1,
                      "Kranc2BSSN::betat3", betat3_bound);
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register betat3_bound BC for Kranc2BSSN::betat3!");
  }
  ...
  if (CCTK_EQUALS(h_group_bound, "radiative"))
  {
   /* select radiation boundary condition */
    ...
    ierr = Boundary_SelectGroupForBC(cctkGH, CCTK_ALL_FACES, 1, handle_h_group_bound, 
                      "Kranc2BSSN::h_group", "Radiation");
  
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register Radiation BC for Kranc2BSSN::h_group!");
  ...
  if (CCTK_EQUALS(A_group_bound, "radiative"))
  {
   /* select radiation boundary condition */
    ...
    ierr = Boundary_SelectGroupForBC(cctkGH, CCTK_ALL_FACES, 1, handle_A_group_bound, 
                      "Kranc2BSSN::A_group", "Radiation");
  
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register Radiation BC for Kranc2BSSN::A_group!");
  ...
  if (CCTK_EQUALS(phi_group_bound, "radiative"))
  {
   /* select radiation boundary condition */
    ...
    ierr = Boundary_SelectGroupForBC(cctkGH, CCTK_ALL_FACES, 1, handle_phi_group_bound, 
                      "Kranc2BSSN::phi_group", "Radiation");
  
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register Radiation BC for Kranc2BSSN::phi_group!");
  ...
  if (CCTK_EQUALS(K_group_bound, "radiative"))
  {
   /* select radiation boundary condition */
    ...
    ierr = Boundary_SelectGroupForBC(cctkGH, CCTK_ALL_FACES, 1, handle_K_group_bound, 
                      "Kranc2BSSN::K_group", "Radiation");
  
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register Radiation BC for Kranc2BSSN::K_group!");
  ...
  if (CCTK_EQUALS(Gam_group_bound, "radiative"))
  {
   /* select radiation boundary condition */
    ...
    ierr = Boundary_SelectGroupForBC(cctkGH, CCTK_ALL_FACES, 1, handle_Gam_group_bound, 
                      "Kranc2BSSN::Gam_group", "Radiation");
  
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register Radiation BC for Kranc2BSSN::Gam_group!");
  ...
  if (CCTK_EQUALS(alpha_group_bound, "radiative"))
  {
   /* select radiation boundary condition */
    ...
    ierr = Boundary_SelectGroupForBC(cctkGH, CCTK_ALL_FACES, 1, handle_alpha_group_bound, 
                      "Kranc2BSSN::alpha_group", "Radiation");
  
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register Radiation BC for Kranc2BSSN::alpha_group!");
  ...
  if (CCTK_EQUALS(beta_group_bound, "radiative"))
  {
   /* select radiation boundary condition */
    ...
    ierr = Boundary_SelectGroupForBC(cctkGH, CCTK_ALL_FACES, 1, handle_beta_group_bound, 
                      "Kranc2BSSN::beta_group", "Radiation");
  
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register Radiation BC for Kranc2BSSN::beta_group!");
  ...
  if (CCTK_EQUALS(betat_group_bound, "radiative"))
  {
   /* select radiation boundary condition */
    ...
    ierr = Boundary_SelectGroupForBC(cctkGH, CCTK_ALL_FACES, 1, handle_betat_group_bound, 
                      "Kranc2BSSN::betat_group", "Radiation");
  
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register Radiation BC for Kranc2BSSN::betat_group!");
  ...
  if (CCTK_EQUALS(h11_bound, "radiative"))
  {
   /* select radiation boundary condition */
    ...
    ierr = Boundary_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, handle_h11_bound, 
                      "Kranc2BSSN::h11", "Radiation");
  
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register Radiation BC for Kranc2BSSN::h11!");
  ...
  if (CCTK_EQUALS(h21_bound, "radiative"))
  {
   /* select radiation boundary condition */
    ...
    ierr = Boundary_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, handle_h21_bound, 
                      "Kranc2BSSN::h21", "Radiation");
  
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register Radiation BC for Kranc2BSSN::h21!");
  ...
  if (CCTK_EQUALS(h31_bound, "radiative"))
  {
   /* select radiation boundary condition */
    ...
    ierr = Boundary_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, handle_h31_bound, 
                      "Kranc2BSSN::h31", "Radiation");
  
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register Radiation BC for Kranc2BSSN::h31!");
  ...
  if (CCTK_EQUALS(h22_bound, "radiative"))
  {
   /* select radiation boundary condition */
    ...
    ierr = Boundary_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, handle_h22_bound, 
                      "Kranc2BSSN::h22", "Radiation");
  
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register Radiation BC for Kranc2BSSN::h22!");
  ...
  if (CCTK_EQUALS(h32_bound, "radiative"))
  {
   /* select radiation boundary condition */
    ...
    ierr = Boundary_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, handle_h32_bound, 
                      "Kranc2BSSN::h32", "Radiation");
  
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register Radiation BC for Kranc2BSSN::h32!");
  ...
  if (CCTK_EQUALS(h33_bound, "radiative"))
  {
   /* select radiation boundary condition */
    ...
    ierr = Boundary_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, handle_h33_bound, 
                      "Kranc2BSSN::h33", "Radiation");
  
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register Radiation BC for Kranc2BSSN::h33!");
  ...
  if (CCTK_EQUALS(A11_bound, "radiative"))
  {
   /* select radiation boundary condition */
    ...
    ierr = Boundary_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, handle_A11_bound, 
                      "Kranc2BSSN::A11", "Radiation");
  
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register Radiation BC for Kranc2BSSN::A11!");
  ...
  if (CCTK_EQUALS(A21_bound, "radiative"))
  {
   /* select radiation boundary condition */
    ...
    ierr = Boundary_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, handle_A21_bound, 
                      "Kranc2BSSN::A21", "Radiation");
  
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register Radiation BC for Kranc2BSSN::A21!");
  ...
  if (CCTK_EQUALS(A31_bound, "radiative"))
  {
   /* select radiation boundary condition */
    ...
    ierr = Boundary_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, handle_A31_bound, 
                      "Kranc2BSSN::A31", "Radiation");
  
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register Radiation BC for Kranc2BSSN::A31!");
  ...
  if (CCTK_EQUALS(A22_bound, "radiative"))
  {
   /* select radiation boundary condition */
    ...
    ierr = Boundary_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, handle_A22_bound, 
                      "Kranc2BSSN::A22", "Radiation");
  
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register Radiation BC for Kranc2BSSN::A22!");
  ...
  if (CCTK_EQUALS(A32_bound, "radiative"))
  {
   /* select radiation boundary condition */
    ...
    ierr = Boundary_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, handle_A32_bound, 
                      "Kranc2BSSN::A32", "Radiation");
  
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register Radiation BC for Kranc2BSSN::A32!");
  ...
  if (CCTK_EQUALS(A33_bound, "radiative"))
  {
   /* select radiation boundary condition */
    ...
    ierr = Boundary_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, handle_A33_bound, 
                      "Kranc2BSSN::A33", "Radiation");
  
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register Radiation BC for Kranc2BSSN::A33!");
  ...
  if (CCTK_EQUALS(phi_bound, "radiative"))
  {
   /* select radiation boundary condition */
    ...
    ierr = Boundary_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, handle_phi_bound, 
                      "Kranc2BSSN::phi", "Radiation");
  
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register Radiation BC for Kranc2BSSN::phi!");
  ...
  if (CCTK_EQUALS(K_bound, "radiative"))
  {
   /* select radiation boundary condition */
    ...
    ierr = Boundary_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, handle_K_bound, 
                      "Kranc2BSSN::K", "Radiation");
  
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register Radiation BC for Kranc2BSSN::K!");
  ...
  if (CCTK_EQUALS(Gam1_bound, "radiative"))
  {
   /* select radiation boundary condition */
    ...
    ierr = Boundary_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, handle_Gam1_bound, 
                      "Kranc2BSSN::Gam1", "Radiation");
  
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register Radiation BC for Kranc2BSSN::Gam1!");
  ...
  if (CCTK_EQUALS(Gam2_bound, "radiative"))
  {
   /* select radiation boundary condition */
    ...
    ierr = Boundary_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, handle_Gam2_bound, 
                      "Kranc2BSSN::Gam2", "Radiation");
  
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register Radiation BC for Kranc2BSSN::Gam2!");
  ...
  if (CCTK_EQUALS(Gam3_bound, "radiative"))
  {
   /* select radiation boundary condition */
    ...
    ierr = Boundary_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, handle_Gam3_bound, 
                      "Kranc2BSSN::Gam3", "Radiation");
  
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register Radiation BC for Kranc2BSSN::Gam3!");
  ...
  if (CCTK_EQUALS(alpha_bound, "radiative"))
  {
   /* select radiation boundary condition */
    ...
    ierr = Boundary_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, handle_alpha_bound, 
                      "Kranc2BSSN::alpha", "Radiation");
  
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register Radiation BC for Kranc2BSSN::alpha!");
  ...
  if (CCTK_EQUALS(beta1_bound, "radiative"))
  {
   /* select radiation boundary condition */
    ...
    ierr = Boundary_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, handle_beta1_bound, 
                      "Kranc2BSSN::beta1", "Radiation");
  
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register Radiation BC for Kranc2BSSN::beta1!");
  ...
  if (CCTK_EQUALS(beta2_bound, "radiative"))
  {
   /* select radiation boundary condition */
    ...
    ierr = Boundary_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, handle_beta2_bound, 
                      "Kranc2BSSN::beta2", "Radiation");
  
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register Radiation BC for Kranc2BSSN::beta2!");
  ...
  if (CCTK_EQUALS(beta3_bound, "radiative"))
  {
   /* select radiation boundary condition */
    ...
    ierr = Boundary_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, handle_beta3_bound, 
                      "Kranc2BSSN::beta3", "Radiation");
  
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register Radiation BC for Kranc2BSSN::beta3!");
  ...
  if (CCTK_EQUALS(betat1_bound, "radiative"))
  {
   /* select radiation boundary condition */
    ...
    ierr = Boundary_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, handle_betat1_bound, 
                      "Kranc2BSSN::betat1", "Radiation");
  
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register Radiation BC for Kranc2BSSN::betat1!");
  ...
  if (CCTK_EQUALS(betat2_bound, "radiative"))
  {
   /* select radiation boundary condition */
    ...
    ierr = Boundary_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, handle_betat2_bound, 
                      "Kranc2BSSN::betat2", "Radiation");
  
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register Radiation BC for Kranc2BSSN::betat2!");
  ...
  if (CCTK_EQUALS(betat3_bound, "radiative"))
  {
   /* select radiation boundary condition */
    ...
    ierr = Boundary_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, handle_betat3_bound, 
                      "Kranc2BSSN::betat3", "Radiation");
  
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register Radiation BC for Kranc2BSSN::betat3!");
  ...
  if (CCTK_EQUALS(h_group_bound, "scalar"))
  {
   /* select scalar boundary condition */
    ...
    ierr = Boundary_SelectGroupForBC(cctkGH, CCTK_ALL_FACES, 1, handle_h_group_bound, 
                      "Kranc2BSSN::h_group", "scalar");
  
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register Scalar BC for Kranc2BSSN::h_group!");
  ...
  if (CCTK_EQUALS(A_group_bound, "scalar"))
  {
   /* select scalar boundary condition */
    ...
    ierr = Boundary_SelectGroupForBC(cctkGH, CCTK_ALL_FACES, 1, handle_A_group_bound, 
                      "Kranc2BSSN::A_group", "scalar");
  
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register Scalar BC for Kranc2BSSN::A_group!");
  ...
  if (CCTK_EQUALS(phi_group_bound, "scalar"))
  {
   /* select scalar boundary condition */
    ...
    ierr = Boundary_SelectGroupForBC(cctkGH, CCTK_ALL_FACES, 1, handle_phi_group_bound, 
                      "Kranc2BSSN::phi_group", "scalar");
  
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register Scalar BC for Kranc2BSSN::phi_group!");
  ...
  if (CCTK_EQUALS(K_group_bound, "scalar"))
  {
   /* select scalar boundary condition */
    ...
    ierr = Boundary_SelectGroupForBC(cctkGH, CCTK_ALL_FACES, 1, handle_K_group_bound, 
                      "Kranc2BSSN::K_group", "scalar");
  
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register Scalar BC for Kranc2BSSN::K_group!");
  ...
  if (CCTK_EQUALS(Gam_group_bound, "scalar"))
  {
   /* select scalar boundary condition */
    ...
    ierr = Boundary_SelectGroupForBC(cctkGH, CCTK_ALL_FACES, 1, handle_Gam_group_bound, 
                      "Kranc2BSSN::Gam_group", "scalar");
  
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register Scalar BC for Kranc2BSSN::Gam_group!");
  ...
  if (CCTK_EQUALS(alpha_group_bound, "scalar"))
  {
   /* select scalar boundary condition */
    ...
    ierr = Boundary_SelectGroupForBC(cctkGH, CCTK_ALL_FACES, 1, handle_alpha_group_bound, 
                      "Kranc2BSSN::alpha_group", "scalar");
  
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register Scalar BC for Kranc2BSSN::alpha_group!");
  ...
  if (CCTK_EQUALS(beta_group_bound, "scalar"))
  {
   /* select scalar boundary condition */
    ...
    ierr = Boundary_SelectGroupForBC(cctkGH, CCTK_ALL_FACES, 1, handle_beta_group_bound, 
                      "Kranc2BSSN::beta_group", "scalar");
  
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register Scalar BC for Kranc2BSSN::beta_group!");
  ...
  if (CCTK_EQUALS(betat_group_bound, "scalar"))
  {
   /* select scalar boundary condition */
    ...
    ierr = Boundary_SelectGroupForBC(cctkGH, CCTK_ALL_FACES, 1, handle_betat_group_bound, 
                      "Kranc2BSSN::betat_group", "scalar");
  
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register Scalar BC for Kranc2BSSN::betat_group!");
  ...
  if (CCTK_EQUALS(h11_bound, "scalar"))
  {
   /* select scalar boundary condition */
    ...
    ierr = Boundary_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, handle_h11_bound, 
                      "Kranc2BSSN::h11", "scalar");
  
    if (ierr < 0)
       CCTK_WARN(0, "Error in registering Scalar BC for Kranc2BSSN::h11!");
  ...
  if (CCTK_EQUALS(h21_bound, "scalar"))
  {
   /* select scalar boundary condition */
    ...
    ierr = Boundary_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, handle_h21_bound, 
                      "Kranc2BSSN::h21", "scalar");
  
    if (ierr < 0)
       CCTK_WARN(0, "Error in registering Scalar BC for Kranc2BSSN::h21!");
  ...
  if (CCTK_EQUALS(h31_bound, "scalar"))
  {
   /* select scalar boundary condition */
    ...
    ierr = Boundary_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, handle_h31_bound, 
                      "Kranc2BSSN::h31", "scalar");
  
    if (ierr < 0)
       CCTK_WARN(0, "Error in registering Scalar BC for Kranc2BSSN::h31!");
  ...
  if (CCTK_EQUALS(h22_bound, "scalar"))
  {
   /* select scalar boundary condition */
    ...
    ierr = Boundary_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, handle_h22_bound, 
                      "Kranc2BSSN::h22", "scalar");
  
    if (ierr < 0)
       CCTK_WARN(0, "Error in registering Scalar BC for Kranc2BSSN::h22!");
  ...
  if (CCTK_EQUALS(h32_bound, "scalar"))
  {
   /* select scalar boundary condition */
    ...
    ierr = Boundary_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, handle_h32_bound, 
                      "Kranc2BSSN::h32", "scalar");
  
    if (ierr < 0)
       CCTK_WARN(0, "Error in registering Scalar BC for Kranc2BSSN::h32!");
  ...
  if (CCTK_EQUALS(h33_bound, "scalar"))
  {
   /* select scalar boundary condition */
    ...
    ierr = Boundary_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, handle_h33_bound, 
                      "Kranc2BSSN::h33", "scalar");
  
    if (ierr < 0)
       CCTK_WARN(0, "Error in registering Scalar BC for Kranc2BSSN::h33!");
  ...
  if (CCTK_EQUALS(A11_bound, "scalar"))
  {
   /* select scalar boundary condition */
    ...
    ierr = Boundary_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, handle_A11_bound, 
                      "Kranc2BSSN::A11", "scalar");
  
    if (ierr < 0)
       CCTK_WARN(0, "Error in registering Scalar BC for Kranc2BSSN::A11!");
  ...
  if (CCTK_EQUALS(A21_bound, "scalar"))
  {
   /* select scalar boundary condition */
    ...
    ierr = Boundary_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, handle_A21_bound, 
                      "Kranc2BSSN::A21", "scalar");
  
    if (ierr < 0)
       CCTK_WARN(0, "Error in registering Scalar BC for Kranc2BSSN::A21!");
  ...
  if (CCTK_EQUALS(A31_bound, "scalar"))
  {
   /* select scalar boundary condition */
    ...
    ierr = Boundary_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, handle_A31_bound, 
                      "Kranc2BSSN::A31", "scalar");
  
    if (ierr < 0)
       CCTK_WARN(0, "Error in registering Scalar BC for Kranc2BSSN::A31!");
  ...
  if (CCTK_EQUALS(A22_bound, "scalar"))
  {
   /* select scalar boundary condition */
    ...
    ierr = Boundary_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, handle_A22_bound, 
                      "Kranc2BSSN::A22", "scalar");
  
    if (ierr < 0)
       CCTK_WARN(0, "Error in registering Scalar BC for Kranc2BSSN::A22!");
  ...
  if (CCTK_EQUALS(A32_bound, "scalar"))
  {
   /* select scalar boundary condition */
    ...
    ierr = Boundary_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, handle_A32_bound, 
                      "Kranc2BSSN::A32", "scalar");
  
    if (ierr < 0)
       CCTK_WARN(0, "Error in registering Scalar BC for Kranc2BSSN::A32!");
  ...
  if (CCTK_EQUALS(A33_bound, "scalar"))
  {
   /* select scalar boundary condition */
    ...
    ierr = Boundary_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, handle_A33_bound, 
                      "Kranc2BSSN::A33", "scalar");
  
    if (ierr < 0)
       CCTK_WARN(0, "Error in registering Scalar BC for Kranc2BSSN::A33!");
  ...
  if (CCTK_EQUALS(phi_bound, "scalar"))
  {
   /* select scalar boundary condition */
    ...
    ierr = Boundary_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, handle_phi_bound, 
                      "Kranc2BSSN::phi", "scalar");
  
    if (ierr < 0)
       CCTK_WARN(0, "Error in registering Scalar BC for Kranc2BSSN::phi!");
  ...
  if (CCTK_EQUALS(K_bound, "scalar"))
  {
   /* select scalar boundary condition */
    ...
    if (ierr < 0)
       CCTK_WARN(0, "Error in registering Scalar BC for Kranc2BSSN::K!");
  ...
  if (CCTK_EQUALS(Gam1_bound, "scalar"))
  {
   /* select scalar boundary condition */
    ...
    ierr = Boundary_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, handle_Gam1_bound, 
                      "Kranc2BSSN::Gam1", "scalar");
  
    if (ierr < 0)
       CCTK_WARN(0, "Error in registering Scalar BC for Kranc2BSSN::Gam1!");
  ...
  if (CCTK_EQUALS(Gam2_bound, "scalar"))
  {
   /* select scalar boundary condition */
    ...
    ierr = Boundary_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, handle_Gam2_bound, 
                      "Kranc2BSSN::Gam2", "scalar");
  
    if (ierr < 0)
       CCTK_WARN(0, "Error in registering Scalar BC for Kranc2BSSN::Gam2!");
  ...
  if (CCTK_EQUALS(Gam3_bound, "scalar"))
  {
   /* select scalar boundary condition */
    ...
    ierr = Boundary_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, handle_Gam3_bound, 
                      "Kranc2BSSN::Gam3", "scalar");
  
    if (ierr < 0)
       CCTK_WARN(0, "Error in registering Scalar BC for Kranc2BSSN::Gam3!");
  ...
  if (CCTK_EQUALS(alpha_bound, "scalar"))
  {
   /* select scalar boundary condition */
    ...
    ierr = Boundary_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, handle_alpha_bound, 
                      "Kranc2BSSN::alpha", "scalar");
  
    if (ierr < 0)
       CCTK_WARN(0, "Error in registering Scalar BC for Kranc2BSSN::alpha!");
  ...
  if (CCTK_EQUALS(beta1_bound, "scalar"))
  {
   /* select scalar boundary condition */
    ...
    ierr = Boundary_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, handle_beta1_bound, 
                      "Kranc2BSSN::beta1", "scalar");
  
    if (ierr < 0)
       CCTK_WARN(0, "Error in registering Scalar BC for Kranc2BSSN::beta1!");
  ...
  if (CCTK_EQUALS(beta2_bound, "scalar"))
  {
   /* select scalar boundary condition */
    ...
    ierr = Boundary_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, handle_beta2_bound, 
                      "Kranc2BSSN::beta2", "scalar");
  
    if (ierr < 0)
       CCTK_WARN(0, "Error in registering Scalar BC for Kranc2BSSN::beta2!");
  ...
  if (CCTK_EQUALS(beta3_bound, "scalar"))
  {
   /* select scalar boundary condition */
    ...
    ierr = Boundary_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, handle_beta3_bound, 
                      "Kranc2BSSN::beta3", "scalar");
  
    if (ierr < 0)
       CCTK_WARN(0, "Error in registering Scalar BC for Kranc2BSSN::beta3!");
  ...
  if (CCTK_EQUALS(betat1_bound, "scalar"))
  {
   /* select scalar boundary condition */
    ...
    ierr = Boundary_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, handle_betat1_bound, 
                      "Kranc2BSSN::betat1", "scalar");
  
    if (ierr < 0)
       CCTK_WARN(0, "Error in registering Scalar BC for Kranc2BSSN::betat1!");
  ...
  if (CCTK_EQUALS(betat2_bound, "scalar"))
  {
   /* select scalar boundary condition */
    ...
    ierr = Boundary_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, handle_betat2_bound, 
                      "Kranc2BSSN::betat2", "scalar");
  
    if (ierr < 0)
       CCTK_WARN(0, "Error in registering Scalar BC for Kranc2BSSN::betat2!");
  ...
  if (CCTK_EQUALS(betat3_bound, "scalar"))
  {
   /* select scalar boundary condition */
    ...
    ierr = Boundary_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, handle_betat3_bound, 
                      "Kranc2BSSN::betat3", "scalar");
  
    if (ierr < 0)
       CCTK_WARN(0, "Error in registering Scalar BC for Kranc2BSSN::betat3!");
...
#$bound$#Kranc2BSSN::h_group_bound       = "skip"
#$bound$#Kranc2BSSN::h_group_bound_speed = 1.0
#$bound$#Kranc2BSSN::h_group_bound_limit = 0.0
#$bound$#Kranc2BSSN::h_group_bound_scalar = 0.0

#$bound$#Kranc2BSSN::A_group_bound       = "skip"
#$bound$#Kranc2BSSN::A_group_bound_speed = 1.0
#$bound$#Kranc2BSSN::A_group_bound_limit = 0.0
#$bound$#Kranc2BSSN::A_group_bound_scalar = 0.0

#$bound$#Kranc2BSSN::phi_group_bound       = "skip"
#$bound$#Kranc2BSSN::phi_group_bound_speed = 1.0
#$bound$#Kranc2BSSN::phi_group_bound_limit = 0.0
#$bound$#Kranc2BSSN::phi_group_bound_scalar = 0.0

#$bound$#Kranc2BSSN::K_group_bound       = "skip"
#$bound$#Kranc2BSSN::K_group_bound_speed = 1.0
#$bound$#Kranc2BSSN::K_group_bound_limit = 0.0
#$bound$#Kranc2BSSN::K_group_bound_scalar = 0.0

#$bound$#Kranc2BSSN::Gam_group_bound       = "skip"
#$bound$#Kranc2BSSN::Gam_group_bound_speed = 1.0
#$bound$#Kranc2BSSN::Gam_group_bound_limit = 0.0
#$bound$#Kranc2BSSN::Gam_group_bound_scalar = 0.0

#$bound$#Kranc2BSSN::alpha_group_bound       = "skip"
#$bound$#Kranc2BSSN::alpha_group_bound_speed = 1.0
#$bound$#Kranc2BSSN::alpha_group_bound_limit = 0.0
#$bound$#Kranc2BSSN::alpha_group_bound_scalar = 0.0

#$bound$#Kranc2BSSN::beta_group_bound       = "skip"
#$bound$#Kranc2BSSN::beta_group_bound_speed = 1.0
#$bound$#Kranc2BSSN::beta_group_bound_limit = 0.0
#$bound$#Kranc2BSSN::beta_group_bound_scalar = 0.0

#$bound$#Kranc2BSSN::betat_group_bound       = "skip"
#$bound$#Kranc2BSSN::betat_group_bound_speed = 1.0
#$bound$#Kranc2BSSN::betat_group_bound_limit = 0.0
#$bound$#Kranc2BSSN::betat_group_bound_scalar = 0.0

#$bound$#Kranc2BSSN::h11_bound       = "skip"
#$bound$#Kranc2BSSN::h11_bound_speed = 1.0
#$bound$#Kranc2BSSN::h11_bound_limit = 0.0
#$bound$#Kranc2BSSN::h11_bound_scalar = 0.0

#$bound$#Kranc2BSSN::h21_bound       = "skip"
#$bound$#Kranc2BSSN::h21_bound_speed = 1.0
#$bound$#Kranc2BSSN::h21_bound_limit = 0.0
#$bound$#Kranc2BSSN::h21_bound_scalar = 0.0

#$bound$#Kranc2BSSN::h31_bound       = "skip"
#$bound$#Kranc2BSSN::h31_bound_speed = 1.0
#$bound$#Kranc2BSSN::h31_bound_limit = 0.0
#$bound$#Kranc2BSSN::h31_bound_scalar = 0.0

#$bound$#Kranc2BSSN::h22_bound       = "skip"
#$bound$#Kranc2BSSN::h22_bound_speed = 1.0
#$bound$#Kranc2BSSN::h22_bound_limit = 0.0
#$bound$#Kranc2BSSN::h22_bound_scalar = 0.0

#$bound$#Kranc2BSSN::h32_bound       = "skip"
#$bound$#Kranc2BSSN::h32_bound_speed = 1.0
#$bound$#Kranc2BSSN::h32_bound_limit = 0.0
#$bound$#Kranc2BSSN::h32_bound_scalar = 0.0

#$bound$#Kranc2BSSN::h33_bound       = "skip"
#$bound$#Kranc2BSSN::h33_bound_speed = 1.0
#$bound$#Kranc2BSSN::h33_bound_limit = 0.0
#$bound$#Kranc2BSSN::h33_bound_scalar = 0.0

#$bound$#Kranc2BSSN::A11_bound       = "skip"
#$bound$#Kranc2BSSN::A11_bound_speed = 1.0
#$bound$#Kranc2BSSN::A11_bound_limit = 0.0
#$bound$#Kranc2BSSN::A11_bound_scalar = 0.0

#$bound$#Kranc2BSSN::A21_bound       = "skip"
#$bound$#Kranc2BSSN::A21_bound_speed = 1.0
#$bound$#Kranc2BSSN::A21_bound_limit = 0.0
#$bound$#Kranc2BSSN::A21_bound_scalar = 0.0

#$bound$#Kranc2BSSN::A31_bound       = "skip"
#$bound$#Kranc2BSSN::A31_bound_speed = 1.0
#$bound$#Kranc2BSSN::A31_bound_limit = 0.0
#$bound$#Kranc2BSSN::A31_bound_scalar = 0.0

#$bound$#Kranc2BSSN::A22_bound       = "skip"
#$bound$#Kranc2BSSN::A22_bound_speed = 1.0
#$bound$#Kranc2BSSN::A22_bound_limit = 0.0
#$bound$#Kranc2BSSN::A22_bound_scalar = 0.0

#$bound$#Kranc2BSSN::A32_bound       = "skip"
#$bound$#Kranc2BSSN::A32_bound_speed = 1.0
#$bound$#Kranc2BSSN::A32_bound_limit = 0.0
#$bound$#Kranc2BSSN::A32_bound_scalar = 0.0

#$bound$#Kranc2BSSN::A33_bound       = "skip"
#$bound$#Kranc2BSSN::A33_bound_speed = 1.0
#$bound$#Kranc2BSSN::A33_bound_limit = 0.0
#$bound$#Kranc2BSSN::A33_bound_scalar = 0.0

#$bound$#Kranc2BSSN::phi_bound       = "skip"
#$bound$#Kranc2BSSN::phi_bound_speed = 1.0
#$bound$#Kranc2BSSN::phi_bound_limit = 0.0
#$bound$#Kranc2BSSN::phi_bound_scalar = 0.0

#$bound$#Kranc2BSSN::K_bound       = "skip"
#$bound$#Kranc2BSSN::K_bound_speed = 1.0
#$bound$#Kranc2BSSN::K_bound_limit = 0.0
#$bound$#Kranc2BSSN::K_bound_scalar = 0.0

#$bound$#Kranc2BSSN::Gam1_bound       = "skip"
#$bound$#Kranc2BSSN::Gam1_bound_speed = 1.0
#$bound$#Kranc2BSSN::Gam1_bound_limit = 0.0
#$bound$#Kranc2BSSN::Gam1_bound_scalar = 0.0

#$bound$#Kranc2BSSN::Gam2_bound       = "skip"
#$bound$#Kranc2BSSN::Gam2_bound_speed = 1.0
#$bound$#Kranc2BSSN::Gam2_bound_limit = 0.0
#$bound$#Kranc2BSSN::Gam2_bound_scalar = 0.0

#$bound$#Kranc2BSSN::Gam3_bound       = "skip"
#$bound$#Kranc2BSSN::Gam3_bound_speed = 1.0
#$bound$#Kranc2BSSN::Gam3_bound_limit = 0.0
#$bound$#Kranc2BSSN::Gam3_bound_scalar = 0.0

#$bound$#Kranc2BSSN::alpha_bound       = "skip"
#$bound$#Kranc2BSSN::alpha_bound_speed = 1.0
#$bound$#Kranc2BSSN::alpha_bound_limit = 0.0
#$bound$#Kranc2BSSN::alpha_bound_scalar = 0.0

#$bound$#Kranc2BSSN::beta1_bound       = "skip"
#$bound$#Kranc2BSSN::beta1_bound_speed = 1.0
#$bound$#Kranc2BSSN::beta1_bound_limit = 0.0
#$bound$#Kranc2BSSN::beta1_bound_scalar = 0.0

#$bound$#Kranc2BSSN::beta2_bound       = "skip"
#$bound$#Kranc2BSSN::beta2_bound_speed = 1.0
#$bound$#Kranc2BSSN::beta2_bound_limit = 0.0
#$bound$#Kranc2BSSN::beta2_bound_scalar = 0.0

#$bound$#Kranc2BSSN::beta3_bound       = "skip"
#$bound$#Kranc2BSSN::beta3_bound_speed = 1.0
#$bound$#Kranc2BSSN::beta3_bound_limit = 0.0
#$bound$#Kranc2BSSN::beta3_bound_scalar = 0.0

#$bound$#Kranc2BSSN::betat1_bound       = "skip"
#$bound$#Kranc2BSSN::betat1_bound_speed = 1.0
#$bound$#Kranc2BSSN::betat1_bound_limit = 0.0
#$bound$#Kranc2BSSN::betat1_bound_scalar = 0.0

#$bound$#Kranc2BSSN::betat2_bound       = "skip"
#$bound$#Kranc2BSSN::betat2_bound_speed = 1.0
#$bound$#Kranc2BSSN::betat2_bound_limit = 0.0
#$bound$#Kranc2BSSN::betat2_bound_scalar = 0.0

#$bound$#Kranc2BSSN::betat3_bound       = "skip"
#$bound$#Kranc2BSSN::betat3_bound_speed = 1.0
#$bound$#Kranc2BSSN::betat3_bound_limit = 0.0
#$bound$#Kranc2BSSN::betat3_bound_scalar = 0.0
