...
externalEtaBetaGroups =
   {{"ExternalEtaBeta::exetaBeta_group", {externalEtaBeta} } };
...
(*   DeclarationIncludes -> {"externaletabeta.h"},*)
   Equations ->
   {
     ...
     dot[betat[ui]] -> -externalEtaBeta betat[ui] + chiBeta alpha^gammaDriverLapsePower dot[Gam[ui]] - NASAAdvection beta[ua] PDadvect[Gam[ui],la]  + betatAdvection beta[ua] PDadvect[betat[ui],la]
   }
};
