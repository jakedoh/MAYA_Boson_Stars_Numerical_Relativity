...
namespace Kranc2BSSNChi {

extern "C" void bssnchi_evolve_nonmetric_4thcentred_SelectBCs(CCTK_ARGUMENTS)
{
  DECLARE_CCTK_ARGUMENTS;
  DECLARE_CCTK_PARAMETERS;
  
  if (cctk_iteration % bssnchi_evolve_nonmetric_4thcentred_calc_every != bssnchi_evolve_nonmetric_4thcentred_calc_offset)
    return;
  CCTK_INT ierr CCTK_ATTRIBUTE_UNUSED = 0;
  ierr = Boundary_SelectGroupForBC(cctkGH, CCTK_ALL_FACES, GetBoundaryWidth(cctkGH), -1 /* no table */, "Kranc2BSSNChi::A_grouprhs","flat");
  if (ierr < 0)
    CCTK_WARN(CCTK_WARN_ALERT, "Failed to register flat BC for Kranc2BSSNChi::A_grouprhs.");
  ierr = Boundary_SelectGroupForBC(cctkGH, CCTK_ALL_FACES, GetBoundaryWidth(cctkGH), -1 /* no table */, "Kranc2BSSNChi::Gam_grouprhs","flat");
  if (ierr < 0)
    CCTK_WARN(CCTK_WARN_ALERT, "Failed to register flat BC for Kranc2BSSNChi::Gam_grouprhs.");
  ierr = Boundary_SelectGroupForBC(cctkGH, CCTK_ALL_FACES, GetBoundaryWidth(cctkGH), -1 /* no table */, "Kranc2BSSNChi::K_grouprhs","flat");
  if (ierr < 0)
    CCTK_WARN(CCTK_WARN_ALERT, "Failed to register flat BC for Kranc2BSSNChi::K_grouprhs.");
  ierr = Boundary_SelectGroupForBC(cctkGH, CCTK_ALL_FACES, GetBoundaryWidth(cctkGH), -1 /* no table */, "Kranc2BSSNChi::scalarconstraints","flat");
  if (ierr < 0)
    CCTK_WARN(CCTK_WARN_ALERT, "Failed to register flat BC for Kranc2BSSNChi::scalarconstraints.");
  return;
}

static void bssnchi_evolve_nonmetric_4thcentred_Body(const cGH* restrict const cctkGH, const int dir, const int face, const CCTK_REAL normal[3], const CCTK_REAL tangentA[3], const CCTK_REAL tangentB[3], const int imin[3], const int imax[3], const int n_subblock_gfs, CCTK_REAL* restrict const subblock_gfs[])
{
  DECLARE_CCTK_ARGUMENTS;
  DECLARE_CCTK_PARAMETERS;
  ...
  #pragma omp parallel
  CCTK_LOOP3(bssnchi_evolve_nonmetric_4thcentred,
    ...
    cctk_ash[0],cctk_ash[1],cctk_ash[2])
  {
    ...
    CCTK_REAL PDstandard4th1A11 CCTK_ATTRIBUTE_UNUSED;
    CCTK_REAL PDstandard4th2A11 CCTK_ATTRIBUTE_UNUSED;
    CCTK_REAL PDstandard4th3A11 CCTK_ATTRIBUTE_UNUSED;
    CCTK_REAL PDstandard4th1A21 CCTK_ATTRIBUTE_UNUSED;
    CCTK_REAL PDstandard4th2A21 CCTK_ATTRIBUTE_UNUSED;
    CCTK_REAL PDstandard4th3A21 CCTK_ATTRIBUTE_UNUSED;
    CCTK_REAL PDstandard4th1A22 CCTK_ATTRIBUTE_UNUSED;
    CCTK_REAL PDstandard4th2A22 CCTK_ATTRIBUTE_UNUSED;
    CCTK_REAL PDstandard4th3A22 CCTK_ATTRIBUTE_UNUSED;
    CCTK_REAL PDstandard4th1A31 CCTK_ATTRIBUTE_UNUSED;
    CCTK_REAL PDstandard4th2A31 CCTK_ATTRIBUTE_UNUSED;
    CCTK_REAL PDstandard4th3A31 CCTK_ATTRIBUTE_UNUSED;
    CCTK_REAL PDstandard4th1A32 CCTK_ATTRIBUTE_UNUSED;
    CCTK_REAL PDstandard4th2A32 CCTK_ATTRIBUTE_UNUSED;
    CCTK_REAL PDstandard4th3A32 CCTK_ATTRIBUTE_UNUSED;
    CCTK_REAL PDstandard4th1A33 CCTK_ATTRIBUTE_UNUSED;
    CCTK_REAL PDstandard4th2A33 CCTK_ATTRIBUTE_UNUSED;
    CCTK_REAL PDstandard4th3A33 CCTK_ATTRIBUTE_UNUSED;
    CCTK_REAL PDstandard4th1alpha CCTK_ATTRIBUTE_UNUSED;
    CCTK_REAL PDstandard4th2alpha CCTK_ATTRIBUTE_UNUSED;
    CCTK_REAL PDstandard4th3alpha CCTK_ATTRIBUTE_UNUSED;
    CCTK_REAL PDstandard4th11alpha CCTK_ATTRIBUTE_UNUSED;
    CCTK_REAL PDstandard4th22alpha CCTK_ATTRIBUTE_UNUSED;
    CCTK_REAL PDstandard4th33alpha CCTK_ATTRIBUTE_UNUSED;
    CCTK_REAL PDstandard4th12alpha CCTK_ATTRIBUTE_UNUSED;
    CCTK_REAL PDstandard4th13alpha CCTK_ATTRIBUTE_UNUSED;
    CCTK_REAL PDstandard4th23alpha CCTK_ATTRIBUTE_UNUSED;
    ...
    CCTK_REAL PDstandard4th11beta1 CCTK_ATTRIBUTE_UNUSED;
    CCTK_REAL PDstandard4th22beta1 CCTK_ATTRIBUTE_UNUSED;
    CCTK_REAL PDstandard4th33beta1 CCTK_ATTRIBUTE_UNUSED;
    CCTK_REAL PDstandard4th12beta1 CCTK_ATTRIBUTE_UNUSED;
    CCTK_REAL PDstandard4th13beta1 CCTK_ATTRIBUTE_UNUSED;
    CCTK_REAL PDstandard4th23beta1 CCTK_ATTRIBUTE_UNUSED;
    ...
    CCTK_REAL PDstandard4th11beta2 CCTK_ATTRIBUTE_UNUSED;
    CCTK_REAL PDstandard4th22beta2 CCTK_ATTRIBUTE_UNUSED;
    CCTK_REAL PDstandard4th33beta2 CCTK_ATTRIBUTE_UNUSED;
    CCTK_REAL PDstandard4th12beta2 CCTK_ATTRIBUTE_UNUSED;
    CCTK_REAL PDstandard4th13beta2 CCTK_ATTRIBUTE_UNUSED;
    CCTK_REAL PDstandard4th23beta2 CCTK_ATTRIBUTE_UNUSED;
    ...
    CCTK_REAL PDstandard4th11beta3 CCTK_ATTRIBUTE_UNUSED;
    CCTK_REAL PDstandard4th22beta3 CCTK_ATTRIBUTE_UNUSED;
    CCTK_REAL PDstandard4th33beta3 CCTK_ATTRIBUTE_UNUSED;
    CCTK_REAL PDstandard4th12beta3 CCTK_ATTRIBUTE_UNUSED;
    CCTK_REAL PDstandard4th13beta3 CCTK_ATTRIBUTE_UNUSED;
    CCTK_REAL PDstandard4th23beta3 CCTK_ATTRIBUTE_UNUSED;
    CCTK_REAL PDstandard4th1chi CCTK_ATTRIBUTE_UNUSED;
    CCTK_REAL PDstandard4th2chi CCTK_ATTRIBUTE_UNUSED;
    CCTK_REAL PDstandard4th3chi CCTK_ATTRIBUTE_UNUSED;
    CCTK_REAL PDstandard4th11chi CCTK_ATTRIBUTE_UNUSED;
    CCTK_REAL PDstandard4th22chi CCTK_ATTRIBUTE_UNUSED;
    CCTK_REAL PDstandard4th33chi CCTK_ATTRIBUTE_UNUSED;
    CCTK_REAL PDstandard4th12chi CCTK_ATTRIBUTE_UNUSED;
    CCTK_REAL PDstandard4th13chi CCTK_ATTRIBUTE_UNUSED;
    CCTK_REAL PDstandard4th23chi CCTK_ATTRIBUTE_UNUSED;
    ...
    CCTK_REAL PDstandard4th11h11 CCTK_ATTRIBUTE_UNUSED;
    CCTK_REAL PDstandard4th22h11 CCTK_ATTRIBUTE_UNUSED;
    CCTK_REAL PDstandard4th33h11 CCTK_ATTRIBUTE_UNUSED;
    CCTK_REAL PDstandard4th12h11 CCTK_ATTRIBUTE_UNUSED;
    CCTK_REAL PDstandard4th13h11 CCTK_ATTRIBUTE_UNUSED;
    CCTK_REAL PDstandard4th23h11 CCTK_ATTRIBUTE_UNUSED;
    ...
    CCTK_REAL PDstandard4th11h21 CCTK_ATTRIBUTE_UNUSED;
    CCTK_REAL PDstandard4th22h21 CCTK_ATTRIBUTE_UNUSED;
    CCTK_REAL PDstandard4th33h21 CCTK_ATTRIBUTE_UNUSED;
    CCTK_REAL PDstandard4th12h21 CCTK_ATTRIBUTE_UNUSED;
    CCTK_REAL PDstandard4th13h21 CCTK_ATTRIBUTE_UNUSED;
    CCTK_REAL PDstandard4th23h21 CCTK_ATTRIBUTE_UNUSED;
    ...
    CCTK_REAL PDstandard4th11h22 CCTK_ATTRIBUTE_UNUSED;
    CCTK_REAL PDstandard4th22h22 CCTK_ATTRIBUTE_UNUSED;
    CCTK_REAL PDstandard4th33h22 CCTK_ATTRIBUTE_UNUSED;
    CCTK_REAL PDstandard4th12h22 CCTK_ATTRIBUTE_UNUSED;
    CCTK_REAL PDstandard4th13h22 CCTK_ATTRIBUTE_UNUSED;
    CCTK_REAL PDstandard4th23h22 CCTK_ATTRIBUTE_UNUSED;
    ...
    CCTK_REAL PDstandard4th11h31 CCTK_ATTRIBUTE_UNUSED;
    CCTK_REAL PDstandard4th22h31 CCTK_ATTRIBUTE_UNUSED;
    CCTK_REAL PDstandard4th33h31 CCTK_ATTRIBUTE_UNUSED;
    CCTK_REAL PDstandard4th12h31 CCTK_ATTRIBUTE_UNUSED;
    CCTK_REAL PDstandard4th13h31 CCTK_ATTRIBUTE_UNUSED;
    CCTK_REAL PDstandard4th23h31 CCTK_ATTRIBUTE_UNUSED;
    ...
    CCTK_REAL PDstandard4th11h32 CCTK_ATTRIBUTE_UNUSED;
    CCTK_REAL PDstandard4th22h32 CCTK_ATTRIBUTE_UNUSED;
    CCTK_REAL PDstandard4th33h32 CCTK_ATTRIBUTE_UNUSED;
    CCTK_REAL PDstandard4th12h32 CCTK_ATTRIBUTE_UNUSED;
    CCTK_REAL PDstandard4th13h32 CCTK_ATTRIBUTE_UNUSED;
    CCTK_REAL PDstandard4th23h32 CCTK_ATTRIBUTE_UNUSED;
    ...
    CCTK_REAL PDstandard4th11h33 CCTK_ATTRIBUTE_UNUSED;
    CCTK_REAL PDstandard4th22h33 CCTK_ATTRIBUTE_UNUSED;
    CCTK_REAL PDstandard4th33h33 CCTK_ATTRIBUTE_UNUSED;
    CCTK_REAL PDstandard4th12h33 CCTK_ATTRIBUTE_UNUSED;
    CCTK_REAL PDstandard4th13h33 CCTK_ATTRIBUTE_UNUSED;
    CCTK_REAL PDstandard4th23h33 CCTK_ATTRIBUTE_UNUSED;
    CCTK_REAL PDstandard4th1K CCTK_ATTRIBUTE_UNUSED;
    CCTK_REAL PDstandard4th2K CCTK_ATTRIBUTE_UNUSED;
    CCTK_REAL PDstandard4th3K CCTK_ATTRIBUTE_UNUSED;
    
    switch (constraintsfdorder)
    {
      case 2:
      {
        PDstandard4th1A11 = PDstandard4th1(&A11[index]);
        PDstandard4th2A11 = PDstandard4th2(&A11[index]);
        PDstandard4th3A11 = PDstandard4th3(&A11[index]);
        PDstandard4th1A21 = PDstandard4th1(&A21[index]);
        PDstandard4th2A21 = PDstandard4th2(&A21[index]);
        PDstandard4th3A21 = PDstandard4th3(&A21[index]);
        PDstandard4th1A22 = PDstandard4th1(&A22[index]);
        PDstandard4th2A22 = PDstandard4th2(&A22[index]);
        PDstandard4th3A22 = PDstandard4th3(&A22[index]);
        PDstandard4th1A31 = PDstandard4th1(&A31[index]);
        PDstandard4th2A31 = PDstandard4th2(&A31[index]);
        PDstandard4th3A31 = PDstandard4th3(&A31[index]);
        PDstandard4th1A32 = PDstandard4th1(&A32[index]);
        PDstandard4th2A32 = PDstandard4th2(&A32[index]);
        PDstandard4th3A32 = PDstandard4th3(&A32[index]);
        PDstandard4th1A33 = PDstandard4th1(&A33[index]);
        PDstandard4th2A33 = PDstandard4th2(&A33[index]);
        PDstandard4th3A33 = PDstandard4th3(&A33[index]);
        PDstandard4th1alpha = PDstandard4th1(&alpha[index]);
        PDstandard4th2alpha = PDstandard4th2(&alpha[index]);
        PDstandard4th3alpha = PDstandard4th3(&alpha[index]);
        PDstandard4th11alpha = PDstandard4th11(&alpha[index]);
        PDstandard4th22alpha = PDstandard4th22(&alpha[index]);
        PDstandard4th33alpha = PDstandard4th33(&alpha[index]);
        PDstandard4th12alpha = PDstandard4th12(&alpha[index]);
        PDstandard4th13alpha = PDstandard4th13(&alpha[index]);
        PDstandard4th23alpha = PDstandard4th23(&alpha[index]);
        ...
        PDstandard4th11beta1 = PDstandard4th11(&beta1[index]);
        PDstandard4th22beta1 = PDstandard4th22(&beta1[index]);
        PDstandard4th33beta1 = PDstandard4th33(&beta1[index]);
        PDstandard4th12beta1 = PDstandard4th12(&beta1[index]);
        PDstandard4th13beta1 = PDstandard4th13(&beta1[index]);
        PDstandard4th23beta1 = PDstandard4th23(&beta1[index]);
        ...
        PDstandard4th11beta2 = PDstandard4th11(&beta2[index]);
        PDstandard4th22beta2 = PDstandard4th22(&beta2[index]);
        PDstandard4th33beta2 = PDstandard4th33(&beta2[index]);
        PDstandard4th12beta2 = PDstandard4th12(&beta2[index]);
        PDstandard4th13beta2 = PDstandard4th13(&beta2[index]);
        PDstandard4th23beta2 = PDstandard4th23(&beta2[index]);
        ...
        PDstandard4th11beta3 = PDstandard4th11(&beta3[index]);
        PDstandard4th22beta3 = PDstandard4th22(&beta3[index]);
        PDstandard4th33beta3 = PDstandard4th33(&beta3[index]);
        PDstandard4th12beta3 = PDstandard4th12(&beta3[index]);
        PDstandard4th13beta3 = PDstandard4th13(&beta3[index]);
        PDstandard4th23beta3 = PDstandard4th23(&beta3[index]);
        PDstandard4th1chi = PDstandard4th1(&chi[index]);
        PDstandard4th2chi = PDstandard4th2(&chi[index]);
        PDstandard4th3chi = PDstandard4th3(&chi[index]);
        PDstandard4th11chi = PDstandard4th11(&chi[index]);
        PDstandard4th22chi = PDstandard4th22(&chi[index]);
        PDstandard4th33chi = PDstandard4th33(&chi[index]);
        PDstandard4th12chi = PDstandard4th12(&chi[index]);
        PDstandard4th13chi = PDstandard4th13(&chi[index]);
        PDstandard4th23chi = PDstandard4th23(&chi[index]);
        ...
        PDstandard4th11h11 = PDstandard4th11(&h11[index]);
        PDstandard4th22h11 = PDstandard4th22(&h11[index]);
        PDstandard4th33h11 = PDstandard4th33(&h11[index]);
        PDstandard4th12h11 = PDstandard4th12(&h11[index]);
        PDstandard4th13h11 = PDstandard4th13(&h11[index]);
        PDstandard4th23h11 = PDstandard4th23(&h11[index]);
        ...
        PDstandard4th11h21 = PDstandard4th11(&h21[index]);
        PDstandard4th22h21 = PDstandard4th22(&h21[index]);
        PDstandard4th33h21 = PDstandard4th33(&h21[index]);
        PDstandard4th12h21 = PDstandard4th12(&h21[index]);
        PDstandard4th13h21 = PDstandard4th13(&h21[index]);
        PDstandard4th23h21 = PDstandard4th23(&h21[index]);
        ...
        PDstandard4th11h22 = PDstandard4th11(&h22[index]);
        PDstandard4th22h22 = PDstandard4th22(&h22[index]);
        PDstandard4th33h22 = PDstandard4th33(&h22[index]);
        PDstandard4th12h22 = PDstandard4th12(&h22[index]);
        PDstandard4th13h22 = PDstandard4th13(&h22[index]);
        PDstandard4th23h22 = PDstandard4th23(&h22[index]);
        ...
        PDstandard4th11h31 = PDstandard4th11(&h31[index]);
        PDstandard4th22h31 = PDstandard4th22(&h31[index]);
        PDstandard4th33h31 = PDstandard4th33(&h31[index]);
        PDstandard4th12h31 = PDstandard4th12(&h31[index]);
        PDstandard4th13h31 = PDstandard4th13(&h31[index]);
        PDstandard4th23h31 = PDstandard4th23(&h31[index]);
        ...
        PDstandard4th11h32 = PDstandard4th11(&h32[index]);
        PDstandard4th22h32 = PDstandard4th22(&h32[index]);
        PDstandard4th33h32 = PDstandard4th33(&h32[index]);
        PDstandard4th12h32 = PDstandard4th12(&h32[index]);
        PDstandard4th13h32 = PDstandard4th13(&h32[index]);
        PDstandard4th23h32 = PDstandard4th23(&h32[index]);
        ...
        PDstandard4th11h33 = PDstandard4th11(&h33[index]);
        PDstandard4th22h33 = PDstandard4th22(&h33[index]);
        PDstandard4th33h33 = PDstandard4th33(&h33[index]);
        PDstandard4th12h33 = PDstandard4th12(&h33[index]);
        PDstandard4th13h33 = PDstandard4th13(&h33[index]);
        PDstandard4th23h33 = PDstandard4th23(&h33[index]);
        PDstandard4th1K = PDstandard4th1(&K[index]);
        PDstandard4th2K = PDstandard4th2(&K[index]);
        PDstandard4th3K = PDstandard4th3(&K[index]);
        break;
      }
    ...
    CCTK_REAL gamma111 CCTK_ATTRIBUTE_UNUSED = 
      0.5*hInv11*PDstandard4th1h11 + hInv12*(PDstandard4th1h21 - 
      0.5*PDstandard4th2h11) + hInv13*(PDstandard4th1h31 - 
      0.5*PDstandard4th3h11);
    
    CCTK_REAL gamma211 CCTK_ATTRIBUTE_UNUSED = 
      0.5*hInv12*PDstandard4th1h11 + hInv22*(PDstandard4th1h21 - 
      0.5*PDstandard4th2h11) + hInv23*(PDstandard4th1h31 - 
      0.5*PDstandard4th3h11);
    
    CCTK_REAL gamma311 CCTK_ATTRIBUTE_UNUSED = 
      0.5*hInv13*PDstandard4th1h11 + hInv23*(PDstandard4th1h21 - 
      0.5*PDstandard4th2h11) + hInv33*(PDstandard4th1h31 - 
      0.5*PDstandard4th3h11);
    ...
    CCTK_REAL gamma122 CCTK_ATTRIBUTE_UNUSED = 
      hInv11*(-0.5*PDstandard4th1h22 + PDstandard4th2h21) + 
      0.5*hInv12*PDstandard4th2h22 + hInv13*(PDstandard4th2h32 - 
      0.5*PDstandard4th3h22);
    
    CCTK_REAL gamma222 CCTK_ATTRIBUTE_UNUSED = 
      hInv12*(-0.5*PDstandard4th1h22 + PDstandard4th2h21) + 
      0.5*hInv22*PDstandard4th2h22 + hInv23*(PDstandard4th2h32 - 
      0.5*PDstandard4th3h22);
    
    CCTK_REAL gamma322 CCTK_ATTRIBUTE_UNUSED = 
      hInv13*(-0.5*PDstandard4th1h22 + PDstandard4th2h21) + 
      0.5*hInv23*PDstandard4th2h22 + hInv33*(PDstandard4th2h32 - 
      0.5*PDstandard4th3h22);
    ...
    CCTK_REAL gamma133 CCTK_ATTRIBUTE_UNUSED = 
      hInv11*(-0.5*PDstandard4th1h33 + PDstandard4th3h31) + 
      hInv12*(-0.5*PDstandard4th2h33 + PDstandard4th3h32) + 
      0.5*hInv13*PDstandard4th3h33;
    
    CCTK_REAL gamma233 CCTK_ATTRIBUTE_UNUSED = 
      hInv12*(-0.5*PDstandard4th1h33 + PDstandard4th3h31) + 
      hInv22*(-0.5*PDstandard4th2h33 + PDstandard4th3h32) + 
      0.5*hInv23*PDstandard4th3h33;
    
    CCTK_REAL gamma333 CCTK_ATTRIBUTE_UNUSED = 
      hInv13*(-0.5*PDstandard4th1h33 + PDstandard4th3h31) + 
      hInv23*(-0.5*PDstandard4th2h33 + PDstandard4th3h32) + 
      0.5*hInv33*PDstandard4th3h33;
    ...
    CCTK_REAL R11 CCTK_ATTRIBUTE_UNUSED = h11L*(Gam1L*gamma111 + 
      Gam2L*gamma121 + Gam3L*gamma131 + PDstandard4th1Gam1) + 
      h21L*(Gam1L*gamma211 + Gam2L*gamma221 + Gam3L*gamma231 + 
      PDstandard4th1Gam2) + h31L*(Gam1L*gamma311 + Gam2L*gamma321 + 
      Gam3L*gamma331 + PDstandard4th1Gam3) + 
      ...
      h31L*(2*gamma131 + gamma333))) - PDstandard4th23h11) + 
      hInv12*(-PDstandard4th12h11 + 2*(gamma121*(3*h11L*gamma111 + 
      ...
      gamma311*(h21L*gamma231 + h31L*gamma331)) - 0.5*PDstandard4th11h11 + 
      ...
      gamma321*(h21L*gamma232 + h31L*gamma332)) - 0.5*PDstandard4th22h11 + 
      ...
      gamma331*(h21L*gamma233 + h31L*gamma333)) - 0.5*PDstandard4th33h11 + 
      h11L*(2*(gamma132*gamma231 + gamma133*gamma331) + 3*pow(gamma131,2)) + 
      h22L*pow(gamma231,2) + h33L*pow(gamma331,2)) + 
      hInv13*(-PDstandard4th13h11 + 2*(h11L*(gamma132*gamma211 + 
    ...
    CCTK_REAL R21 CCTK_ATTRIBUTE_UNUSED = 0.5*(Gam1L*(h11L*gamma121 + 
      ...
      h31L*gamma332) + h22L*PDstandard4th1Gam2 + h32L*PDstandard4th1Gam3 + 
      h11L*PDstandard4th2Gam1 + h21L*(PDstandard4th1Gam1 + 
      PDstandard4th2Gam2) + h31L*PDstandard4th2Gam3) + 
      ...
      h32L*gamma331) - 0.5*PDstandard4th11h21 + h21L*(3*gamma121*gamma211 + 
      ...
      h32L*gamma332) - 0.5*PDstandard4th22h21 + h21L*(3*gamma122*gamma221 + 
      ...
      h32L*gamma333) - 0.5*PDstandard4th33h21 + h21L*(3*gamma132*gamma231 + 
      ...
      PDstandard4th12h21 + 2*(gamma111*(h21L*gamma121 + h11L*gamma122) + 
      ...
      gamma321*(h11L*gamma133 + h21L*gamma233 + h33L*gamma331 + 
      h31L*(gamma131 + gamma333)) - PDstandard4th13h21 + 
      ...
      h33L*gamma332 + h32L*(gamma131 + gamma333)) - PDstandard4th23h21 + 
      h31L*pow(gamma332,2));
    
    CCTK_REAL R31 CCTK_ATTRIBUTE_UNUSED = 0.5*(h32L*(Gam1L*gamma211 + 
      Gam2L*gamma221 + Gam3L*gamma231 + PDstandard4th1Gam2) + 
      h33L*(Gam1L*gamma311 + Gam2L*gamma321 + Gam3L*gamma331 + 
      PDstandard4th1Gam3) + h11L*(Gam1L*gamma131 + Gam2L*gamma132 + 
      Gam3L*gamma133 + PDstandard4th3Gam1) + h21L*(Gam1L*gamma231 + 
      Gam2L*gamma232 + Gam3L*gamma233 + PDstandard4th3Gam2) + 
      h31L*(Gam1L*(gamma111 + gamma331) + Gam2L*(gamma121 + gamma332) + 
      Gam3L*(gamma131 + gamma333) + PDstandard4th1Gam1 + PDstandard4th3Gam3)) 
      ...
      h33L*(gamma121 + 2*gamma332)) - PDstandard4th12h31 + 
      ...
      PDstandard4th23h31 + h21L*(gamma233*(gamma121 + gamma332) + 
      ...
      h32L*(gamma221 + gamma331)) - 0.5*PDstandard4th11h31 + 
      ...
      2*gamma333)) - PDstandard4th13h31 + h22L*(gamma211*gamma233 + 
      ...
      + h33L*gamma322 + h32L*(gamma222 + gamma332)) - 0.5*PDstandard4th22h31 
      ...
      h32L*(gamma232 + gamma333)) - 0.5*PDstandard4th33h31 + 
    ...
    CCTK_REAL R22 CCTK_ATTRIBUTE_UNUSED = 
      ...
      h32L*gamma333)) - PDstandard4th13h22) + h21L*(Gam1L*gamma121 + 
      Gam2L*gamma122 + Gam3L*gamma132 + PDstandard4th2Gam1) + 
      h22L*(Gam1L*gamma221 + Gam2L*gamma222 + Gam3L*gamma232 + 
      PDstandard4th2Gam2) + h32L*(Gam1L*gamma321 + Gam2L*gamma322 + 
      Gam3L*gamma332 + PDstandard4th2Gam3) + hInv12*(-PDstandard4th12h22 + 
      ...
      2*(h21L*gamma131 + h32L*gamma331)) - 0.5*PDstandard4th11h22 + 
      ...
      0.5*PDstandard4th22h22 + h11L*pow(gamma122,2) + 
      ...
      2*(h21L*gamma133 + h32L*gamma333)) - 0.5*PDstandard4th33h22 + 
      h11L*pow(gamma132,2) + h22L*(2*gamma233*gamma332 + 3*pow(gamma232,2)) + 
      h33L*pow(gamma332,2)) + hInv23*(-PDstandard4th23h22 + 
    ...
    CCTK_REAL R32 CCTK_ATTRIBUTE_UNUSED = 0.5*(h31L*(Gam1L*gamma121 + 
      ...
      PDstandard4th2Gam3) + h21L*(Gam1L*gamma131 + Gam2L*gamma132 + 
      Gam3L*gamma133 + PDstandard4th3Gam1) + h22L*(Gam1L*gamma231 + 
      Gam2L*gamma232 + Gam3L*gamma233 + PDstandard4th3Gam2) + 
      h32L*(Gam1L*(gamma221 + gamma331) + Gam2L*(gamma222 + gamma332) + 
      Gam3L*(gamma232 + gamma333) + PDstandard4th2Gam2 + PDstandard4th3Gam3)) 
      ...
      gamma222 + 2*gamma332)) - PDstandard4th12h32 + 
      ...
      + gamma232 + 2*gamma333)) - PDstandard4th13h32 + 
      ...
      0.5*PDstandard4th11h32 + h32L*(gamma131*gamma311 + 3*gamma231*gamma321 
      ...
      gamma222 + gamma332)) - 0.5*PDstandard4th22h32 + 
      ...
      2*gamma333)) - PDstandard4th23h32 + h11L*(gamma122*gamma133 + 
      ...
      gamma232 + gamma333)) - 0.5*PDstandard4th33h32 + 
    ...
    CCTK_REAL R33 CCTK_ATTRIBUTE_UNUSED = 
      ...
      PDstandard4th12h33) + h31L*(Gam1L*gamma131 + Gam2L*gamma132 + 
      Gam3L*gamma133 + PDstandard4th3Gam1) + h32L*(Gam1L*gamma231 + 
      Gam2L*gamma232 + Gam3L*gamma233 + PDstandard4th3Gam2) + 
      h33L*(Gam1L*gamma331 + Gam2L*gamma332 + Gam3L*gamma333 + 
      PDstandard4th3Gam3) + hInv13*(-PDstandard4th13h33 + 
      ...
      pow(gamma131,2)))) + hInv23*(-PDstandard4th23h33 + 
      ...
      h31L*(gamma111 + 2*gamma331))) - 0.5*PDstandard4th11h33 + 
      ...
      0.5*PDstandard4th22h33 + h11L*pow(gamma132,2) + h22L*pow(gamma232,2) + 
      ...
      h31L*(gamma131 + 2*gamma333))) - 0.5*PDstandard4th33h33 + 
    ...
    CCTK_REAL DDphi11 CCTK_ATTRIBUTE_UNUSED = 
      0.25*pow(chiCutoff,-2)*(chiCutoff*(-PDstandard4th11chi + 
      gamma111*PDstandard4th1chi + gamma211*PDstandard4th2chi + 
      gamma311*PDstandard4th3chi) + pow(PDstandard4th1chi,2));
    
    CCTK_REAL DDphi21 CCTK_ATTRIBUTE_UNUSED = 
      0.25*(PDstandard4th1chi*(chiCutoff*gamma121 + PDstandard4th2chi) + 
      chiCutoff*(-PDstandard4th12chi + gamma221*PDstandard4th2chi + 
      gamma321*PDstandard4th3chi))*pow(chiCutoff,-2);
    
    CCTK_REAL DDphi31 CCTK_ATTRIBUTE_UNUSED = 
      0.25*(PDstandard4th1chi*(chiCutoff*gamma131 + PDstandard4th3chi) + 
      chiCutoff*(-PDstandard4th13chi + gamma231*PDstandard4th2chi + 
      gamma331*PDstandard4th3chi))*pow(chiCutoff,-2);
    ...
    CCTK_REAL DDphi22 CCTK_ATTRIBUTE_UNUSED = 
      0.25*pow(chiCutoff,-2)*(chiCutoff*(gamma122*PDstandard4th1chi - 
      PDstandard4th22chi + gamma222*PDstandard4th2chi + 
      gamma322*PDstandard4th3chi) + pow(PDstandard4th2chi,2));
    
    CCTK_REAL DDphi32 CCTK_ATTRIBUTE_UNUSED = 
      0.25*(PDstandard4th2chi*(chiCutoff*gamma232 + PDstandard4th3chi) + 
      chiCutoff*(gamma132*PDstandard4th1chi - PDstandard4th23chi + 
      gamma332*PDstandard4th3chi))*pow(chiCutoff,-2);
    ...
    CCTK_REAL DDphi33 CCTK_ATTRIBUTE_UNUSED = 
      0.25*pow(chiCutoff,-2)*(chiCutoff*(gamma133*PDstandard4th1chi + 
      gamma233*PDstandard4th2chi - PDstandard4th33chi + 
      gamma333*PDstandard4th3chi) + pow(PDstandard4th3chi,2));
    
    CCTK_REAL Dphi1 CCTK_ATTRIBUTE_UNUSED = 
      -0.25*PDstandard4th1chi*pow(chiCutoff,-1);
    
    CCTK_REAL Dphi2 CCTK_ATTRIBUTE_UNUSED = 
      -0.25*PDstandard4th2chi*pow(chiCutoff,-1);
    
    CCTK_REAL Dphi3 CCTK_ATTRIBUTE_UNUSED = 
      -0.25*PDstandard4th3chi*pow(chiCutoff,-1);
    ...
    CCTK_REAL DDalpha11 CCTK_ATTRIBUTE_UNUSED = PDstandard4th11alpha - 
      gamma111*PDstandard4th1alpha - gamma211*PDstandard4th2alpha - 
      gamma311*PDstandard4th3alpha;
    
    CCTK_REAL DDalpha21 CCTK_ATTRIBUTE_UNUSED = PDstandard4th12alpha - 
      gamma121*PDstandard4th1alpha - gamma221*PDstandard4th2alpha - 
      gamma321*PDstandard4th3alpha;
    
    CCTK_REAL DDalpha31 CCTK_ATTRIBUTE_UNUSED = PDstandard4th13alpha - 
      gamma131*PDstandard4th1alpha - gamma231*PDstandard4th2alpha - 
      gamma331*PDstandard4th3alpha;
    
    CCTK_REAL DDalpha12 CCTK_ATTRIBUTE_UNUSED = PDstandard4th12alpha - 
      gamma121*PDstandard4th1alpha - gamma221*PDstandard4th2alpha - 
      gamma321*PDstandard4th3alpha;
    
    CCTK_REAL DDalpha22 CCTK_ATTRIBUTE_UNUSED = 
      -(gamma122*PDstandard4th1alpha) + PDstandard4th22alpha - 
      gamma222*PDstandard4th2alpha - gamma322*PDstandard4th3alpha;
    
    CCTK_REAL DDalpha32 CCTK_ATTRIBUTE_UNUSED = 
      -(gamma132*PDstandard4th1alpha) + PDstandard4th23alpha - 
      gamma232*PDstandard4th2alpha - gamma332*PDstandard4th3alpha;
    
    CCTK_REAL DDalpha13 CCTK_ATTRIBUTE_UNUSED = PDstandard4th13alpha - 
      gamma131*PDstandard4th1alpha - gamma231*PDstandard4th2alpha - 
      gamma331*PDstandard4th3alpha;
    ...
    CCTK_REAL DDalpha33 CCTK_ATTRIBUTE_UNUSED = 
      -(gamma133*PDstandard4th1alpha) - gamma233*PDstandard4th2alpha + 
      PDstandard4th33alpha - gamma333*PDstandard4th3alpha;
    
    CCTK_REAL B11 CCTK_ATTRIBUTE_UNUSED = -DDalpha11 + 
      4*Dphi1*PDstandard4th1alpha + alphaL*(R11 + Rphi11);
    
    CCTK_REAL B12 CCTK_ATTRIBUTE_UNUSED = -DDalpha21 + 
      2*(Dphi2*PDstandard4th1alpha + Dphi1*PDstandard4th2alpha) + alphaL*(R21 
      + Rphi21);
    
    CCTK_REAL B13 CCTK_ATTRIBUTE_UNUSED = -DDalpha31 + 
      2*(Dphi3*PDstandard4th1alpha + Dphi1*PDstandard4th3alpha) + alphaL*(R31 
      + Rphi31);
    ...
    CCTK_REAL B22 CCTK_ATTRIBUTE_UNUSED = -DDalpha22 + 
      4*Dphi2*PDstandard4th2alpha + alphaL*(R22 + Rphi22);
    
    CCTK_REAL B23 CCTK_ATTRIBUTE_UNUSED = -DDalpha32 + 
      2*(Dphi3*PDstandard4th2alpha + Dphi2*PDstandard4th3alpha) + alphaL*(R32 
      + Rphi32);
    ...
    CCTK_REAL B33 CCTK_ATTRIBUTE_UNUSED = -DDalpha33 + 
      4*Dphi3*PDstandard4th3alpha + alphaL*(R33 + Rphi33);
    ...
    CCTK_REAL KrhsL CCTK_ATTRIBUTE_UNUSED = beta1L*PDstandard4th1K + 
      beta2L*PDstandard4th2K + em4phi*(-(hInv11*(DDalpha11 + 
      2*Dphi1*PDstandard4th1alpha)) - hInv12*(DDalpha12 + DDalpha21 + 
      2*Dphi2*PDstandard4th1alpha + 2*Dphi1*PDstandard4th2alpha) - 
      hInv22*(DDalpha22 + 2*Dphi2*PDstandard4th2alpha) - hInv13*(DDalpha13 + 
      DDalpha31 + 2*Dphi3*PDstandard4th1alpha + 2*Dphi1*PDstandard4th3alpha)) 
      + em4phi*(-(hInv23*(DDalpha23 + DDalpha32 + 2*Dphi3*PDstandard4th2alpha 
      + 2*Dphi2*PDstandard4th3alpha)) - hInv33*(DDalpha33 + 
      2*Dphi3*PDstandard4th3alpha)) + beta3L*PDstandard4th3K + 
    ...
    CCTK_REAL A11rhsL CCTK_ATTRIBUTE_UNUSED = beta1L*PDstandard4th1A11 + 
      2*(A11L*PDstandard4th1beta1 + A21L*PDstandard4th1beta2 + 
      A31L*PDstandard4th1beta3) + beta2L*PDstandard4th2A11 + 
      beta3L*PDstandard4th3A11 - 
      0.666666666666666666666666666667*A11L*(PDstandard4th1beta1 + 
      PDstandard4th2beta2 + PDstandard4th3beta3) + em4phi*(B11 - 
    ...
    CCTK_REAL A21rhsL CCTK_ATTRIBUTE_UNUSED = beta1L*PDstandard4th1A21 + 
      A22L*PDstandard4th1beta2 + A32L*PDstandard4th1beta3 + 
      beta2L*PDstandard4th2A21 + A11L*PDstandard4th2beta1 + 
      A31L*PDstandard4th2beta3 + beta3L*PDstandard4th3A21 + A21L*(alphaL*(KL 
      - 2*(A11L*hInv11 + A22L*hInv22)) + 
      0.333333333333333333333333333333*(PDstandard4th1beta1 + 
      PDstandard4th2beta2) - 
      0.666666666666666666666666666667*PDstandard4th3beta3) + em4phi*(B12 - 
    ...
    CCTK_REAL A31rhsL CCTK_ATTRIBUTE_UNUSED = beta1L*PDstandard4th1A31 + 
      A32L*PDstandard4th1beta2 + A33L*PDstandard4th1beta3 + 
      beta2L*PDstandard4th2A31 + beta3L*PDstandard4th3A31 + 
      A11L*PDstandard4th3beta1 + A21L*PDstandard4th3beta2 + A31L*(alphaL*(KL 
      - 2*(A11L*hInv11 + A33L*hInv33)) - 
      0.666666666666666666666666666667*PDstandard4th2beta2 + 
      0.333333333333333333333333333333*(PDstandard4th1beta1 + 
      PDstandard4th3beta3)) + em4phi*(B13 - 
    ...
    CCTK_REAL A22rhsL CCTK_ATTRIBUTE_UNUSED = beta1L*PDstandard4th1A22 + 
      beta2L*PDstandard4th2A22 + 2*(A21L*PDstandard4th2beta1 + 
      A22L*PDstandard4th2beta2 + A32L*PDstandard4th2beta3) + 
      beta3L*PDstandard4th3A22 - 
      0.666666666666666666666666666667*A22L*(PDstandard4th1beta1 + 
      PDstandard4th2beta2 + PDstandard4th3beta3) + em4phi*(B22 - 
    ...
    CCTK_REAL A32rhsL CCTK_ATTRIBUTE_UNUSED = beta1L*PDstandard4th1A32 + 
      beta2L*PDstandard4th2A32 + A31L*PDstandard4th2beta1 + 
      A33L*PDstandard4th2beta3 + beta3L*PDstandard4th3A32 + 
      A21L*PDstandard4th3beta1 + A22L*PDstandard4th3beta2 + 
      A32L*(-0.666666666666666666666666666667*PDstandard4th1beta1 + 
      0.333333333333333333333333333333*(PDstandard4th2beta2 + 
      PDstandard4th3beta3)) + em4phi*(B23 - 
    ...
    CCTK_REAL A33rhsL CCTK_ATTRIBUTE_UNUSED = beta1L*PDstandard4th1A33 + 
      beta2L*PDstandard4th2A33 + beta3L*PDstandard4th3A33 - 
      0.666666666666666666666666666667*A33L*(PDstandard4th1beta1 + 
      PDstandard4th2beta2 + PDstandard4th3beta3) + 
      2*(A31L*PDstandard4th3beta1 + A32L*PDstandard4th3beta2 + 
      A33L*PDstandard4th3beta3) + em4phi*(B33 - 
    ...
    CCTK_REAL Gam1rhsL CCTK_ATTRIBUTE_UNUSED = alphaL*(12*(AInv11*Dphi1 + 
      ...
      2*AInv33*gamma133) + beta1L*PDstandard4th1Gam1 - 
      Gam2L*PDstandard4th2beta1 + beta2L*PDstandard4th2Gam1 - 
      2*(AInv11*PDstandard4th1alpha + AInv12*PDstandard4th2alpha + 
      AInv13*PDstandard4th3alpha) - Gam3L*PDstandard4th3beta1 - 
      1.33333333333333333333333333333*Gam1L*addYoTerm*(PDstandard4th1beta1 + 
      PDstandard4th2beta2 + PDstandard4th3beta3) + 
      Gam1L*(-PDstandard4th1beta1 + 
      0.666666666666666666666666666667*(PDstandard4th1beta1 + 
      PDstandard4th2beta2 + PDstandard4th3beta3)) + 
      0.333333333333333333333333333333*hInv11*(4*PDstandard4th11beta1 + 
      PDstandard4th12beta2 + PDstandard4th13beta3 - 4*alphaL*PDstandard4th1K 
      + 4*addYoTerm*gamma111*(PDstandard4th1beta1 + PDstandard4th2beta2 + 
      PDstandard4th3beta3)) + 
      0.333333333333333333333333333333*hInv12*(7*PDstandard4th12beta1 + 
      PDstandard4th22beta2 + PDstandard4th23beta3 - 4*alphaL*PDstandard4th2K 
      + 8*addYoTerm*gamma121*(PDstandard4th1beta1 + PDstandard4th2beta2 + 
      PDstandard4th3beta3)) + hInv22*(PDstandard4th22beta1 + 
      1.33333333333333333333333333333*addYoTerm*gamma122*(PDstandard4th1beta1 
      + PDstandard4th2beta2 + PDstandard4th3beta3)) + 
      hInv23*(2*PDstandard4th23beta1 + 
      2.66666666666666666666666666667*addYoTerm*gamma132*(PDstandard4th1beta1 
      + PDstandard4th2beta2 + PDstandard4th3beta3)) + 
      hInv33*(PDstandard4th33beta1 + 
      1.33333333333333333333333333333*addYoTerm*gamma133*(PDstandard4th1beta1 
      + PDstandard4th2beta2 + PDstandard4th3beta3)) + 
      beta3L*PDstandard4th3Gam1 + 
      0.333333333333333333333333333333*hInv13*(7*PDstandard4th13beta1 + 
      PDstandard4th23beta2 + PDstandard4th33beta3 + 
      8*addYoTerm*gamma131*(PDstandard4th1beta1 + PDstandard4th2beta2 + 
      PDstandard4th3beta3) - 4*alphaL*PDstandard4th3K);
    ...
    CCTK_REAL Gam2rhsL CCTK_ATTRIBUTE_UNUSED = alphaL*(12*(AInv12*Dphi1 + 
      ...
      2*AInv33*gamma233) - Gam1L*PDstandard4th1beta2 + 
      beta1L*PDstandard4th1Gam2 + beta2L*PDstandard4th2Gam2 - 
      2*(AInv12*PDstandard4th1alpha + AInv22*PDstandard4th2alpha + 
      AInv23*PDstandard4th3alpha) - Gam3L*PDstandard4th3beta2 - 
      1.33333333333333333333333333333*Gam2L*addYoTerm*(PDstandard4th1beta1 + 
      PDstandard4th2beta2 + PDstandard4th3beta3) + 
      Gam2L*(-PDstandard4th2beta2 + 
      0.666666666666666666666666666667*(PDstandard4th1beta1 + 
      PDstandard4th2beta2 + PDstandard4th3beta3)) + 
      hInv11*(PDstandard4th11beta2 + 
      1.33333333333333333333333333333*addYoTerm*gamma211*(PDstandard4th1beta1 
      + PDstandard4th2beta2 + PDstandard4th3beta3)) + 
      0.333333333333333333333333333333*hInv12*(PDstandard4th11beta1 + 
      7*PDstandard4th12beta2 + PDstandard4th13beta3 - 
      4*alphaL*PDstandard4th1K + 8*addYoTerm*gamma221*(PDstandard4th1beta1 + 
      PDstandard4th2beta2 + PDstandard4th3beta3)) + 
      0.333333333333333333333333333333*hInv22*(PDstandard4th12beta1 + 
      4*PDstandard4th22beta2 + PDstandard4th23beta3 - 
      4*alphaL*PDstandard4th2K + 4*addYoTerm*gamma222*(PDstandard4th1beta1 + 
      PDstandard4th2beta2 + PDstandard4th3beta3)) + 
      hInv13*(2*PDstandard4th13beta2 + 
      2.66666666666666666666666666667*addYoTerm*gamma231*(PDstandard4th1beta1 
      + PDstandard4th2beta2 + PDstandard4th3beta3)) + 
      hInv33*(PDstandard4th33beta2 + 
      1.33333333333333333333333333333*addYoTerm*gamma233*(PDstandard4th1beta1 
      + PDstandard4th2beta2 + PDstandard4th3beta3)) + 
      beta3L*PDstandard4th3Gam2 + 
      0.333333333333333333333333333333*hInv23*(PDstandard4th13beta1 + 
      7*PDstandard4th23beta2 + PDstandard4th33beta3 + 
      8*addYoTerm*gamma232*(PDstandard4th1beta1 + PDstandard4th2beta2 + 
      PDstandard4th3beta3) - 4*alphaL*PDstandard4th3K);
    ...
    CCTK_REAL Gam3rhsL CCTK_ATTRIBUTE_UNUSED = alphaL*(12*(AInv13*Dphi1 + 
      ...
      2*AInv33*gamma333) - Gam1L*PDstandard4th1beta3 + 
      beta1L*PDstandard4th1Gam3 - Gam2L*PDstandard4th2beta3 + 
      beta2L*PDstandard4th2Gam3 - 2*(AInv13*PDstandard4th1alpha + 
      AInv23*PDstandard4th2alpha + AInv33*PDstandard4th3alpha) - 
      1.33333333333333333333333333333*Gam3L*addYoTerm*(PDstandard4th1beta1 + 
      PDstandard4th2beta2 + PDstandard4th3beta3) + 
      Gam3L*(-PDstandard4th3beta3 + 
      0.666666666666666666666666666667*(PDstandard4th1beta1 + 
      PDstandard4th2beta2 + PDstandard4th3beta3)) + 
      hInv11*(PDstandard4th11beta3 + 
      1.33333333333333333333333333333*addYoTerm*gamma311*(PDstandard4th1beta1 
      + PDstandard4th2beta2 + PDstandard4th3beta3)) + 
      hInv12*(2*PDstandard4th12beta3 + 
      2.66666666666666666666666666667*addYoTerm*gamma321*(PDstandard4th1beta1 
      + PDstandard4th2beta2 + PDstandard4th3beta3)) + 
      hInv22*(PDstandard4th22beta3 + 
      1.33333333333333333333333333333*addYoTerm*gamma322*(PDstandard4th1beta1 
      + PDstandard4th2beta2 + PDstandard4th3beta3)) + 
      0.333333333333333333333333333333*hInv13*(PDstandard4th11beta1 + 
      PDstandard4th12beta2 + 7*PDstandard4th13beta3 - 
      4*alphaL*PDstandard4th1K + 8*addYoTerm*gamma331*(PDstandard4th1beta1 + 
      PDstandard4th2beta2 + PDstandard4th3beta3)) + 
      0.333333333333333333333333333333*hInv23*(PDstandard4th12beta1 + 
      PDstandard4th22beta2 + 7*PDstandard4th23beta3 - 
      4*alphaL*PDstandard4th2K + 8*addYoTerm*gamma332*(PDstandard4th1beta1 + 
      PDstandard4th2beta2 + PDstandard4th3beta3)) + beta3L*PDstandard4th3Gam3 
      + 0.333333333333333333333333333333*hInv33*(PDstandard4th13beta1 + 
      PDstandard4th23beta2 + 4*PDstandard4th33beta3 + 
      4*addYoTerm*gamma333*(PDstandard4th1beta1 + PDstandard4th2beta2 + 
      PDstandard4th3beta3) - 4*alphaL*PDstandard4th3K);
    /* Copy local copies back to grid functions */
  ...
  CCTK_ENDLOOP3(bssnchi_evolve_nonmetric_4thcentred);
}
extern "C" void bssnchi_evolve_nonmetric_4thcentred(CCTK_ARGUMENTS)
{
  DECLARE_CCTK_ARGUMENTS;
  DECLARE_CCTK_PARAMETERS;
  ...
  if (verbose > 1)
  {
    CCTK_VInfo(CCTK_THORNSTRING,"Entering bssnchi_evolve_nonmetric_4thcentred_Body");
  }
  if (cctk_iteration % bssnchi_evolve_nonmetric_4thcentred_calc_every != bssnchi_evolve_nonmetric_4thcentred_calc_offset)
  {
    return;
  ...
  const char* const groups[] = {
    ...
    "Kranc2BSSNChi::A_grouprhs",
    "Kranc2BSSNChi::alpha_group",
    "Kranc2BSSNChi::beta_group",
    "Kranc2BSSNChi::chi_group",
    "Kranc2BSSNChi::Gam_group",
    "Kranc2BSSNChi::Gam_grouprhs",
    "Kranc2BSSNChi::h_group",
    "Kranc2BSSNChi::K_group",
    "Kranc2BSSNChi::K_grouprhs",
    "Kranc2BSSNChi::scalarconstraints"};
  AssertGroupStorage(cctkGH, "bssnchi_evolve_nonmetric_4thcentred", 11, groups);
  
  switch (constraintsfdorder)
  {
    case 2:
    {
      EnsureStencilFits(cctkGH, "bssnchi_evolve_nonmetric_4thcentred", 2, 2, 2);
      break;
    }
  ...
  LoopOverInterior(cctkGH, bssnchi_evolve_nonmetric_4thcentred_Body);
  if (verbose > 1)
  {
    CCTK_VInfo(CCTK_THORNSTRING,"Leaving bssnchi_evolve_nonmetric_4thcentred_Body");
  }
}
