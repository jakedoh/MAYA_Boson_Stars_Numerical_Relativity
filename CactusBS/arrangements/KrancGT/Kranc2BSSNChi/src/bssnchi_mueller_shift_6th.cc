...
extern "C" void bssnchi_mueller_shift_6th_SelectBCs(CCTK_ARGUMENTS)
{
  DECLARE_CCTK_ARGUMENTS;
  DECLARE_CCTK_PARAMETERS;
  
  if (cctk_iteration % bssnchi_mueller_shift_6th_calc_every != bssnchi_mueller_shift_6th_calc_offset)
    return;
...
static void bssnchi_mueller_shift_6th_Body(const cGH* restrict const cctkGH, const int dir, const int face, const CCTK_REAL normal[3], const CCTK_REAL tangentA[3], const CCTK_REAL tangentB[3], const int imin[3], const int imax[3], const int n_subblock_gfs, CCTK_REAL* restrict const subblock_gfs[])
{
  DECLARE_CCTK_ARGUMENTS;
  DECLARE_CCTK_PARAMETERS;
  ...
  #pragma omp parallel
  CCTK_LOOP3(bssnchi_mueller_shift_6th,
    ...
    cctk_ash[0],cctk_ash[1],cctk_ash[2])
  {
    ...
    CCTK_REAL muellerTop CCTK_ATTRIBUTE_UNUSED = 
      2*(PDlopsided6th1(&chi[index])*(PDlopsided6th2(&chi[index])*hInv12 + 
      PDlopsided6th3(&chi[index])*hInv13) + 
      PDlopsided6th2(&chi[index])*PDlopsided6th3(&chi[index])*hInv23) + 
      hInv11*pow(PDlopsided6th1(&chi[index]),2) + 
      hInv22*pow(PDlopsided6th2(&chi[index]),2) + 
      hInv33*pow(PDlopsided6th3(&chi[index]),2);
    ...
    CCTK_REAL beta1rhsL CCTK_ATTRIBUTE_UNUSED = 
      (beta1L*PDlopsided6th1(&beta1[index]) + 
      beta2L*PDlopsided6th2(&beta1[index]) + 
      beta3L*PDlopsided6th3(&beta1[index]))*newNASAAdvection + 
      betat1L*betaDotAlphaFactor*pow(alphaL,gammaDriverLambda);
    
    CCTK_REAL beta2rhsL CCTK_ATTRIBUTE_UNUSED = 
      (beta1L*PDlopsided6th1(&beta2[index]) + 
      beta2L*PDlopsided6th2(&beta2[index]) + 
      beta3L*PDlopsided6th3(&beta2[index]))*newNASAAdvection + 
      betat2L*betaDotAlphaFactor*pow(alphaL,gammaDriverLambda);
    
    CCTK_REAL beta3rhsL CCTK_ATTRIBUTE_UNUSED = 
      (beta1L*PDlopsided6th1(&beta3[index]) + 
      beta2L*PDlopsided6th2(&beta3[index]) + 
      beta3L*PDlopsided6th3(&beta3[index]))*newNASAAdvection + 
      betat3L*betaDotAlphaFactor*pow(alphaL,gammaDriverLambda);
    
    CCTK_REAL betat1rhsL CCTK_ATTRIBUTE_UNUSED = 
      (beta1L*PDlopsided6th1(&betat1[index]) + 
      beta2L*PDlopsided6th2(&betat1[index]) + 
      beta3L*PDlopsided6th3(&betat1[index]))*betatAdvection - betat1L*mueller 
      - (beta1L*PDlopsided6th1(&Gam1[index]) + 
      beta2L*PDlopsided6th2(&Gam1[index]) + 
      beta3L*PDlopsided6th3(&Gam1[index]))*NASAAdvection + 
      Gam1rhsL*chiBeta*pow(alphaL,gammaDriverLapsePower);
    
    CCTK_REAL betat2rhsL CCTK_ATTRIBUTE_UNUSED = 
      (beta1L*PDlopsided6th1(&betat2[index]) + 
      beta2L*PDlopsided6th2(&betat2[index]) + 
      beta3L*PDlopsided6th3(&betat2[index]))*betatAdvection - betat2L*mueller 
      - (beta1L*PDlopsided6th1(&Gam2[index]) + 
      beta2L*PDlopsided6th2(&Gam2[index]) + 
      beta3L*PDlopsided6th3(&Gam2[index]))*NASAAdvection + 
      Gam2rhsL*chiBeta*pow(alphaL,gammaDriverLapsePower);
    
    CCTK_REAL betat3rhsL CCTK_ATTRIBUTE_UNUSED = 
      (beta1L*PDlopsided6th1(&betat3[index]) + 
      beta2L*PDlopsided6th2(&betat3[index]) + 
      beta3L*PDlopsided6th3(&betat3[index]))*betatAdvection - betat3L*mueller 
      - (beta1L*PDlopsided6th1(&Gam3[index]) + 
      beta2L*PDlopsided6th2(&Gam3[index]) + 
      beta3L*PDlopsided6th3(&Gam3[index]))*NASAAdvection + 
  ...
  CCTK_ENDLOOP3(bssnchi_mueller_shift_6th);
}
extern "C" void bssnchi_mueller_shift_6th(CCTK_ARGUMENTS)
{
  DECLARE_CCTK_ARGUMENTS;
  DECLARE_CCTK_PARAMETERS;
  ...
  if (verbose > 1)
  {
    CCTK_VInfo(CCTK_THORNSTRING,"Entering bssnchi_mueller_shift_6th_Body");
  }
  if (cctk_iteration % bssnchi_mueller_shift_6th_calc_every != bssnchi_mueller_shift_6th_calc_offset)
  {
    return;
  ...
  AssertGroupStorage(cctkGH, "bssnchi_mueller_shift_6th", 9, groups);
  
  switch (constraintsfdorder)
  {
    case 2:
    {
      EnsureStencilFits(cctkGH, "bssnchi_mueller_shift_6th", 4, 4, 4);
      break;
    }
  ...
  LoopOverInterior(cctkGH, bssnchi_mueller_shift_6th_Body);
  if (verbose > 1)
  {
    CCTK_VInfo(CCTK_THORNSTRING,"Leaving bssnchi_mueller_shift_6th_Body");
  }
}
