...
extern "C" void bssnchi_nasa_shift_full4th_SelectBCs(CCTK_ARGUMENTS)
{
  DECLARE_CCTK_ARGUMENTS;
  DECLARE_CCTK_PARAMETERS;
  
  if (cctk_iteration % bssnchi_nasa_shift_full4th_calc_every != bssnchi_nasa_shift_full4th_calc_offset)
    return;
...
static void bssnchi_nasa_shift_full4th_Body(const cGH* restrict const cctkGH, const int dir, const int face, const CCTK_REAL normal[3], const CCTK_REAL tangentA[3], const CCTK_REAL tangentB[3], const int imin[3], const int imax[3], const int n_subblock_gfs, CCTK_REAL* restrict const subblock_gfs[])
{
  DECLARE_CCTK_ARGUMENTS;
  DECLARE_CCTK_PARAMETERS;
  ...
  #pragma omp parallel
  CCTK_LOOP3(bssnchi_nasa_shift_full4th,
    ...
    cctk_ash[0],cctk_ash[1],cctk_ash[2])
  {
    ...
    CCTK_REAL betat1rhsL CCTK_ATTRIBUTE_UNUSED = 
      ...
      beta3L*PDlopsided4th3(&betat1[index]))*betatAdvection - betat1L*etaBeta 
    ...
    CCTK_REAL betat2rhsL CCTK_ATTRIBUTE_UNUSED = 
      ...
      beta3L*PDlopsided4th3(&betat2[index]))*betatAdvection - betat2L*etaBeta 
    ...
    CCTK_REAL betat3rhsL CCTK_ATTRIBUTE_UNUSED = 
      ...
      beta3L*PDlopsided4th3(&betat3[index]))*betatAdvection - betat3L*etaBeta 
  ...
  CCTK_ENDLOOP3(bssnchi_nasa_shift_full4th);
}
extern "C" void bssnchi_nasa_shift_full4th(CCTK_ARGUMENTS)
{
  DECLARE_CCTK_ARGUMENTS;
  DECLARE_CCTK_PARAMETERS;
  ...
  if (verbose > 1)
  {
    CCTK_VInfo(CCTK_THORNSTRING,"Entering bssnchi_nasa_shift_full4th_Body");
  }
  if (cctk_iteration % bssnchi_nasa_shift_full4th_calc_every != bssnchi_nasa_shift_full4th_calc_offset)
  {
    return;
  ...
  AssertGroupStorage(cctkGH, "bssnchi_nasa_shift_full4th", 7, groups);
  
  switch (constraintsfdorder)
  {
    case 2:
    {
      EnsureStencilFits(cctkGH, "bssnchi_nasa_shift_full4th", 3, 3, 3);
      break;
    }
  ...
  LoopOverInterior(cctkGH, bssnchi_nasa_shift_full4th_Body);
  if (verbose > 1)
  {
    CCTK_VInfo(CCTK_THORNSTRING,"Leaving bssnchi_nasa_shift_full4th_Body");
  }
}
