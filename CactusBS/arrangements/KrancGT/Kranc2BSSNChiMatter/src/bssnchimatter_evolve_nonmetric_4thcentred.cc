...
extern "C" void bssnchimatter_evolve_nonmetric_4thcentred_SelectBCs(CCTK_ARGUMENTS)
{
  ...
  if (ierr < 0)
    CCTK_WARN(1, "Failed to register flat BC for Kranc2BSSNChiMatter::A_grouprhs.");
  ...
  if (ierr < 0)
    CCTK_WARN(1, "Failed to register flat BC for Kranc2BSSNChiMatter::Gam_grouprhs.");
  ...
  if (ierr < 0)
    CCTK_WARN(1, "Failed to register flat BC for Kranc2BSSNChiMatter::K_grouprhs.");
