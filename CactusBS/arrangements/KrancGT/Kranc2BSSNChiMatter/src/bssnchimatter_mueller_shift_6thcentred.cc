...
extern "C" void bssnchimatter_mueller_shift_6thcentred_SelectBCs(CCTK_ARGUMENTS)
{
  ...
  if (ierr < 0)
    CCTK_WARN(1, "Failed to register flat BC for Kranc2BSSNChiMatter::beta_grouprhs.");
  ...
  if (ierr < 0)
    CCTK_WARN(1, "Failed to register flat BC for Kranc2BSSNChiMatter::betat_grouprhs.");
  return;
}
...
extern "C" void bssnchimatter_mueller_shift_6thcentred(CCTK_ARGUMENTS)
{
  ...
  AssertGroupStorage(cctkGH, "bssnchimatter_mueller_shift_6thcentred", 9, groups);
