...
{
  #ifdef DECLARE_CCTK_ARGUMENTS_bssnchimatter_boundary_SelectBCs
  DECLARE_CCTK_ARGUMENTS_CHECKED(bssnchimatter_boundary_SelectBCs);
  #else
...
{
  #ifdef DECLARE_CCTK_ARGUMENTS_bssnchimatter_boundary
  DECLARE_CCTK_ARGUMENTS_CHECKED(bssnchimatter_boundary);
  #else
  DECLARE_CCTK_ARGUMENTS;
  #endif
  DECLARE_CCTK_PARAMETERS;
