...
{
  #ifdef DECLARE_CCTK_ARGUMENTS_bssnchimatter_calc_constraints_matter_SelectBCs
  DECLARE_CCTK_ARGUMENTS_CHECKED(bssnchimatter_calc_constraints_matter_SelectBCs);
  #else
...
{
  #ifdef DECLARE_CCTK_ARGUMENTS_bssnchimatter_calc_constraints_matter
  DECLARE_CCTK_ARGUMENTS_CHECKED(bssnchimatter_calc_constraints_matter);
  #else
  DECLARE_CCTK_ARGUMENTS;
  #endif
  DECLARE_CCTK_PARAMETERS;
