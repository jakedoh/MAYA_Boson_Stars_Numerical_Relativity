...
{
  #ifdef DECLARE_CCTK_ARGUMENTS_bssnchimatter_external_shift_2nd_SelectBCs
  DECLARE_CCTK_ARGUMENTS_CHECKED(bssnchimatter_external_shift_2nd_SelectBCs);
  #else
...
{
  #ifdef DECLARE_CCTK_ARGUMENTS_bssnchimatter_external_shift_2nd
  DECLARE_CCTK_ARGUMENTS_CHECKED(bssnchimatter_external_shift_2nd);
  #else
  DECLARE_CCTK_ARGUMENTS;
  #endif
  DECLARE_CCTK_PARAMETERS;
