...
{
  #ifdef DECLARE_CCTK_ARGUMENTS_bssnchimatter_external_shift_6thcentred_SelectBCs
  DECLARE_CCTK_ARGUMENTS_CHECKED(bssnchimatter_external_shift_6thcentred_SelectBCs);
  #else
...
{
  #ifdef DECLARE_CCTK_ARGUMENTS_bssnchimatter_external_shift_6thcentred
  DECLARE_CCTK_ARGUMENTS_CHECKED(bssnchimatter_external_shift_6thcentred);
  #else
  DECLARE_CCTK_ARGUMENTS;
  #endif
  DECLARE_CCTK_PARAMETERS;
