...
{
  #ifdef DECLARE_CCTK_ARGUMENTS_bssnchimatter_nasa_shift_4thcentred_SelectBCs
  DECLARE_CCTK_ARGUMENTS_CHECKED(bssnchimatter_nasa_shift_4thcentred_SelectBCs);
  #else
...
{
  #ifdef DECLARE_CCTK_ARGUMENTS_bssnchimatter_nasa_shift_4thcentred
  DECLARE_CCTK_ARGUMENTS_CHECKED(bssnchimatter_nasa_shift_4thcentred);
  #else
  DECLARE_CCTK_ARGUMENTS;
  #endif
  DECLARE_CCTK_PARAMETERS;
  ...
  AssertGroupStorage(cctkGH, "bssnchimatter_nasa_shift_4thcentred", 8, groups);
