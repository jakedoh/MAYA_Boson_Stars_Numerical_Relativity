...
static void bssnchimatter_nullify_GREvol_Body(const cGH* restrict const cctkGH, const int dir, const int face, const CCTK_REAL normal[3], const CCTK_REAL tangentA[3], const CCTK_REAL tangentB[3], const int imin[3], const int imax[3], const int n_subblock_gfs, CCTK_REAL* restrict const subblock_gfs[])
{
  ...
  #pragma omp parallel
  CCTK_LOOP3(bssnchimatter_nullify_GREvol,
    ...
    cctk_ash[0],cctk_ash[1],cctk_ash[2])
  {
    ...
    CCTK_REAL h11rhsL CCTK_ATTRIBUTE_UNUSED = 0;
    
    CCTK_REAL h21rhsL CCTK_ATTRIBUTE_UNUSED = 0;
    
    CCTK_REAL h31rhsL CCTK_ATTRIBUTE_UNUSED = 0;
    
    CCTK_REAL h22rhsL CCTK_ATTRIBUTE_UNUSED = 0;
    
    CCTK_REAL h32rhsL CCTK_ATTRIBUTE_UNUSED = 0;
    
    CCTK_REAL h33rhsL CCTK_ATTRIBUTE_UNUSED = 0;
    
    CCTK_REAL chirhsL CCTK_ATTRIBUTE_UNUSED = 0;
    
    CCTK_REAL KrhsL CCTK_ATTRIBUTE_UNUSED = 0;
    
    CCTK_REAL A11rhsL CCTK_ATTRIBUTE_UNUSED = 0;
    
    CCTK_REAL A21rhsL CCTK_ATTRIBUTE_UNUSED = 0;
    
    CCTK_REAL A31rhsL CCTK_ATTRIBUTE_UNUSED = 0;
    
    CCTK_REAL A22rhsL CCTK_ATTRIBUTE_UNUSED = 0;
    
    CCTK_REAL A32rhsL CCTK_ATTRIBUTE_UNUSED = 0;
    
    CCTK_REAL A33rhsL CCTK_ATTRIBUTE_UNUSED = 0;
    ...
    CCTK_REAL betat1rhsL CCTK_ATTRIBUTE_UNUSED = 0;
    
    CCTK_REAL betat2rhsL CCTK_ATTRIBUTE_UNUSED = 0;
    
    CCTK_REAL betat3rhsL CCTK_ATTRIBUTE_UNUSED = 0;
    /* Copy local copies back to grid functions */
  ...
  CCTK_ENDLOOP3(bssnchimatter_nullify_GREvol);
}
extern "C" void bssnchimatter_nullify_GREvol(CCTK_ARGUMENTS)
{
  #ifdef DECLARE_CCTK_ARGUMENTS_bssnchimatter_nullify_GREvol
  DECLARE_CCTK_ARGUMENTS_CHECKED(bssnchimatter_nullify_GREvol);
  #else
  DECLARE_CCTK_ARGUMENTS;
  #endif
  DECLARE_CCTK_PARAMETERS;
  
  if (!(delayGREvolutiontoItn > 0 && (cctk_iteration-1) < delayGREvolutiontoItn))
  {
    return;
  }
  if (verbose > 1)
  {
    CCTK_VInfo(CCTK_THORNSTRING,"Entering bssnchimatter_nullify_GREvol_Body");
  }
  if (cctk_iteration % bssnchimatter_nullify_GREvol_calc_every != bssnchimatter_nullify_GREvol_calc_offset)
  {
    return;
  }
  ...
  AssertGroupStorage(cctkGH, "bssnchimatter_nullify_GREvol", 8, groups);
  ...
  LoopOverEverything(cctkGH, bssnchimatter_nullify_GREvol_Body);
  if (verbose > 1)
  {
    CCTK_VInfo(CCTK_THORNSTRING,"Leaving bssnchimatter_nullify_GREvol_Body");
  }
}
