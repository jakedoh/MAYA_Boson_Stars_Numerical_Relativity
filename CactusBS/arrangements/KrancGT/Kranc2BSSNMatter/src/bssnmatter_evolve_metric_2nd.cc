...
extern "C" void bssnmatter_evolve_metric_2nd_SelectBCs(CCTK_ARGUMENTS)
{
  DECLARE_CCTK_ARGUMENTS;
  DECLARE_CCTK_PARAMETERS;
  
  if (cctk_iteration % bssnmatter_evolve_metric_2nd_calc_every != bssnmatter_evolve_metric_2nd_calc_offset)
    return;
...
static void bssnmatter_evolve_metric_2nd_Body(const cGH* restrict const cctkGH, const int dir, const int face, const CCTK_REAL normal[3], const CCTK_REAL tangentA[3], const CCTK_REAL tangentB[3], const int imin[3], const int imax[3], const int n_subblock_gfs, CCTK_REAL* restrict const subblock_gfs[])
{
  DECLARE_CCTK_ARGUMENTS;
  DECLARE_CCTK_PARAMETERS;
  ...
  #pragma omp parallel
  CCTK_LOOP3(bssnmatter_evolve_metric_2nd,
    ...
    cctk_ash[0],cctk_ash[1],cctk_ash[2])
  {
    ...
    CCTK_REAL phirhsL CCTK_ATTRIBUTE_UNUSED = 
      ...
      6*(beta1L*PDonesided2nd1(&phi[index]) + 
      beta2L*PDonesided2nd2(&phi[index]) + 
      beta3L*PDonesided2nd3(&phi[index])) + PDstandard2nd1beta1 + 
  ...
  CCTK_ENDLOOP3(bssnmatter_evolve_metric_2nd);
}
extern "C" void bssnmatter_evolve_metric_2nd(CCTK_ARGUMENTS)
{
  DECLARE_CCTK_ARGUMENTS;
  DECLARE_CCTK_PARAMETERS;
  ...
  if (verbose > 1)
  {
    CCTK_VInfo(CCTK_THORNSTRING,"Entering bssnmatter_evolve_metric_2nd_Body");
  }
  if (cctk_iteration % bssnmatter_evolve_metric_2nd_calc_every != bssnmatter_evolve_metric_2nd_calc_offset)
  {
    return;
  ...
  AssertGroupStorage(cctkGH, "bssnmatter_evolve_metric_2nd", 8, groups);
  
  switch (constraintsfdorder)
  {
    case 2:
    {
      EnsureStencilFits(cctkGH, "bssnmatter_evolve_metric_2nd", 2, 2, 2);
      break;
    }
  ...
  LoopOverInterior(cctkGH, bssnmatter_evolve_metric_2nd_Body);
  if (verbose > 1)
  {
    CCTK_VInfo(CCTK_THORNSTRING,"Leaving bssnmatter_evolve_metric_2nd_Body");
  }
}
