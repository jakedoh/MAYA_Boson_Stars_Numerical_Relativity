...
extern "C" void bssnmatter_evolve_metric_4thcentred_SelectBCs(CCTK_ARGUMENTS)
{
  DECLARE_CCTK_ARGUMENTS;
  DECLARE_CCTK_PARAMETERS;
  
  if (cctk_iteration % bssnmatter_evolve_metric_4thcentred_calc_every != bssnmatter_evolve_metric_4thcentred_calc_offset)
    return;
  ...
  if (ierr < 0)
    CCTK_WARN(1, "Failed to register flat BC for Kranc2BSSNMatter::h_grouprhs.");
  ...
  if (ierr < 0)
    CCTK_WARN(1, "Failed to register flat BC for Kranc2BSSNMatter::phi_grouprhs.");
  return;
}

static void bssnmatter_evolve_metric_4thcentred_Body(const cGH* restrict const cctkGH, const int dir, const int face, const CCTK_REAL normal[3], const CCTK_REAL tangentA[3], const CCTK_REAL tangentB[3], const int imin[3], const int imax[3], const int n_subblock_gfs, CCTK_REAL* restrict const subblock_gfs[])
{
  DECLARE_CCTK_ARGUMENTS;
  DECLARE_CCTK_PARAMETERS;
  ...
  #pragma omp parallel
  CCTK_LOOP3(bssnmatter_evolve_metric_4thcentred,
    ...
    cctk_ash[0],cctk_ash[1],cctk_ash[2])
  {
    ...
    CCTK_REAL phirhsL CCTK_ATTRIBUTE_UNUSED = 
      0.166666666666666666666666666667*(-(alphaL*KL) + PDstandard4th1beta1 + 
      PDstandard4th2beta2 + PDstandard4th3beta3 + 6*(beta1L*PDstandard4th1phi 
      + beta2L*PDstandard4th2phi + beta3L*PDstandard4th3phi));
  ...
  CCTK_ENDLOOP3(bssnmatter_evolve_metric_4thcentred);
}
extern "C" void bssnmatter_evolve_metric_4thcentred(CCTK_ARGUMENTS)
{
  DECLARE_CCTK_ARGUMENTS;
  DECLARE_CCTK_PARAMETERS;
  ...
  if (verbose > 1)
  {
    CCTK_VInfo(CCTK_THORNSTRING,"Entering bssnmatter_evolve_metric_4thcentred_Body");
  }
  if (cctk_iteration % bssnmatter_evolve_metric_4thcentred_calc_every != bssnmatter_evolve_metric_4thcentred_calc_offset)
  {
    return;
  ...
  AssertGroupStorage(cctkGH, "bssnmatter_evolve_metric_4thcentred", 8, groups);
  
  switch (constraintsfdorder)
  {
    case 2:
    {
      EnsureStencilFits(cctkGH, "bssnmatter_evolve_metric_4thcentred", 2, 2, 2);
      break;
    }
  ...
  LoopOverInterior(cctkGH, bssnmatter_evolve_metric_4thcentred_Body);
  if (verbose > 1)
  {
    CCTK_VInfo(CCTK_THORNSTRING,"Leaving bssnmatter_evolve_metric_4thcentred_Body");
  }
}
