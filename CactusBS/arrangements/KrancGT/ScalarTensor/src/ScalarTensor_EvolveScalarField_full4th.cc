...
extern "C" void ScalarTensor_EvolveScalarField_full4th_SelectBCs(CCTK_ARGUMENTS)
{
  DECLARE_CCTK_ARGUMENTS;
  DECLARE_CCTK_PARAMETERS;
  
  if (cctk_iteration % ScalarTensor_EvolveScalarField_full4th_calc_every != ScalarTensor_EvolveScalarField_full4th_calc_offset)
    return;
...
static void ScalarTensor_EvolveScalarField_full4th_Body(const cGH* restrict const cctkGH, const int dir, const int face, const CCTK_REAL normal[3], const CCTK_REAL tangentA[3], const CCTK_REAL tangentB[3], const int imin[3], const int imax[3], const int n_subblock_gfs, CCTK_REAL* restrict const subblock_gfs[])
{
  DECLARE_CCTK_ARGUMENTS;
  DECLARE_CCTK_PARAMETERS;
  ...
  #pragma omp parallel
  CCTK_LOOP3(ScalarTensor_EvolveScalarField_full4th,
    ...
    cctk_ash[0],cctk_ash[1],cctk_ash[2])
  {
    ...
    const CCTK_REAL PDstandard4th11STphi CCTK_ATTRIBUTE_UNUSED = PDstandard4th11(&STphi[index]);
    const CCTK_REAL PDstandard4th22STphi CCTK_ATTRIBUTE_UNUSED = PDstandard4th22(&STphi[index]);
    const CCTK_REAL PDstandard4th33STphi CCTK_ATTRIBUTE_UNUSED = PDstandard4th33(&STphi[index]);
    const CCTK_REAL PDstandard4th12STphi CCTK_ATTRIBUTE_UNUSED = PDstandard4th12(&STphi[index]);
    const CCTK_REAL PDstandard4th13STphi CCTK_ATTRIBUTE_UNUSED = PDstandard4th13(&STphi[index]);
    const CCTK_REAL PDstandard4th23STphi CCTK_ATTRIBUTE_UNUSED = PDstandard4th23(&STphi[index]);
    ...
    CCTK_REAL STphirhsL CCTK_ATTRIBUTE_UNUSED = 
      betaxL*PDlopsided4th1(&STphi[index]) + 
      betayL*PDlopsided4th2(&STphi[index]) + 
      betazL*PDlopsided4th3(&STphi[index]) + alpL*STpiL;
    
    CCTK_REAL STpirhsL CCTK_ATTRIBUTE_UNUSED = 
      betaxL*PDlopsided4th1(&STpi[index]) + 
      betayL*PDlopsided4th2(&STpi[index]) + 
      betazL*PDlopsided4th3(&STpi[index]) + 
      PDstandard4th1alp*(gInv11*PDstandard4th1STphi + 
      gInv12*PDstandard4th2STphi + gInv13*PDstandard4th3STphi) + 
      PDstandard4th2alp*(gInv12*PDstandard4th1STphi + 
      gInv22*PDstandard4th2STphi + gInv23*PDstandard4th3STphi) + 
      PDstandard4th3alp*(gInv13*PDstandard4th1STphi + 
      gInv23*PDstandard4th2STphi + gInv33*PDstandard4th3STphi) + 
      alpL*(STpiL*ktrace + gInv11*PDstandard4th11STphi - (Gam3111*gInv11 + 
      2*Gam3121*gInv12 + 2*Gam3131*gInv13 + Gam3122*gInv22 + 2*Gam3132*gInv23 
      + Gam3133*gInv33)*PDstandard4th1STphi + gInv22*PDstandard4th22STphi + 
      2*(gInv12*PDstandard4th12STphi + gInv13*PDstandard4th13STphi + 
      gInv23*PDstandard4th23STphi) - (Gam3211*gInv11 + 2*Gam3221*gInv12 + 
      2*Gam3231*gInv13 + Gam3222*gInv22 + 2*Gam3232*gInv23 + 
      Gam3233*gInv33)*PDstandard4th2STphi + gInv33*PDstandard4th33STphi - 
      (Gam3311*gInv11 + 2*Gam3321*gInv12 + 2*Gam3331*gInv13 + Gam3322*gInv22 
      + 2*Gam3332*gInv23 + Gam3333*gInv33)*PDstandard4th3STphi + (STalpha0 + 
      1.*STphiL*STBeta)*ttrace);
    /* Copy local copies back to grid functions */
    STphirhs[index] = STphirhsL;
    STpirhs[index] = STpirhsL;
  }
  CCTK_ENDLOOP3(ScalarTensor_EvolveScalarField_full4th);
}
extern "C" void ScalarTensor_EvolveScalarField_full4th(CCTK_ARGUMENTS)
{
  DECLARE_CCTK_ARGUMENTS;
  DECLARE_CCTK_PARAMETERS;
  ...
  if (verbose > 1)
  {
    CCTK_VInfo(CCTK_THORNSTRING,"Entering ScalarTensor_EvolveScalarField_full4th_Body");
  }
  if (cctk_iteration % ScalarTensor_EvolveScalarField_full4th_calc_every != ScalarTensor_EvolveScalarField_full4th_calc_offset)
  {
    return;
  ...
  AssertGroupStorage(cctkGH, "ScalarTensor_EvolveScalarField_full4th", 8, groups);
  
  EnsureStencilFits(cctkGH, "ScalarTensor_EvolveScalarField_full4th", 3, 3, 3);
  
  LoopOverInterior(cctkGH, ScalarTensor_EvolveScalarField_full4th_Body);
  if (verbose > 1)
  {
    CCTK_VInfo(CCTK_THORNSTRING,"Leaving ScalarTensor_EvolveScalarField_full4th_Body");
  }
}
