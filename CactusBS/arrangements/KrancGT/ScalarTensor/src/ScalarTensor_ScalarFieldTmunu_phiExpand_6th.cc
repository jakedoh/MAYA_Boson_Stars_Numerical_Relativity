...
extern "C" void ScalarTensor_ScalarFieldTmunu_phiExpand_6th_SelectBCs(CCTK_ARGUMENTS)
{
  DECLARE_CCTK_ARGUMENTS;
  DECLARE_CCTK_PARAMETERS;
  
  if (cctk_iteration % ScalarTensor_ScalarFieldTmunu_phiExpand_6th_calc_every != ScalarTensor_ScalarFieldTmunu_phiExpand_6th_calc_offset)
    return;
...
static void ScalarTensor_ScalarFieldTmunu_phiExpand_6th_Body(const cGH* restrict const cctkGH, const int dir, const int face, const CCTK_REAL normal[3], const CCTK_REAL tangentA[3], const CCTK_REAL tangentB[3], const int imin[3], const int imax[3], const int n_subblock_gfs, CCTK_REAL* restrict const subblock_gfs[])
{
  DECLARE_CCTK_ARGUMENTS;
  DECLARE_CCTK_PARAMETERS;
  ...
  #pragma omp parallel
  CCTK_LOOP3(ScalarTensor_ScalarFieldTmunu_phiExpand_6th,
    ...
    cctk_ash[0],cctk_ash[1],cctk_ash[2])
  {
    ...
    CCTK_REAL dtSTphi CCTK_ATTRIBUTE_UNUSED = alpLocalL*STpiL + 
      PDlopsided6th1(&STphi[index])*betaLocal1 + 
      PDlopsided6th2(&STphi[index])*betaLocal2 + 
      PDlopsided6th3(&STphi[index])*betaLocal3;
    ...
    CCTK_REAL dSTphiSqr CCTK_ATTRIBUTE_UNUSED = 
      2*(gLocalInv23*PDstandard6th2STphi*PDstandard6th3STphi + 
      PDstandard6th1STphi*(gLocalInv12*PDstandard6th2STphi + 
      gLocalInv13*PDstandard6th3STphi)) - pow(STpiL,2) + 
      gLocalInv11*pow(PDstandard6th1STphi,2) + 
      gLocalInv22*pow(PDstandard6th2STphi,2) + 
      gLocalInv33*pow(PDstandard6th3STphi,2);
    
    CCTK_REAL STTtt CCTK_ATTRIBUTE_UNUSED = pow(dtSTphi,2) - 0.5*(betaSqr 
      - pow(alpLocalL,2))*(dSTphiSqr + pow(STphiL,2)*pow(fieldMass,2) + 
      0.166666666666666666666666666667*(12*V0 + 
      Vlambda*pow(STphiL,2)*(2*pow(STphiL,4) - 3*pow(STphiL,2)*(1 + 
      pow(Veps,2))*pow(Veta,2) + 6*pow(Veps,2)*pow(Veta,4))));
    
    CCTK_REAL STTtj1 CCTK_ATTRIBUTE_UNUSED = dtSTphi*PDstandard6th1STphi + 
      0.5*(gLocal11L*betaLocal1 + gLocal21L*betaLocal2 + 
      gLocal31L*betaLocal3)*(-dSTphiSqr - pow(STphiL,2)*pow(fieldMass,2) - 
      2*(V0 + 
      0.0833333333333333333333333333333*Vlambda*pow(STphiL,2)*(2*pow(STphiL,4) 
      - 3*pow(STphiL,2)*(1 + pow(Veps,2))*pow(Veta,2) + 
      6*pow(Veps,2)*pow(Veta,4))));
    
    CCTK_REAL STTtj2 CCTK_ATTRIBUTE_UNUSED = dtSTphi*PDstandard6th2STphi + 
      0.5*(gLocal21L*betaLocal1 + gLocal22L*betaLocal2 + 
      gLocal32L*betaLocal3)*(-dSTphiSqr - pow(STphiL,2)*pow(fieldMass,2) - 
      2*(V0 + 
      0.0833333333333333333333333333333*Vlambda*pow(STphiL,2)*(2*pow(STphiL,4) 
      - 3*pow(STphiL,2)*(1 + pow(Veps,2))*pow(Veta,2) + 
      6*pow(Veps,2)*pow(Veta,4))));
    
    CCTK_REAL STTtj3 CCTK_ATTRIBUTE_UNUSED = dtSTphi*PDstandard6th3STphi + 
      0.5*(gLocal31L*betaLocal1 + gLocal32L*betaLocal2 + 
      gLocal33L*betaLocal3)*(-dSTphiSqr - pow(STphiL,2)*pow(fieldMass,2) - 
      2*(V0 + 
      0.0833333333333333333333333333333*Vlambda*pow(STphiL,2)*(2*pow(STphiL,4) 
      - 3*pow(STphiL,2)*(1 + pow(Veps,2))*pow(Veta,2) + 
      6*pow(Veps,2)*pow(Veta,4))));
    
    CCTK_REAL STTij11 CCTK_ATTRIBUTE_UNUSED = pow(PDstandard6th1STphi,2) - 
      0.5*gLocal11L*(dSTphiSqr + pow(STphiL,2)*pow(fieldMass,2) + 
      0.166666666666666666666666666667*(12*V0 + 
      Vlambda*pow(STphiL,2)*(2*pow(STphiL,4) - 3*pow(STphiL,2)*(1 + 
      pow(Veps,2))*pow(Veta,2) + 6*pow(Veps,2)*pow(Veta,4))));
    
    CCTK_REAL STTij21 CCTK_ATTRIBUTE_UNUSED = 
      PDstandard6th1STphi*PDstandard6th2STphi - 0.5*gLocal21L*(dSTphiSqr + 
      pow(STphiL,2)*pow(fieldMass,2) + 
      0.166666666666666666666666666667*(12*V0 + 
      Vlambda*pow(STphiL,2)*(2*pow(STphiL,4) - 3*pow(STphiL,2)*(1 + 
      pow(Veps,2))*pow(Veta,2) + 6*pow(Veps,2)*pow(Veta,4))));
    
    CCTK_REAL STTij31 CCTK_ATTRIBUTE_UNUSED = 
      PDstandard6th1STphi*PDstandard6th3STphi - 0.5*gLocal31L*(dSTphiSqr + 
      pow(STphiL,2)*pow(fieldMass,2) + 
      0.166666666666666666666666666667*(12*V0 + 
      Vlambda*pow(STphiL,2)*(2*pow(STphiL,4) - 3*pow(STphiL,2)*(1 + 
      pow(Veps,2))*pow(Veta,2) + 6*pow(Veps,2)*pow(Veta,4))));
    
    CCTK_REAL STTij22 CCTK_ATTRIBUTE_UNUSED = pow(PDstandard6th2STphi,2) - 
      0.5*gLocal22L*(dSTphiSqr + pow(STphiL,2)*pow(fieldMass,2) + 
      0.166666666666666666666666666667*(12*V0 + 
      Vlambda*pow(STphiL,2)*(2*pow(STphiL,4) - 3*pow(STphiL,2)*(1 + 
      pow(Veps,2))*pow(Veta,2) + 6*pow(Veps,2)*pow(Veta,4))));
    
    CCTK_REAL STTij32 CCTK_ATTRIBUTE_UNUSED = 
      PDstandard6th2STphi*PDstandard6th3STphi - 0.5*gLocal32L*(dSTphiSqr + 
      pow(STphiL,2)*pow(fieldMass,2) + 
      0.166666666666666666666666666667*(12*V0 + 
      Vlambda*pow(STphiL,2)*(2*pow(STphiL,4) - 3*pow(STphiL,2)*(1 + 
      pow(Veps,2))*pow(Veta,2) + 6*pow(Veps,2)*pow(Veta,4))));
    
    CCTK_REAL STTij33 CCTK_ATTRIBUTE_UNUSED = pow(PDstandard6th3STphi,2) - 
      0.5*gLocal33L*(dSTphiSqr + pow(STphiL,2)*pow(fieldMass,2) + 
      0.166666666666666666666666666667*(12*V0 + 
      Vlambda*pow(STphiL,2)*(2*pow(STphiL,4) - 3*pow(STphiL,2)*(1 + 
      pow(Veps,2))*pow(Veta,2) + 6*pow(Veps,2)*pow(Veta,4))));
  ...
  CCTK_ENDLOOP3(ScalarTensor_ScalarFieldTmunu_phiExpand_6th);
}
extern "C" void ScalarTensor_ScalarFieldTmunu_phiExpand_6th(CCTK_ARGUMENTS)
{
  DECLARE_CCTK_ARGUMENTS;
  DECLARE_CCTK_PARAMETERS;
  ...
  if (verbose > 1)
  {
    CCTK_VInfo(CCTK_THORNSTRING,"Entering ScalarTensor_ScalarFieldTmunu_phiExpand_6th_Body");
  }
  if (cctk_iteration % ScalarTensor_ScalarFieldTmunu_phiExpand_6th_calc_every != ScalarTensor_ScalarFieldTmunu_phiExpand_6th_calc_offset)
  {
    return;
  ...
  AssertGroupStorage(cctkGH, "ScalarTensor_ScalarFieldTmunu_phiExpand_6th", 6, groups);
  
  EnsureStencilFits(cctkGH, "ScalarTensor_ScalarFieldTmunu_phiExpand_6th", 4, 4, 4);
  
  LoopOverInterior(cctkGH, ScalarTensor_ScalarFieldTmunu_phiExpand_6th_Body);
  if (verbose > 1)
  {
    CCTK_VInfo(CCTK_THORNSTRING,"Leaving ScalarTensor_ScalarFieldTmunu_phiExpand_6th_Body");
  }
}
