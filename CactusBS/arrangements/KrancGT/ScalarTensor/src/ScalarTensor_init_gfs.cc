...
static void ScalarTensor_init_gfs_Body(const cGH* restrict const cctkGH, const int dir, const int face, const CCTK_REAL normal[3], const CCTK_REAL tangentA[3], const CCTK_REAL tangentB[3], const int imin[3], const int imax[3], const int n_subblock_gfs, CCTK_REAL* restrict const subblock_gfs[])
{
  ...
  #pragma omp parallel
  CCTK_LOOP3(ScalarTensor_init_gfs,
    ...
    cctk_ash[0],cctk_ash[1],cctk_ash[2])
  {
    ...
    CCTK_REAL STphiL CCTK_ATTRIBUTE_UNUSED = 100;
    
    CCTK_REAL STpiL CCTK_ATTRIBUTE_UNUSED = 100;
  ...
  CCTK_ENDLOOP3(ScalarTensor_init_gfs);
}
extern "C" void ScalarTensor_init_gfs(CCTK_ARGUMENTS)
{
  DECLARE_CCTK_ARGUMENTS;
  DECLARE_CCTK_PARAMETERS;
  ...
  if (verbose > 1)
  {
    CCTK_VInfo(CCTK_THORNSTRING,"Entering ScalarTensor_init_gfs_Body");
  }
  if (cctk_iteration % ScalarTensor_init_gfs_calc_every != ScalarTensor_init_gfs_calc_offset)
  {
    return;
  }
  ...
  AssertGroupStorage(cctkGH, "ScalarTensor_init_gfs", 4, groups);
  
  
  LoopOverEverything(cctkGH, ScalarTensor_init_gfs_Body);
  if (verbose > 1)
  {
    CCTK_VInfo(CCTK_THORNSTRING,"Leaving ScalarTensor_init_gfs_Body");
  }
}
