...
!  @enddesc
!  @version   $Id: MoncriefQ.F90 58 2009-09-21 17:09:44Z schnetter $
!  @@*/
...
subroutine WavExtr_MoncriefQ(CCTK_ARGUMENTS)
  ...
  integer, save :: moncriefq_timer = -1
...
! _________________________________________________________________
  ...
  if (moncriefq_timer < 0) then
     call CCTK_TimerCreate(moncriefq_timer, "MoncriefQ")
     if (moncriefq_timer < 0) then
        call CCTK_WARN(1,"could not create MoncriefQ timer")
     end if
  end if
