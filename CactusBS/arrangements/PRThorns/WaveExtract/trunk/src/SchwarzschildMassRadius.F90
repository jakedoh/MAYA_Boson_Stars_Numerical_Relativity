...
!  @enddesc
!  @version   $Id: SchwarzschildMassRadius.F90 58 2009-09-21 17:09:44Z schnetter $
!@@*/
...
!  @@*/
  ...
  integer, save :: schwarzschild_timer = -1
...
! _________________________________________________________________
  ...
  if (schwarzschild_timer < 0) then
     call CCTK_TimerCreate(schwarzschild_timer, "Schwarzschild")
     if (schwarzschild_timer < 0) then
        call CCTK_WARN(1,"could not create Schwarzschild timer")
     end if
  end if
