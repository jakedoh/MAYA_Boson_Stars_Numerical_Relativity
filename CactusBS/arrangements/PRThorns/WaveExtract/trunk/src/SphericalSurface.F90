...
!     return
 ! end if
  ...
  do i=1,maximum_detector_number
    ...
    !print*,'WaveExtract: int_ntheta.', int_ntheta(i)
    !print*,'WaveExtract: int_nphi.', int_nphi(i)
    !print*,'WaveExtract: r.', detector_radius(i)
...
!     endif
!     
! !    print*,'WaveExtract: ntheta.', ntheta(i)
! !    print*,'WaveExtract: nphi.', nphi(i)
!     
