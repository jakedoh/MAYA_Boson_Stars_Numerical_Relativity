...
extern "C" void EvolveScalarFields_EvolveScalarField_full4th_potential_exppotential_SelectBCs(CCTK_ARGUMENTS)
{
  DECLARE_CCTK_ARGUMENTS;
  DECLARE_CCTK_PARAMETERS;
  
  if (cctk_iteration % EvolveScalarFields_EvolveScalarField_full4th_potential_exppotential_calc_every != EvolveScalarFields_EvolveScalarField_full4th_potential_exppotential_calc_offset)
    return;
...
static void EvolveScalarFields_EvolveScalarField_full4th_potential_exppotential_Body(const cGH* restrict const cctkGH, const int dir, const int face, const CCTK_REAL normal[3], const CCTK_REAL tangentA[3], const CCTK_REAL tangentB[3], const int imin[3], const int imax[3], const int n_subblock_gfs, CCTK_REAL* restrict const subblock_gfs[])
{
  DECLARE_CCTK_ARGUMENTS;
  DECLARE_CCTK_PARAMETERS;
  ...
  #pragma omp parallel
  CCTK_LOOP3(EvolveScalarFields_EvolveScalarField_full4th_potential_exppotential,
    ...
    cctk_ash[0],cctk_ash[1],cctk_ash[2])
  {
    ...
    CCTK_REAL derivVa CCTK_ATTRIBUTE_UNUSED = 2*phiaL*vv0*(vv1 - 
      ...
      pow(yL,2),0.5)),-1)*pow(pow(xL,2) + pow(yL,2),0.5)),0.5),2))));
  ...
  CCTK_ENDLOOP3(EvolveScalarFields_EvolveScalarField_full4th_potential_exppotential);
}
extern "C" void EvolveScalarFields_EvolveScalarField_full4th_potential_exppotential(CCTK_ARGUMENTS)
{
  DECLARE_CCTK_ARGUMENTS;
  DECLARE_CCTK_PARAMETERS;
  ...
  if (verbose > 1)
  {
    CCTK_VInfo(CCTK_THORNSTRING,"Entering EvolveScalarFields_EvolveScalarField_full4th_potential_exppotential_Body");
  }
  if (cctk_iteration % EvolveScalarFields_EvolveScalarField_full4th_potential_exppotential_calc_every != EvolveScalarFields_EvolveScalarField_full4th_potential_exppotential_calc_offset)
  {
    return;
  ...
  AssertGroupStorage(cctkGH, "EvolveScalarFields_EvolveScalarField_full4th_potential_exppotential", 13, groups);
  
  EnsureStencilFits(cctkGH, "EvolveScalarFields_EvolveScalarField_full4th_potential_exppotential", 3, 3, 3);
  
  LoopOverInterior(cctkGH, EvolveScalarFields_EvolveScalarField_full4th_potential_exppotential_Body);
  if (verbose > 1)
  {
    CCTK_VInfo(CCTK_THORNSTRING,"Leaving EvolveScalarFields_EvolveScalarField_full4th_potential_exppotential_Body");
  }
}
