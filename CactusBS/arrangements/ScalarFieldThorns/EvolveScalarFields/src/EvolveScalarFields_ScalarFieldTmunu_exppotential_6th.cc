...
extern "C" void EvolveScalarFields_ScalarFieldTmunu_exppotential_6th_SelectBCs(CCTK_ARGUMENTS)
{
  DECLARE_CCTK_ARGUMENTS;
  DECLARE_CCTK_PARAMETERS;
  
  if (cctk_iteration % EvolveScalarFields_ScalarFieldTmunu_exppotential_6th_calc_every != EvolveScalarFields_ScalarFieldTmunu_exppotential_6th_calc_offset)
    return;
...
static void EvolveScalarFields_ScalarFieldTmunu_exppotential_6th_Body(const cGH* restrict const cctkGH, const int dir, const int face, const CCTK_REAL normal[3], const CCTK_REAL tangentA[3], const CCTK_REAL tangentB[3], const int imin[3], const int imax[3], const int n_subblock_gfs, CCTK_REAL* restrict const subblock_gfs[])
{
  ...
  #pragma omp parallel
  CCTK_LOOP3(EvolveScalarFields_ScalarFieldTmunu_exppotential_6th,
  ...
  CCTK_ENDLOOP3(EvolveScalarFields_ScalarFieldTmunu_exppotential_6th);
}
extern "C" void EvolveScalarFields_ScalarFieldTmunu_exppotential_6th(CCTK_ARGUMENTS)
{
  DECLARE_CCTK_ARGUMENTS;
  DECLARE_CCTK_PARAMETERS;
  ...
  if (verbose > 1)
  {
    CCTK_VInfo(CCTK_THORNSTRING,"Entering EvolveScalarFields_ScalarFieldTmunu_exppotential_6th_Body");
  }
  if (cctk_iteration % EvolveScalarFields_ScalarFieldTmunu_exppotential_6th_calc_every != EvolveScalarFields_ScalarFieldTmunu_exppotential_6th_calc_offset)
  {
    return;
  ...
  AssertGroupStorage(cctkGH, "EvolveScalarFields_ScalarFieldTmunu_exppotential_6th", 11, groups);
  
  EnsureStencilFits(cctkGH, "EvolveScalarFields_ScalarFieldTmunu_exppotential_6th", 4, 4, 4);
  
  LoopOverInterior(cctkGH, EvolveScalarFields_ScalarFieldTmunu_exppotential_6th_Body);
  if (verbose > 1)
  {
    CCTK_VInfo(CCTK_THORNSTRING,"Leaving EvolveScalarFields_ScalarFieldTmunu_exppotential_6th_Body");
  }
}
