...
extern "C" void EvolveScalarFields_ScalarFieldanalysis_axionnew_6th_SelectBCs(CCTK_ARGUMENTS)
{
  DECLARE_CCTK_ARGUMENTS;
  DECLARE_CCTK_PARAMETERS;
  
  if (cctk_iteration % EvolveScalarFields_ScalarFieldanalysis_axionnew_6th_calc_every != EvolveScalarFields_ScalarFieldanalysis_axionnew_6th_calc_offset)
    return;
...
static void EvolveScalarFields_ScalarFieldanalysis_axionnew_6th_Body(const cGH* restrict const cctkGH, const int dir, const int face, const CCTK_REAL normal[3], const CCTK_REAL tangentA[3], const CCTK_REAL tangentB[3], const int imin[3], const int imax[3], const int n_subblock_gfs, CCTK_REAL* restrict const subblock_gfs[])
{
  ...
  #pragma omp parallel
  CCTK_LOOP3(EvolveScalarFields_ScalarFieldanalysis_axionnew_6th,
    ...
    cctk_ash[0],cctk_ash[1],cctk_ash[2])
  {
    ...
    SFTttL = pow(dtphia,2) + pow(dtphib,2) + 0.125*(-betaSqr + 
      pow(alpL,2))*(4*(dphiaSqrL + dphibSqrL) + (lambdaphian*pow(phiaL,2) + 
      2*lambdaphibn*pow(phibL,2))*(pow(vv1,2) + 
      ...
      pow(yL,2),0.5)),-1)*pow(pow(xL,2) + 
      pow(yL,2),0.5)),0.5)*pow(fmax(1.e-20,rL),-1))),2)) - 
      2*lambdaphian*phivsign*vv1*pow(phiaL,2)*tanh(pow(sigma,-1)*(delta + 
      r0apotential - rL*pow(fabs(gzzL*(pow(xL,2) + pow(yL,2)) + (2*gxyL*xL*yL 
      + gxxL*pow(xL,2) + 
      gyyL*pow(yL,2))*pow(zL,2)*pow(fmax(1.e-20,pow(pow(xL,2) + 
      pow(yL,2),0.5)),-2) - 2*(gxzL*xL + 
    ...
    CCTK_REAL SFTtj1 CCTK_ATTRIBUTE_UNUSED = dtphia*PDstandard6th1phia + 
      ...
      betazL*gxzL)*(4*(dphiaSqrL + dphibSqrL) + (lambdaphian*pow(phiaL,2) + 
      2*lambdaphibn*pow(phibL,2))*(pow(vv1,2) + 
      pow(phivsign,2)*pow(tanh(pow(sigma,-1)*(delta + r0apotential - 
      rL*pow(fabs(gzzL*(pow(xL,2) + pow(yL,2)) + (2*gxyL*xL*yL + 
      gxxL*pow(xL,2) + 
    ...
    CCTK_REAL SFTtj2 CCTK_ATTRIBUTE_UNUSED = dtphia*PDstandard6th2phia + 
      ...
      betazL*gyzL)*(4*(dphiaSqrL + dphibSqrL) + (lambdaphian*pow(phiaL,2) + 
      2*lambdaphibn*pow(phibL,2))*(pow(vv1,2) + 
      pow(phivsign,2)*pow(tanh(pow(sigma,-1)*(delta + r0apotential - 
      rL*pow(fabs(gzzL*(pow(xL,2) + pow(yL,2)) + (2*gxyL*xL*yL + 
      gxxL*pow(xL,2) + 
    ...
    CCTK_REAL SFTtj3 CCTK_ATTRIBUTE_UNUSED = dtphia*PDstandard6th3phia + 
      ...
      betazL*gzzL)*(4*(dphiaSqrL + dphibSqrL) + (lambdaphian*pow(phiaL,2) + 
      2*lambdaphibn*pow(phibL,2))*(pow(vv1,2) + 
      pow(phivsign,2)*pow(tanh(pow(sigma,-1)*(delta + r0apotential - 
      rL*pow(fabs(gzzL*(pow(xL,2) + pow(yL,2)) + (2*gxyL*xL*yL + 
      gxxL*pow(xL,2) + 
    ...
    CCTK_REAL SFTij11 CCTK_ATTRIBUTE_UNUSED = pow(PDstandard6th1phia,2) + 
      ...
      (lambdaphian*pow(phiaL,2) + 2*lambdaphibn*pow(phibL,2))*(pow(vv1,2) + 
      pow(phivsign,2)*pow(tanh(pow(sigma,-1)*(delta + r0apotential - 
      rL*pow(fabs(gzzL*(pow(xL,2) + pow(yL,2)) + (2*gxyL*xL*yL + 
      gxxL*pow(xL,2) + 
      gyyL*pow(yL,2))*pow(zL,2)*pow(fmax(1.e-20,pow(pow(xL,2) + 
    ...
    CCTK_REAL SFTij21 CCTK_ATTRIBUTE_UNUSED = 
      ...
      dphibSqrL) + (lambdaphian*pow(phiaL,2) + 
      2*lambdaphibn*pow(phibL,2))*(pow(vv1,2) + 
      pow(phivsign,2)*pow(tanh(pow(sigma,-1)*(delta + r0apotential - 
      rL*pow(fabs(gzzL*(pow(xL,2) + pow(yL,2)) + (2*gxyL*xL*yL + 
      gxxL*pow(xL,2) + 
    ...
    CCTK_REAL phidVdphiL CCTK_ATTRIBUTE_UNUSED = phiaL*derivVa;
  ...
  CCTK_ENDLOOP3(EvolveScalarFields_ScalarFieldanalysis_axionnew_6th);
}
extern "C" void EvolveScalarFields_ScalarFieldanalysis_axionnew_6th(CCTK_ARGUMENTS)
{
  DECLARE_CCTK_ARGUMENTS;
  DECLARE_CCTK_PARAMETERS;
  ...
  if (verbose > 1)
  {
    CCTK_VInfo(CCTK_THORNSTRING,"Entering EvolveScalarFields_ScalarFieldanalysis_axionnew_6th_Body");
  }
  if (cctk_iteration % EvolveScalarFields_ScalarFieldanalysis_axionnew_6th_calc_every != EvolveScalarFields_ScalarFieldanalysis_axionnew_6th_calc_offset)
  {
    return;
  ...
  AssertGroupStorage(cctkGH, "EvolveScalarFields_ScalarFieldanalysis_axionnew_6th", 19, groups);
  
  EnsureStencilFits(cctkGH, "EvolveScalarFields_ScalarFieldanalysis_axionnew_6th", 4, 4, 4);
  
  LoopOverInterior(cctkGH, EvolveScalarFields_ScalarFieldanalysis_axionnew_6th_Body);
  if (verbose > 1)
  {
    CCTK_VInfo(CCTK_THORNSTRING,"Leaving EvolveScalarFields_ScalarFieldanalysis_axionnew_6th_Body");
  }
}
