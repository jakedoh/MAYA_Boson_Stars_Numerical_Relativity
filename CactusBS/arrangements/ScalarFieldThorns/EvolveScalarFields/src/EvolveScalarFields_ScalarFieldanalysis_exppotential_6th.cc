...
extern "C" void EvolveScalarFields_ScalarFieldanalysis_exppotential_6th_SelectBCs(CCTK_ARGUMENTS)
{
  DECLARE_CCTK_ARGUMENTS;
  DECLARE_CCTK_PARAMETERS;
  
  if (cctk_iteration % EvolveScalarFields_ScalarFieldanalysis_exppotential_6th_calc_every != EvolveScalarFields_ScalarFieldanalysis_exppotential_6th_calc_offset)
    return;
...
static void EvolveScalarFields_ScalarFieldanalysis_exppotential_6th_Body(const cGH* restrict const cctkGH, const int dir, const int face, const CCTK_REAL normal[3], const CCTK_REAL tangentA[3], const CCTK_REAL tangentB[3], const int imin[3], const int imax[3], const int n_subblock_gfs, CCTK_REAL* restrict const subblock_gfs[])
{
  DECLARE_CCTK_ARGUMENTS;
  DECLARE_CCTK_PARAMETERS;
  ...
  #pragma omp parallel
  CCTK_LOOP3(EvolveScalarFields_ScalarFieldanalysis_exppotential_6th,
    ...
    cctk_ash[0],cctk_ash[1],cctk_ash[2])
  {
    ...
    CCTK_REAL SFTtj1 CCTK_ATTRIBUTE_UNUSED = dtphia*PDstandard6th1phia + 
      dtphib*PDstandard6th1phib + (betaxL*gxxL + betayL*gxyL + 
    ...
    CCTK_REAL SFTtj2 CCTK_ATTRIBUTE_UNUSED = dtphia*PDstandard6th2phia + 
      dtphib*PDstandard6th2phib + (betaxL*gxyL + betayL*gyyL + 
    ...
    CCTK_REAL SFTtj3 CCTK_ATTRIBUTE_UNUSED = dtphia*PDstandard6th3phia + 
      dtphib*PDstandard6th3phib + (betaxL*gxzL + betayL*gyzL + 
    ...
    CCTK_REAL SFTij11 CCTK_ATTRIBUTE_UNUSED = -(gxxL*(0.5*(dphiaSqrL + 
      ...
      gyzL*yL)*zL*pow(fmax(1.e-20,pow(pow(xL,2) + 
      pow(yL,2),0.5)),-1)*pow(pow(xL,2) + 
      pow(yL,2),0.5)),0.5),2))))*pow(phiaL,2))) + pow(PDstandard6th1phia,2) + 
      pow(PDstandard6th1phib,2);
    
    CCTK_REAL SFTij21 CCTK_ATTRIBUTE_UNUSED = 
      PDstandard6th1phia*PDstandard6th2phia + 
      PDstandard6th1phib*PDstandard6th2phib - gxyL*(0.5*(dphiaSqrL + 
      dphibSqrL) + vv0*(vv1 - 
      exp(-(pow(sigma,-2)*pow(fmax(1.e-20,rL),-2)*pow(-((delta + 
      r0apotential)*fmax(1.e-20,rL)) + rL*pow(fabs(gzzL*(pow(xL,2) + 
      pow(yL,2)) + (2*gxyL*xL*yL + gxxL*pow(xL,2) + 
    ...
    CCTK_REAL SFTij31 CCTK_ATTRIBUTE_UNUSED = 
      ...
      PDstandard6th1phib*PDstandard6th3phib - gxzL*(0.5*(dphiaSqrL + 
      dphibSqrL) + vv0*(vv1 - 
      exp(-(pow(sigma,-2)*pow(fmax(1.e-20,rL),-2)*pow(-((delta + 
      r0apotential)*fmax(1.e-20,rL)) + rL*pow(fabs(gzzL*(pow(xL,2) + 
      pow(yL,2)) + (2*gxyL*xL*yL + gxxL*pow(xL,2) + 
    ...
    CCTK_REAL SFTij22 CCTK_ATTRIBUTE_UNUSED = -(gyyL*(0.5*(dphiaSqrL + 
      ...
      gyzL*yL)*zL*pow(fmax(1.e-20,pow(pow(xL,2) + 
      pow(yL,2),0.5)),-1)*pow(pow(xL,2) + 
      pow(yL,2),0.5)),0.5),2))))*pow(phiaL,2))) + pow(PDstandard6th2phia,2) + 
      pow(PDstandard6th2phib,2);
    
    CCTK_REAL SFTij32 CCTK_ATTRIBUTE_UNUSED = 
      PDstandard6th2phia*PDstandard6th3phia + 
      PDstandard6th2phib*PDstandard6th3phib - gyzL*(0.5*(dphiaSqrL + 
      dphibSqrL) + vv0*(vv1 - 
      exp(-(pow(sigma,-2)*pow(fmax(1.e-20,rL),-2)*pow(-((delta + 
      r0apotential)*fmax(1.e-20,rL)) + rL*pow(fabs(gzzL*(pow(xL,2) + 
      pow(yL,2)) + (2*gxyL*xL*yL + gxxL*pow(xL,2) + 
    ...
    CCTK_REAL SFTij33 CCTK_ATTRIBUTE_UNUSED = -(gzzL*(0.5*(dphiaSqrL + 
      ...
      gyzL*yL)*zL*pow(fmax(1.e-20,pow(pow(xL,2) + 
      pow(yL,2),0.5)),-1)*pow(pow(xL,2) + 
      pow(yL,2),0.5)),0.5),2))))*pow(phiaL,2))) + pow(PDstandard6th3phia,2) + 
    ...
    CCTK_REAL SFpotentialL CCTK_ATTRIBUTE_UNUSED = vv0*(vv1 - 
      exp(-(pow(sigma,-2)*pow(fmax(1.e-20,rL),-2)*pow(-((delta + 
      r0apotential)*fmax(1.e-20,rL)) + rL*pow(fabs(gzzL*(pow(xL,2) + 
      pow(yL,2)) + (2*gxyL*xL*yL + gxxL*pow(xL,2) + 
      gyyL*pow(yL,2))*pow(zL,2)*pow(fmax(1.e-20,pow(pow(xL,2) + 
  ...
  CCTK_ENDLOOP3(EvolveScalarFields_ScalarFieldanalysis_exppotential_6th);
}
extern "C" void EvolveScalarFields_ScalarFieldanalysis_exppotential_6th(CCTK_ARGUMENTS)
{
  DECLARE_CCTK_ARGUMENTS;
  DECLARE_CCTK_PARAMETERS;
  ...
  if (verbose > 1)
  {
    CCTK_VInfo(CCTK_THORNSTRING,"Entering EvolveScalarFields_ScalarFieldanalysis_exppotential_6th_Body");
  }
  if (cctk_iteration % EvolveScalarFields_ScalarFieldanalysis_exppotential_6th_calc_every != EvolveScalarFields_ScalarFieldanalysis_exppotential_6th_calc_offset)
  {
    return;
  ...
  AssertGroupStorage(cctkGH, "EvolveScalarFields_ScalarFieldanalysis_exppotential_6th", 19, groups);
  
  EnsureStencilFits(cctkGH, "EvolveScalarFields_ScalarFieldanalysis_exppotential_6th", 4, 4, 4);
  
  LoopOverInterior(cctkGH, EvolveScalarFields_ScalarFieldanalysis_exppotential_6th_Body);
  if (verbose > 1)
  {
    CCTK_VInfo(CCTK_THORNSTRING,"Leaving EvolveScalarFields_ScalarFieldanalysis_exppotential_6th_Body");
  }
}
