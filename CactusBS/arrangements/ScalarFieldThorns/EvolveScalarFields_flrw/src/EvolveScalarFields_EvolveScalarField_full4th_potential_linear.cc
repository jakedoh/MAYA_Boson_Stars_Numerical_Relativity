...
extern "C" void EvolveScalarFields_EvolveScalarField_full4th_potential_linear_SelectBCs(CCTK_ARGUMENTS)
{
  #ifdef DECLARE_CCTK_ARGUMENTS_EvolveScalarFields_EvolveScalarField_full4th_potential_linear_SelectBCs
  DECLARE_CCTK_ARGUMENTS_CHECKED(EvolveScalarFields_EvolveScalarField_full4th_potential_linear_SelectBCs);
  #else
  DECLARE_CCTK_ARGUMENTS;
  #endif
  DECLARE_CCTK_PARAMETERS;
  
  if (cctk_iteration % EvolveScalarFields_EvolveScalarField_full4th_potential_linear_calc_every != EvolveScalarFields_EvolveScalarField_full4th_potential_linear_calc_offset)
    return;
...
static void EvolveScalarFields_EvolveScalarField_full4th_potential_linear_Body(const cGH* restrict const cctkGH, const int dir, const int face, const CCTK_REAL normal[3], const CCTK_REAL tangentA[3], const CCTK_REAL tangentB[3], const int imin[3], const int imax[3], const int n_subblock_gfs, CCTK_REAL* restrict const subblock_gfs[])
{
  DECLARE_CCTK_ARGUMENTS;
  DECLARE_CCTK_PARAMETERS;
  ...
  #pragma omp parallel
  CCTK_LOOP3(EvolveScalarFields_EvolveScalarField_full4th_potential_linear,
    ...
    cctk_ash[0],cctk_ash[1],cctk_ash[2])
  {
    ...
    CCTK_REAL derivVa CCTK_ATTRIBUTE_UNUSED = lambdaphia;
    
    CCTK_REAL derivVb CCTK_ATTRIBUTE_UNUSED = lambdaphibn;
  ...
  CCTK_ENDLOOP3(EvolveScalarFields_EvolveScalarField_full4th_potential_linear);
}
extern "C" void EvolveScalarFields_EvolveScalarField_full4th_potential_linear(CCTK_ARGUMENTS)
{
  #ifdef DECLARE_CCTK_ARGUMENTS_EvolveScalarFields_EvolveScalarField_full4th_potential_linear
  DECLARE_CCTK_ARGUMENTS_CHECKED(EvolveScalarFields_EvolveScalarField_full4th_potential_linear);
  #else
  DECLARE_CCTK_ARGUMENTS;
  #endif
  DECLARE_CCTK_PARAMETERS;
  ...
  if (verbose > 1)
  {
    CCTK_VInfo(CCTK_THORNSTRING,"Entering EvolveScalarFields_EvolveScalarField_full4th_potential_linear_Body");
  }
  if (cctk_iteration % EvolveScalarFields_EvolveScalarField_full4th_potential_linear_calc_every != EvolveScalarFields_EvolveScalarField_full4th_potential_linear_calc_offset)
  {
    return;
  ...
  AssertGroupStorage(cctkGH, "EvolveScalarFields_EvolveScalarField_full4th_potential_linear", 12, groups);
  
  EnsureStencilFits(cctkGH, "EvolveScalarFields_EvolveScalarField_full4th_potential_linear", 3, 3, 3);
  
  LoopOverInterior(cctkGH, EvolveScalarFields_EvolveScalarField_full4th_potential_linear_Body);
  if (verbose > 1)
  {
    CCTK_VInfo(CCTK_THORNSTRING,"Leaving EvolveScalarFields_EvolveScalarField_full4th_potential_linear_Body");
  }
}
