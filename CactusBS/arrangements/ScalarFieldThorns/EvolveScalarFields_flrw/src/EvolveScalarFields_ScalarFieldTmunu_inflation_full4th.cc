...
static void EvolveScalarFields_ScalarFieldTmunu_inflation_full4th_Body(const cGH* restrict const cctkGH, const int dir, const int face, const CCTK_REAL normal[3], const CCTK_REAL tangentA[3], const CCTK_REAL tangentB[3], const int imin[3], const int imax[3], const int n_subblock_gfs, CCTK_REAL* restrict const subblock_gfs[])
{
    ...
    cctk_ash[0],cctk_ash[1],cctk_ash[2])
  {
    ...
    CCTK_REAL SFTij11 CCTK_ATTRIBUTE_UNUSED = pow(PDstandard4th1phia,2) + 
      pow(PDstandard4th1phib,2) - 0.25*gxxL*(2*(dphiaSqr + dphibSqr) + 4*Vi0 
      + lambdaphia*pow(-pow(phiaL,2) + pow(phi00,2),2) + 
      lambdaphibn*pow(pow(phibL,2) - pow(phibv,2),2));
    ...
    CCTK_REAL SFTij22 CCTK_ATTRIBUTE_UNUSED = pow(PDstandard4th2phia,2) + 
      pow(PDstandard4th2phib,2) - 0.25*gyyL*(2*(dphiaSqr + dphibSqr) + 4*Vi0 
      + lambdaphia*pow(-pow(phiaL,2) + pow(phi00,2),2) + 
      lambdaphibn*pow(pow(phibL,2) - pow(phibv,2),2));
    ...
    CCTK_REAL SFTij33 CCTK_ATTRIBUTE_UNUSED = pow(PDstandard4th3phia,2) + 
      pow(PDstandard4th3phib,2) - 0.25*gzzL*(2*(dphiaSqr + dphibSqr) + 4*Vi0 
      + lambdaphia*pow(-pow(phiaL,2) + pow(phi00,2),2) + 
      lambdaphibn*pow(pow(phibL,2) - pow(phibv,2),2));
