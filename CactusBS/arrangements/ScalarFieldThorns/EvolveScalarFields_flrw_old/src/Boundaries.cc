...
{
#ifdef DECLARE_CCTK_ARGUMENTS_EvolveScalarFields_CheckBoundaries
  DECLARE_CCTK_ARGUMENTS_CHECKED(EvolveScalarFields_CheckBoundaries);
#else
...
{
#ifdef DECLARE_CCTK_ARGUMENTS_EvolveScalarFields_SelectBoundConds
  DECLARE_CCTK_ARGUMENTS_CHECKED(EvolveScalarFields_SelectBoundConds);
#else
  DECLARE_CCTK_ARGUMENTS;
#endif
  DECLARE_CCTK_PARAMETERS;
  ...
  if (CCTK_EQUALS(phia_group_bound, "radiative"))
  {
   /* select radiation boundary condition */
    ...
    ierr = KrancBdy_SelectGroupForBC(cctkGH, CCTK_ALL_FACES, 1, handle_phia_group_bound, 
  ...
  if (CCTK_EQUALS(pia_group_bound, "radiative"))
  {
   /* select radiation boundary condition */
    ...
    ierr = KrancBdy_SelectGroupForBC(cctkGH, CCTK_ALL_FACES, 1, handle_pia_group_bound, 
  ...
  if (CCTK_EQUALS(phib_group_bound, "radiative"))
  {
   /* select radiation boundary condition */
    ...
    ierr = KrancBdy_SelectGroupForBC(cctkGH, CCTK_ALL_FACES, 1, handle_phib_group_bound, 
  ...
  if (CCTK_EQUALS(pib_group_bound, "radiative"))
  {
   /* select radiation boundary condition */
    ...
    ierr = KrancBdy_SelectGroupForBC(cctkGH, CCTK_ALL_FACES, 1, handle_pib_group_bound, 
  ...
  if (CCTK_EQUALS(phia_bound, "radiative"))
  {
   /* select radiation boundary condition */
    ...
    ierr = KrancBdy_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, handle_phia_bound, 
  ...
  if (CCTK_EQUALS(pia_bound, "radiative"))
  {
   /* select radiation boundary condition */
    ...
    ierr = KrancBdy_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, handle_pia_bound, 
  ...
  if (CCTK_EQUALS(phib_bound, "radiative"))
  {
   /* select radiation boundary condition */
    ...
    ierr = KrancBdy_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, handle_phib_bound, 
  ...
  if (CCTK_EQUALS(pib_bound, "radiative"))
  {
   /* select radiation boundary condition */
    ...
    ierr = KrancBdy_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, handle_pib_bound, 
