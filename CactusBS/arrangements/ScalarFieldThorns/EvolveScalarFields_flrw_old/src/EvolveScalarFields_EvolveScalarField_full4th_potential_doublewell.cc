...
extern "C" void EvolveScalarFields_EvolveScalarField_full4th_potential_doublewell_SelectBCs(CCTK_ARGUMENTS)
{
  #ifdef DECLARE_CCTK_ARGUMENTS_EvolveScalarFields_EvolveScalarField_full4th_potential_doublewell_SelectBCs
  DECLARE_CCTK_ARGUMENTS_CHECKED(EvolveScalarFields_EvolveScalarField_full4th_potential_doublewell_SelectBCs);
  #else
  DECLARE_CCTK_ARGUMENTS;
  #endif
  DECLARE_CCTK_PARAMETERS;
  
  if (cctk_iteration % EvolveScalarFields_EvolveScalarField_full4th_potential_doublewell_calc_every != EvolveScalarFields_EvolveScalarField_full4th_potential_doublewell_calc_offset)
    return;
...
static void EvolveScalarFields_EvolveScalarField_full4th_potential_doublewell_Body(const cGH* restrict const cctkGH, const int dir, const int face, const CCTK_REAL normal[3], const CCTK_REAL tangentA[3], const CCTK_REAL tangentB[3], const int imin[3], const int imax[3], const int n_subblock_gfs, CCTK_REAL* restrict const subblock_gfs[])
{
  DECLARE_CCTK_ARGUMENTS;
  DECLARE_CCTK_PARAMETERS;
  ...
  #pragma omp parallel
  CCTK_LOOP3(EvolveScalarFields_EvolveScalarField_full4th_potential_doublewell,
    ...
    cctk_ash[0],cctk_ash[1],cctk_ash[2])
  {
    ...
    const CCTK_REAL PDstandard4th1alp CCTK_ATTRIBUTE_UNUSED = PDstandard4th1(&alp[index]);
    const CCTK_REAL PDstandard4th2alp CCTK_ATTRIBUTE_UNUSED = PDstandard4th2(&alp[index]);
    const CCTK_REAL PDstandard4th3alp CCTK_ATTRIBUTE_UNUSED = PDstandard4th3(&alp[index]);
    const CCTK_REAL PDstandard4th1gxx CCTK_ATTRIBUTE_UNUSED = PDstandard4th1(&gxx[index]);
    const CCTK_REAL PDstandard4th2gxx CCTK_ATTRIBUTE_UNUSED = PDstandard4th2(&gxx[index]);
    const CCTK_REAL PDstandard4th3gxx CCTK_ATTRIBUTE_UNUSED = PDstandard4th3(&gxx[index]);
    const CCTK_REAL PDstandard4th1gxy CCTK_ATTRIBUTE_UNUSED = PDstandard4th1(&gxy[index]);
    const CCTK_REAL PDstandard4th2gxy CCTK_ATTRIBUTE_UNUSED = PDstandard4th2(&gxy[index]);
    const CCTK_REAL PDstandard4th3gxy CCTK_ATTRIBUTE_UNUSED = PDstandard4th3(&gxy[index]);
    const CCTK_REAL PDstandard4th1gxz CCTK_ATTRIBUTE_UNUSED = PDstandard4th1(&gxz[index]);
    const CCTK_REAL PDstandard4th2gxz CCTK_ATTRIBUTE_UNUSED = PDstandard4th2(&gxz[index]);
    const CCTK_REAL PDstandard4th3gxz CCTK_ATTRIBUTE_UNUSED = PDstandard4th3(&gxz[index]);
    const CCTK_REAL PDstandard4th1gyy CCTK_ATTRIBUTE_UNUSED = PDstandard4th1(&gyy[index]);
    const CCTK_REAL PDstandard4th2gyy CCTK_ATTRIBUTE_UNUSED = PDstandard4th2(&gyy[index]);
    const CCTK_REAL PDstandard4th3gyy CCTK_ATTRIBUTE_UNUSED = PDstandard4th3(&gyy[index]);
    const CCTK_REAL PDstandard4th1gyz CCTK_ATTRIBUTE_UNUSED = PDstandard4th1(&gyz[index]);
    const CCTK_REAL PDstandard4th2gyz CCTK_ATTRIBUTE_UNUSED = PDstandard4th2(&gyz[index]);
    const CCTK_REAL PDstandard4th3gyz CCTK_ATTRIBUTE_UNUSED = PDstandard4th3(&gyz[index]);
    const CCTK_REAL PDstandard4th1gzz CCTK_ATTRIBUTE_UNUSED = PDstandard4th1(&gzz[index]);
    const CCTK_REAL PDstandard4th2gzz CCTK_ATTRIBUTE_UNUSED = PDstandard4th2(&gzz[index]);
    const CCTK_REAL PDstandard4th3gzz CCTK_ATTRIBUTE_UNUSED = PDstandard4th3(&gzz[index]);
    ...
    const CCTK_REAL PDstandard4th11phia CCTK_ATTRIBUTE_UNUSED = PDstandard4th11(&phia[index]);
    const CCTK_REAL PDstandard4th22phia CCTK_ATTRIBUTE_UNUSED = PDstandard4th22(&phia[index]);
    const CCTK_REAL PDstandard4th33phia CCTK_ATTRIBUTE_UNUSED = PDstandard4th33(&phia[index]);
    const CCTK_REAL PDstandard4th12phia CCTK_ATTRIBUTE_UNUSED = PDstandard4th12(&phia[index]);
    const CCTK_REAL PDstandard4th13phia CCTK_ATTRIBUTE_UNUSED = PDstandard4th13(&phia[index]);
    const CCTK_REAL PDstandard4th23phia CCTK_ATTRIBUTE_UNUSED = PDstandard4th23(&phia[index]);
    ...
    const CCTK_REAL PDstandard4th11phib CCTK_ATTRIBUTE_UNUSED = PDstandard4th11(&phib[index]);
    const CCTK_REAL PDstandard4th22phib CCTK_ATTRIBUTE_UNUSED = PDstandard4th22(&phib[index]);
    const CCTK_REAL PDstandard4th33phib CCTK_ATTRIBUTE_UNUSED = PDstandard4th33(&phib[index]);
    const CCTK_REAL PDstandard4th12phib CCTK_ATTRIBUTE_UNUSED = PDstandard4th12(&phib[index]);
    const CCTK_REAL PDstandard4th13phib CCTK_ATTRIBUTE_UNUSED = PDstandard4th13(&phib[index]);
    const CCTK_REAL PDstandard4th23phib CCTK_ATTRIBUTE_UNUSED = PDstandard4th23(&phib[index]);
    ...
    CCTK_REAL Gam3211 CCTK_ATTRIBUTE_UNUSED = 
      0.5*(gInv12*PDstandard4th1gxx + 2*(gInv22*PDstandard4th1gxy + 
      gInv23*PDstandard4th1gxz) - gInv22*PDstandard4th2gxx - 
      gInv23*PDstandard4th3gxx);
    
    CCTK_REAL Gam3311 CCTK_ATTRIBUTE_UNUSED = 
      0.5*(gInv13*PDstandard4th1gxx + 2*(gInv23*PDstandard4th1gxy + 
      gInv33*PDstandard4th1gxz) - gInv23*PDstandard4th2gxx - 
    ...
    CCTK_REAL Gam3221 CCTK_ATTRIBUTE_UNUSED = 
      0.5*(gInv22*PDstandard4th1gyy + gInv12*PDstandard4th2gxx + 
      gInv23*(PDstandard4th1gyz + PDstandard4th2gxz - PDstandard4th3gxy));
    
    CCTK_REAL Gam3321 CCTK_ATTRIBUTE_UNUSED = 
      0.5*(gInv23*PDstandard4th1gyy + gInv13*PDstandard4th2gxx + 
    ...
    CCTK_REAL Gam3231 CCTK_ATTRIBUTE_UNUSED = 
      0.5*(gInv23*PDstandard4th1gzz + gInv12*PDstandard4th3gxx + 
      gInv22*(PDstandard4th1gyz - PDstandard4th2gxz + PDstandard4th3gxy));
    
    CCTK_REAL Gam3331 CCTK_ATTRIBUTE_UNUSED = 
      0.5*(gInv33*PDstandard4th1gzz + gInv13*PDstandard4th3gxx + 
      gInv23*(PDstandard4th1gyz - PDstandard4th2gxz + PDstandard4th3gxy));
    ...
    CCTK_REAL Gam3222 CCTK_ATTRIBUTE_UNUSED = 
      0.5*(gInv12*(-PDstandard4th1gyy + 2*PDstandard4th2gxy) + 
      gInv22*PDstandard4th2gyy + gInv23*(2*PDstandard4th2gyz - 
      PDstandard4th3gyy));
    
    CCTK_REAL Gam3322 CCTK_ATTRIBUTE_UNUSED = 
      0.5*(gInv13*(-PDstandard4th1gyy + 2*PDstandard4th2gxy) + 
      gInv23*PDstandard4th2gyy + gInv33*(2*PDstandard4th2gyz - 
      PDstandard4th3gyy));
    ...
    CCTK_REAL Gam3232 CCTK_ATTRIBUTE_UNUSED = 
      0.5*(gInv23*PDstandard4th2gzz + gInv12*(-PDstandard4th1gyz + 
      PDstandard4th2gxz + PDstandard4th3gxy) + gInv22*PDstandard4th3gyy);
    
    CCTK_REAL Gam3332 CCTK_ATTRIBUTE_UNUSED = 
      0.5*(gInv33*PDstandard4th2gzz + gInv13*(-PDstandard4th1gyz + 
      PDstandard4th2gxz + PDstandard4th3gxy) + gInv23*PDstandard4th3gyy);
    ...
    CCTK_REAL Gam3233 CCTK_ATTRIBUTE_UNUSED = 
      0.5*(gInv12*(-PDstandard4th1gzz + 2*PDstandard4th3gxz) + 
      gInv22*(-PDstandard4th2gzz + 2*PDstandard4th3gyz) + 
      gInv23*PDstandard4th3gzz);
    
    CCTK_REAL Gam3333 CCTK_ATTRIBUTE_UNUSED = 
      0.5*(gInv13*(-PDstandard4th1gzz + 2*PDstandard4th3gxz) + 
      gInv23*(-PDstandard4th2gzz + 2*PDstandard4th3gyz) + 
      gInv33*PDstandard4th3gzz);
    
    CCTK_REAL derivVa CCTK_ATTRIBUTE_UNUSED = phiaL*(gcouple*pow(phibL,2) 
      + pow(phiamass,2) + lambdaphian*(pow(phiaL,2) - pow(phiav,2)));
    
    CCTK_REAL derivVb CCTK_ATTRIBUTE_UNUSED = phibL*(gcouple*pow(phiaL,2) 
      + pow(phibmass,2) + lambdaphibn*(pow(phibL,2) - pow(phibv,2)));
    ...
    CCTK_REAL piarhsL CCTK_ATTRIBUTE_UNUSED = 
      betaxL*PDlopsided4th1(&pia[index]) + betayL*PDlopsided4th2(&pia[index]) 
      + betazL*PDlopsided4th3(&pia[index]) - 
      PDstandard4th1alp*(gInv11*PDstandard4th1phia + 
      gInv12*PDstandard4th2phia + gInv13*PDstandard4th3phia) - 
      PDstandard4th2alp*(gInv12*PDstandard4th1phia + 
      gInv22*PDstandard4th2phia + gInv23*PDstandard4th3phia) - 
      PDstandard4th3alp*(gInv13*PDstandard4th1phia + 
      gInv23*PDstandard4th2phia + gInv33*PDstandard4th3phia) + alpL*(derivVa 
      + piaL*ktrace - gInv11*PDstandard4th11phia - 
      2*gInv12*PDstandard4th12phia - 2*gInv13*PDstandard4th13phia + 
      (Gam3111*gInv11 + 2*Gam3121*gInv12 + 2*Gam3131*gInv13 + Gam3122*gInv22 
      + 2*Gam3132*gInv23 + Gam3133*gInv33)*PDstandard4th1phia - 
      gInv22*PDstandard4th22phia - 2*gInv23*PDstandard4th23phia + 
      (Gam3211*gInv11 + 2*Gam3221*gInv12 + 2*Gam3231*gInv13 + Gam3222*gInv22 
      + 2*Gam3232*gInv23 + Gam3233*gInv33)*PDstandard4th2phia - 
      gInv33*PDstandard4th33phia + (Gam3311*gInv11 + 2*Gam3321*gInv12 + 
      2*Gam3331*gInv13 + Gam3322*gInv22 + 2*Gam3332*gInv23 + 
      Gam3333*gInv33)*PDstandard4th3phia);
    ...
    CCTK_REAL pibrhsL CCTK_ATTRIBUTE_UNUSED = 
      betaxL*PDlopsided4th1(&pib[index]) + betayL*PDlopsided4th2(&pib[index]) 
      + betazL*PDlopsided4th3(&pib[index]) - 
      PDstandard4th1alp*(gInv11*PDstandard4th1phib + 
      gInv12*PDstandard4th2phib + gInv13*PDstandard4th3phib) - 
      PDstandard4th2alp*(gInv12*PDstandard4th1phib + 
      gInv22*PDstandard4th2phib + gInv23*PDstandard4th3phib) - 
      PDstandard4th3alp*(gInv13*PDstandard4th1phib + 
      gInv23*PDstandard4th2phib + gInv33*PDstandard4th3phib) + alpL*(derivVb 
      + pibL*ktrace - gInv11*PDstandard4th11phib - 
      2*gInv12*PDstandard4th12phib - 2*gInv13*PDstandard4th13phib + 
      (Gam3111*gInv11 + 2*Gam3121*gInv12 + 2*Gam3131*gInv13 + Gam3122*gInv22 
      + 2*Gam3132*gInv23 + Gam3133*gInv33)*PDstandard4th1phib - 
      gInv22*PDstandard4th22phib - 2*gInv23*PDstandard4th23phib + 
      (Gam3211*gInv11 + 2*Gam3221*gInv12 + 2*Gam3231*gInv13 + Gam3222*gInv22 
      + 2*Gam3232*gInv23 + Gam3233*gInv33)*PDstandard4th2phib - 
      gInv33*PDstandard4th33phib + (Gam3311*gInv11 + 2*Gam3321*gInv12 + 
      2*Gam3331*gInv13 + Gam3322*gInv22 + 2*Gam3332*gInv23 + 
      Gam3333*gInv33)*PDstandard4th3phib);
    /* Copy local copies back to grid functions */
  ...
  CCTK_ENDLOOP3(EvolveScalarFields_EvolveScalarField_full4th_potential_doublewell);
}
extern "C" void EvolveScalarFields_EvolveScalarField_full4th_potential_doublewell(CCTK_ARGUMENTS)
{
  #ifdef DECLARE_CCTK_ARGUMENTS_EvolveScalarFields_EvolveScalarField_full4th_potential_doublewell
  DECLARE_CCTK_ARGUMENTS_CHECKED(EvolveScalarFields_EvolveScalarField_full4th_potential_doublewell);
  #else
  DECLARE_CCTK_ARGUMENTS;
  #endif
  DECLARE_CCTK_PARAMETERS;
  ...
  if (verbose > 1)
  {
    CCTK_VInfo(CCTK_THORNSTRING,"Entering EvolveScalarFields_EvolveScalarField_full4th_potential_doublewell_Body");
  }
  if (cctk_iteration % EvolveScalarFields_EvolveScalarField_full4th_potential_doublewell_calc_every != EvolveScalarFields_EvolveScalarField_full4th_potential_doublewell_calc_offset)
  {
    return;
  ...
  AssertGroupStorage(cctkGH, "EvolveScalarFields_EvolveScalarField_full4th_potential_doublewell", 12, groups);
  
  EnsureStencilFits(cctkGH, "EvolveScalarFields_EvolveScalarField_full4th_potential_doublewell", 3, 3, 3);
  
  LoopOverInterior(cctkGH, EvolveScalarFields_EvolveScalarField_full4th_potential_doublewell_Body);
  if (verbose > 1)
  {
    CCTK_VInfo(CCTK_THORNSTRING,"Leaving EvolveScalarFields_EvolveScalarField_full4th_potential_doublewell_Body");
  }
}
