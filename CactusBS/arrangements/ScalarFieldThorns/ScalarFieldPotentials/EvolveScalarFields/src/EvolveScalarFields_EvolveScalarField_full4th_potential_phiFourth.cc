...
extern "C" void EvolveScalarFields_EvolveScalarField_full4th_potential_phiFourth_SelectBCs(CCTK_ARGUMENTS)
{
  #ifdef DECLARE_CCTK_ARGUMENTS_EvolveScalarFields_EvolveScalarField_full4th_potential_phiFourth_SelectBCs
  DECLARE_CCTK_ARGUMENTS_CHECKED(EvolveScalarFields_EvolveScalarField_full4th_potential_phiFourth_SelectBCs);
  #else
  DECLARE_CCTK_ARGUMENTS;
  #endif
  DECLARE_CCTK_PARAMETERS;
  
  if (cctk_iteration % EvolveScalarFields_EvolveScalarField_full4th_potential_phiFourth_calc_every != EvolveScalarFields_EvolveScalarField_full4th_potential_phiFourth_calc_offset)
    return;
...
static void EvolveScalarFields_EvolveScalarField_full4th_potential_phiFourth_Body(const cGH* restrict const cctkGH, const int dir, const int face, const CCTK_REAL normal[3], const CCTK_REAL tangentA[3], const CCTK_REAL tangentB[3], const int imin[3], const int imax[3], const int n_subblock_gfs, CCTK_REAL* restrict const subblock_gfs[])
{
  ...
  #pragma omp parallel
  CCTK_LOOP3(EvolveScalarFields_EvolveScalarField_full4th_potential_phiFourth,
    ...
    cctk_ash[0],cctk_ash[1],cctk_ash[2])
  {
    ...
    CCTK_REAL derivVa CCTK_ATTRIBUTE_UNUSED = 
      phiaL*(lambdaphia*pow(phiaL,2) + gcouple*pow(phibL,2) + pow(phiamass,2) 
      + lambdaphian*(pow(phiaL,2) - pow(phiav,2)));
    
    CCTK_REAL derivVb CCTK_ATTRIBUTE_UNUSED = phibL*(gcouple*pow(phiaL,2) 
      + (lambdaphib + lambdaphibn)*pow(phibL,2) + pow(phibmass,2) - 
      lambdaphibn*pow(phibv,2));
  ...
  CCTK_ENDLOOP3(EvolveScalarFields_EvolveScalarField_full4th_potential_phiFourth);
}
extern "C" void EvolveScalarFields_EvolveScalarField_full4th_potential_phiFourth(CCTK_ARGUMENTS)
{
  #ifdef DECLARE_CCTK_ARGUMENTS_EvolveScalarFields_EvolveScalarField_full4th_potential_phiFourth
  DECLARE_CCTK_ARGUMENTS_CHECKED(EvolveScalarFields_EvolveScalarField_full4th_potential_phiFourth);
  #else
  DECLARE_CCTK_ARGUMENTS;
  #endif
  DECLARE_CCTK_PARAMETERS;
  ...
  if (verbose > 1)
  {
    CCTK_VInfo(CCTK_THORNSTRING,"Entering EvolveScalarFields_EvolveScalarField_full4th_potential_phiFourth_Body");
  }
  if (cctk_iteration % EvolveScalarFields_EvolveScalarField_full4th_potential_phiFourth_calc_every != EvolveScalarFields_EvolveScalarField_full4th_potential_phiFourth_calc_offset)
  {
    return;
  ...
  AssertGroupStorage(cctkGH, "EvolveScalarFields_EvolveScalarField_full4th_potential_phiFourth", 12, groups);
  
  EnsureStencilFits(cctkGH, "EvolveScalarFields_EvolveScalarField_full4th_potential_phiFourth", 3, 3, 3);
  
  LoopOverInterior(cctkGH, EvolveScalarFields_EvolveScalarField_full4th_potential_phiFourth_Body);
  if (verbose > 1)
  {
    CCTK_VInfo(CCTK_THORNSTRING,"Leaving EvolveScalarFields_EvolveScalarField_full4th_potential_phiFourth_Body");
  }
}
