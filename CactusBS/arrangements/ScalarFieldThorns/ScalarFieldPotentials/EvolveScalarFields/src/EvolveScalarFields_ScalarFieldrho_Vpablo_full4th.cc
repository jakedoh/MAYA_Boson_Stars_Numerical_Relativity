...
extern "C" void EvolveScalarFields_ScalarFieldrho_Vpablo_full4th_SelectBCs(CCTK_ARGUMENTS)
{
  #ifdef DECLARE_CCTK_ARGUMENTS_EvolveScalarFields_ScalarFieldrho_Vpablo_full4th_SelectBCs
  DECLARE_CCTK_ARGUMENTS_CHECKED(EvolveScalarFields_ScalarFieldrho_Vpablo_full4th_SelectBCs);
  #else
  DECLARE_CCTK_ARGUMENTS;
  #endif
  DECLARE_CCTK_PARAMETERS;
  
  if (cctk_iteration % EvolveScalarFields_ScalarFieldrho_Vpablo_full4th_calc_every != EvolveScalarFields_ScalarFieldrho_Vpablo_full4th_calc_offset)
    return;
...
static void EvolveScalarFields_ScalarFieldrho_Vpablo_full4th_Body(const cGH* restrict const cctkGH, const int dir, const int face, const CCTK_REAL normal[3], const CCTK_REAL tangentA[3], const CCTK_REAL tangentB[3], const int imin[3], const int imax[3], const int n_subblock_gfs, CCTK_REAL* restrict const subblock_gfs[])
{
  DECLARE_CCTK_ARGUMENTS;
  DECLARE_CCTK_PARAMETERS;
  ...
  #pragma omp parallel
  CCTK_LOOP3(EvolveScalarFields_ScalarFieldrho_Vpablo_full4th,
    ...
    cctk_ash[0],cctk_ash[1],cctk_ash[2])
  {
    ...
    CCTK_REAL SFTij11 CCTK_ATTRIBUTE_UNUSED = pow(PDstandard4th1phia,2) + 
      pow(PDstandard4th1phib,2) - 0.5*gxxL*(dphiaSqr + dphibSqr - 
    ...
    CCTK_REAL SFTij21 CCTK_ATTRIBUTE_UNUSED = 
      ...
      PDstandard4th1phib*PDstandard4th2phib - 0.5*gxyL*(dphiaSqr + dphibSqr - 
      8192*V0*pow(-3*C3 + pow(-32*C2 + 9*pow(C3,2),0.5),-2)*(pow(phiaL,4) + 
      C2*(pow(phiaL,2) - 0.015625*pow(-3*C3 + pow(-32*C2 + 
      9*pow(C3,2),0.5),2)) + C3*(pow(phiaL,3) - 0.001953125*pow(-3*C3 + 
      pow(-32*C2 + 9*pow(C3,2),0.5),3)) - 0.000244140625*pow(-3*C3 + 
    ...
    CCTK_REAL SFTij31 CCTK_ATTRIBUTE_UNUSED = 
      ...
      PDstandard4th1phib*PDstandard4th3phib - 0.5*gxzL*(dphiaSqr + dphibSqr - 
      8192*V0*pow(-3*C3 + pow(-32*C2 + 9*pow(C3,2),0.5),-2)*(pow(phiaL,4) + 
      C2*(pow(phiaL,2) - 0.015625*pow(-3*C3 + pow(-32*C2 + 
      9*pow(C3,2),0.5),2)) + C3*(pow(phiaL,3) - 0.001953125*pow(-3*C3 + 
      pow(-32*C2 + 9*pow(C3,2),0.5),3)) - 0.000244140625*pow(-3*C3 + 
    ...
    CCTK_REAL SFTij22 CCTK_ATTRIBUTE_UNUSED = pow(PDstandard4th2phia,2) + 
      pow(PDstandard4th2phib,2) - 0.5*gyyL*(dphiaSqr + dphibSqr - 
      8192*V0*pow(-3*C3 + pow(-32*C2 + 9*pow(C3,2),0.5),-2)*(pow(phiaL,4) + 
      C2*(pow(phiaL,2) - 0.015625*pow(-3*C3 + pow(-32*C2 + 
      9*pow(C3,2),0.5),2)) + C3*(pow(phiaL,3) - 0.001953125*pow(-3*C3 + 
      pow(-32*C2 + 9*pow(C3,2),0.5),3)) - 0.000244140625*pow(-3*C3 + 
    ...
    CCTK_REAL SFTij32 CCTK_ATTRIBUTE_UNUSED = 
      ...
      PDstandard4th2phib*PDstandard4th3phib - 0.5*gyzL*(dphiaSqr + dphibSqr - 
      8192*V0*pow(-3*C3 + pow(-32*C2 + 9*pow(C3,2),0.5),-2)*(pow(phiaL,4) + 
      C2*(pow(phiaL,2) - 0.015625*pow(-3*C3 + pow(-32*C2 + 
      9*pow(C3,2),0.5),2)) + C3*(pow(phiaL,3) - 0.001953125*pow(-3*C3 + 
      pow(-32*C2 + 9*pow(C3,2),0.5),3)) - 0.000244140625*pow(-3*C3 + 
    ...
    CCTK_REAL SFTij33 CCTK_ATTRIBUTE_UNUSED = pow(PDstandard4th3phia,2) + 
      pow(PDstandard4th3phib,2) - 0.5*gzzL*(dphiaSqr + dphibSqr - 
      8192*V0*pow(-3*C3 + pow(-32*C2 + 9*pow(C3,2),0.5),-2)*(pow(phiaL,4) + 
      C2*(pow(phiaL,2) - 0.015625*pow(-3*C3 + pow(-32*C2 + 
      9*pow(C3,2),0.5),2)) + C3*(pow(phiaL,3) - 0.001953125*pow(-3*C3 + 
      pow(-32*C2 + 9*pow(C3,2),0.5),3)) - 0.000244140625*pow(-3*C3 + 
  ...
  CCTK_ENDLOOP3(EvolveScalarFields_ScalarFieldrho_Vpablo_full4th);
}
extern "C" void EvolveScalarFields_ScalarFieldrho_Vpablo_full4th(CCTK_ARGUMENTS)
{
  #ifdef DECLARE_CCTK_ARGUMENTS_EvolveScalarFields_ScalarFieldrho_Vpablo_full4th
  DECLARE_CCTK_ARGUMENTS_CHECKED(EvolveScalarFields_ScalarFieldrho_Vpablo_full4th);
  #else
  DECLARE_CCTK_ARGUMENTS;
  #endif
  DECLARE_CCTK_PARAMETERS;
  ...
  if (verbose > 1)
  {
    CCTK_VInfo(CCTK_THORNSTRING,"Entering EvolveScalarFields_ScalarFieldrho_Vpablo_full4th_Body");
  }
  if (cctk_iteration % EvolveScalarFields_ScalarFieldrho_Vpablo_full4th_calc_every != EvolveScalarFields_ScalarFieldrho_Vpablo_full4th_calc_offset)
  {
    return;
  ...
  AssertGroupStorage(cctkGH, "EvolveScalarFields_ScalarFieldrho_Vpablo_full4th", 9, groups);
  
  EnsureStencilFits(cctkGH, "EvolveScalarFields_ScalarFieldrho_Vpablo_full4th", 3, 3, 3);
  
  LoopOverInterior(cctkGH, EvolveScalarFields_ScalarFieldrho_Vpablo_full4th_Body);
  if (verbose > 1)
  {
    CCTK_VInfo(CCTK_THORNSTRING,"Leaving EvolveScalarFields_ScalarFieldrho_Vpablo_full4th_Body");
  }
}
