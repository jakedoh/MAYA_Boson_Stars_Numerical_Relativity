...
#define NUM_INPUT_ARRAYS 10
#define NUM_OUTPUT_ARRAYS 10
#define DIM 3

void ScalarFluxHorizon_ProjectSphere(CCTK_ARGUMENTS)
{
  ...
  if (verbose>2) {
    CCTK_INFO("projecting TmunuBase");
  }
  ...
  CCTK_REAL rad=sf_radius[*current_detector];
  ...
  *rdet=rad;
  ...
  const CCTK_INT input_array_indices[NUM_INPUT_ARRAYS]
    = { CCTK_VarIndex("TmunuBase::eTtt"),
        CCTK_VarIndex("TmunuBase::eTtx"),
        CCTK_VarIndex("TmunuBase::eTty"),
        CCTK_VarIndex("TmunuBase::eTtz"),
        CCTK_VarIndex("TmunuBase::eTxx"),
        CCTK_VarIndex("TmunuBase::eTxy"),
        CCTK_VarIndex("TmunuBase::eTxz"),
        CCTK_VarIndex("TmunuBase::eTyy"),
        CCTK_VarIndex("TmunuBase::eTyz"),
        CCTK_VarIndex("TmunuBase::eTzz") };
